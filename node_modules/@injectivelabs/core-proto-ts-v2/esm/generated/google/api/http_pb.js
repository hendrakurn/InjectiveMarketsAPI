...
class Http$Type extends MessageType {
  constructor() {
    super("google.api.Http", [
      { no: 1, name: "rules", kind: "message", repeat: 2, T: () => HttpRule },
      {
        no: 2,
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated google.api.HttpRule rules */
        1:
          message.rules.push(HttpRule.internalBinaryRead(reader, reader.uint32(), options));
          break;
        case /* bool fully_decode_reserved_expansion */
        2:
...
class HttpRule$Type extends MessageType {
  constructor() {
    super("google.api.HttpRule", [
      ...
      { no: 11, name: "additional_bindings", kind: "message", repeat: 2, T: () => HttpRule }
    ]);
  }
  create(value) {
    const message = globalThis.Object.create(this.messagePrototype);
    message.selector = "";
    message.pattern = { oneofKind: void 0 };
    message.body = "";
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        6:
          ...
          break;
        case /* google.api.CustomHttpPattern custom */
        8:
          message.pattern = {
            oneofKind: "custom",
        ...
        7:
          ...
          break;
        case /* string response_body */
        12:
          message.responseBody = reader.string();
          break;
        case /* repeated google.api.HttpRule additional_bindings */
        11:
...
const HttpRule = new HttpRule$Type();
...
const CustomHttpPattern = new CustomHttpPattern$Type();
export {
  CustomHttpPattern,
  Http,
  HttpRule
