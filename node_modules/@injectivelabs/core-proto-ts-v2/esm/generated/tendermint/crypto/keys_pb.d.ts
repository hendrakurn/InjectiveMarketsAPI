...
class PublicKey$Type extends MessageType<PublicKey> {
    constructor() {
        super("tendermint.crypto.PublicKey", [
            ...
            { no: 3, name: "bls12381", kind: "scalar", oneof: "sum", T: 12 /*ScalarType.BYTES*/ }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bytes ed25519 */ 1:
                    ...
                    break;
                case /* bytes secp256k1 */ 2:
                    message.sum = {
                        oneofKind: "secp256K1",
                        secp256K1: reader.bytes()
                    };
                    break;
                case /* bytes bls12381 */ 3:
                    message.sum = {
                        oneofKind: "bls12381",
                        bls12381: reader.bytes()
                    };
                    break;
                default:
    ...
    internalBinaryWrite(message: PublicKey, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* bytes bls12381 = 3; */
        if (message.sum.oneofKind === "bls12381")
            writer.tag(3, WireType.LengthDelimited).bytes(message.sum.bls12381);
