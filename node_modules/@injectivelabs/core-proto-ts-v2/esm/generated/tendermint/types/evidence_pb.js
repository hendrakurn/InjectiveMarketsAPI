...
import { LightBlock } from "./types_pb.js";
import { Timestamp } from "../../google/protobuf/timestamp_pb.js";
import { Vote } from "./types_pb.js";
class Evidence$Type extends MessageType {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* tendermint.types.DuplicateVoteEvidence duplicate_vote_evidence */
        1:
          message.sum = {
          ...
          break;
        case /* tendermint.types.LightClientAttackEvidence light_client_attack_evidence */
        2:
          message.sum = {
...
const Evidence = new Evidence$Type();
...
const DuplicateVoteEvidence = new DuplicateVoteEvidence$Type();
class LightClientAttackEvidence$Type extends MessageType {
  constructor() {
    super("tendermint.types.LightClientAttackEvidence", [
      ...
      { no: 3, name: "byzantine_validators", kind: "message", repeat: 2, T: () => Validator },
      {
        no: 4,
        name: "total_voting_power",
        kind: "scalar",
...
const LightClientAttackEvidence = new LightClientAttackEvidence$Type();
class EvidenceList$Type extends MessageType {
  constructor() {
    super("tendermint.types.EvidenceList", [
      { no: 1, name: "evidence", kind: "message", repeat: 2, T: () => Evidence, options: { "gogoproto.nullable": false } }
    ]);
  }
  create(value) {
    const message = globalThis.Object.create(this.messagePrototype);
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* repeated tendermint.types.Evidence evidence */
        1:
...
const EvidenceList = new EvidenceList$Type();
export {
