...
import { DefaultNodeInfo } from "../../../../cometbft/p2p/v1/types_pb";
import { Block as Block$ } from "./types_pb";
import { Block } from "../../../../cometbft/types/v1/block_pb";
import { BlockID } from "../../../../cometbft/types/v1/types_pb";
import { Any } from "../../../../google/protobuf/any_pb";
import { PageResponse } from "../../query/v1beta1/pagination_pb";
import { PageRequest } from "../../query/v1beta1/pagination_pb";
/**
...
export interface GetBlockByHeightResponse {
     ...
     *
     * @generated from protobuf field: cometbft.types.v1.Block block = 2
     */
    block?: Block;
    /**
     * Since: cosmos-sdk 0.47
     *
     * @generated from protobuf field: cosmos.base.tendermint.v1beta1.Block sdk_block = 3
     */
    sdkBlock?: Block$;
}
/**
...
export interface GetNodeInfoResponse {
    /**
     * @generated from protobuf field: cometbft.p2p.v1.DefaultNodeInfo default_node_info = 1
     */
 ...
 *
 * @generated from protobuf message cosmos.base.tendermint.v1beta1.ABCIQueryRequest
 */
 ...
 * Tendermint.
 *
 * @generated from protobuf message cosmos.base.tendermint.v1beta1.ABCIQueryResponse
 */
export interface ABCIQueryResponse {
    ...
    value: Uint8Array;
    /**
     * @generated from protobuf field: cosmos.base.tendermint.v1beta1.ProofOps proof_ops = 8
     */
    proofOps?: ProofOps;
    /**
 ...
 *
 * @generated from protobuf message cosmos.base.tendermint.v1beta1.ProofOp
 */
 ...
 *
 * @generated from protobuf message cosmos.base.tendermint.v1beta1.ProofOps
 */
export interface ProofOps {
    /**
     * @generated from protobuf field: repeated cosmos.base.tendermint.v1beta1.ProofOp ops = 1
     */
    ops: ProofOp[];
}
...
class GetValidatorSetByHeightResponse$Type extends MessageType<GetValidatorSetByHeightResponse> {
    constructor() {
        super("cosmos.base.tendermint.v1beta1.GetValidatorSetByHeightResponse", [
            ...
            { no: 2, name: "validators", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Validator },
...
class Validator$Type extends MessageType<Validator> {
    ...
    create(value?: PartialMessage<Validator>): Validator {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.address = "";
        message.votingPower = 0n;
        message.proposerPriority = 0n;
        if (value !== undefined)
...
class GetBlockByHeightResponse$Type extends MessageType<GetBlockByHeightResponse> {
    constructor() {
        super("cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse", [
            ...
            { no: 3, name: "sdk_block", kind: "message", T: () => Block$ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* cometbft.types.v1.BlockID block_id */ 1:
                    ...
                    break;
                case /* cometbft.types.v1.Block block */ 2:
                    message.block = Block.internalBinaryRead(reader, reader.uint32(), options, message.block);
                    break;
                case /* cosmos.base.tendermint.v1beta1.Block sdk_block */ 3:
                    message.sdkBlock = Block$.internalBinaryRead(reader, reader.uint32(), options, message.sdkBlock);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: GetBlockByHeightResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.sdkBlock)
            Block$.internalBinaryWrite(message.sdkBlock, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetNodeInfoResponse$Type extends MessageType<GetNodeInfoResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetNodeInfoResponse): GetNodeInfoResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* cometbft.p2p.v1.DefaultNodeInfo default_node_info */ 1:
...
class VersionInfo$Type extends MessageType<VersionInfo> {
    constructor() {
        super("cosmos.base.tendermint.v1beta1.VersionInfo", [
            ...
            { no: 7, name: "build_deps", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Module },
...
// @generated message type with reflection information, may provide speed optimized methods
class ABCIQueryRequest$Type extends MessageType<ABCIQueryRequest> {
    constructor() {
        super("cosmos.base.tendermint.v1beta1.ABCIQueryRequest", [
    ...
    create(value?: PartialMessage<ABCIQueryRequest>): ABCIQueryRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        ...
        message.prove = false;
        if (value !== undefined)
            reflectionMergePartial<ABCIQueryRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ABCIQueryRequest): ABCIQueryRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ABCIQueryRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes data = 1; */
...
/**
 * @generated MessageType for protobuf message cosmos.base.tendermint.v1beta1.ABCIQueryRequest
 */
export const ABCIQueryRequest = new ABCIQueryRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ABCIQueryResponse$Type extends MessageType<ABCIQueryResponse> {
    constructor() {
        super("cosmos.base.tendermint.v1beta1.ABCIQueryResponse", [
    ...
    create(value?: PartialMessage<ABCIQueryResponse>): ABCIQueryResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.code = 0;
        message.log = "";
        message.info = "";
        ...
        message.codespace = "";
        if (value !== undefined)
            reflectionMergePartial<ABCIQueryResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ABCIQueryResponse): ABCIQueryResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* bytes value */ 7:
                    ...
                    break;
                case /* cosmos.base.tendermint.v1beta1.ProofOps proof_ops */ 8:
    ...
    internalBinaryWrite(message: ABCIQueryResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 code = 1; */
        if (message.code !== 0)
...
/**
 * @generated MessageType for protobuf message cosmos.base.tendermint.v1beta1.ABCIQueryResponse
 */
export const ABCIQueryResponse = new ABCIQueryResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ProofOp$Type extends MessageType<ProofOp> {
    constructor() {
        super("cosmos.base.tendermint.v1beta1.ProofOp", [
...
/**
 * @generated MessageType for protobuf message cosmos.base.tendermint.v1beta1.ProofOp
 */
export const ProofOp = new ProofOp$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ProofOps$Type extends MessageType<ProofOps> {
    constructor() {
        super("cosmos.base.tendermint.v1beta1.ProofOps", [
            { no: 1, name: "ops", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ProofOp, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ProofOps): ProofOps {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated cosmos.base.tendermint.v1beta1.ProofOp ops */ 1:
    ...
    internalBinaryWrite(message: ProofOps, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated cosmos.base.tendermint.v1beta1.ProofOp ops = 1; */
...
/**
 * @generated MessageType for protobuf message cosmos.base.tendermint.v1beta1.ProofOps
 */
...
export const Service = new ServiceType("cosmos.base.tendermint.v1beta1.Service", [
    ...
    { name: "ABCIQuery", options: { "google.api.http": { get: "/cosmos/base/tendermint/v1beta1/abci_query" } }, I: ABCIQueryRequest, O: ABCIQueryResponse }
]);
