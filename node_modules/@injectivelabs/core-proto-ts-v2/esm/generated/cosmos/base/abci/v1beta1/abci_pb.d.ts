...
import { Event } from "../../../../cometbft/abci/v1/types_pb";
...
export interface TxResponse {
     ...
     *
     * @generated from protobuf field: repeated cometbft.abci.v1.Event events = 13
     */
    events: Event[];
}
/**
...
export interface Result {
     ...
     *
     * @generated from protobuf field: repeated cometbft.abci.v1.Event events = 3
     */
    events: Event[];
    /**
 ...
 *
 * @generated from protobuf message cosmos.base.abci.v1beta1.SearchBlocksResult
 */
export interface SearchBlocksResult {
     ...
     * Index of current page, start from 1
     *
     * @generated from protobuf field: int64 page_number = 3
     */
    pageNumber: bigint;
    /**
     * Count of total pages
     *
     * @generated from protobuf field: int64 page_total = 4
     */
    pageTotal: bigint;
    /**
     ...
     *
     * @generated from protobuf field: repeated cometbft.types.v1.Block blocks = 6
     */
    blocks: Block[];
}
...
class TxResponse$Type extends MessageType<TxResponse> {
    constructor() {
        super("cosmos.base.abci.v1beta1.TxResponse", [
            ...
            { no: 7, name: "logs", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ABCIMessageLog, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "ABCIMessageLogs" } },
            ...
            { no: 13, name: "events", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Event, options: { "gogoproto.nullable": false } }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string timestamp */ 12:
                    ...
                    break;
                case /* repeated cometbft.abci.v1.Event events */ 13:
...
class ABCIMessageLog$Type extends MessageType<ABCIMessageLog> {
    constructor() {
        super("cosmos.base.abci.v1beta1.ABCIMessageLog", [
            ...
            { no: 3, name: "events", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => StringEvent, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "StringEvents" } }
...
class StringEvent$Type extends MessageType<StringEvent> {
    constructor() {
        super("cosmos.base.abci.v1beta1.StringEvent", [
            ...
            { no: 2, name: "attributes", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Attribute, options: { "gogoproto.nullable": false } }
        ], { "gogoproto.stringer": true });
    }
...
class Result$Type extends MessageType<Result> {
    constructor() {
        super("cosmos.base.abci.v1beta1.Result", [
            ...
            { no: 2, name: "log", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "events", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Event, options: { "gogoproto.nullable": false } },
            { no: 4, name: "msg_responses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Any }
        ], { "gogoproto.goproto_getters": false });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string log */ 2:
                    message.log = reader.string();
                    break;
                case /* repeated cometbft.abci.v1.Event events */ 3:
                    message.events.push(Event.internalBinaryRead(reader, reader.uint32(), options));
                    break;
...
class TxMsgData$Type extends MessageType<TxMsgData> {
    constructor() {
        super("cosmos.base.abci.v1beta1.TxMsgData", [
            { no: 1, name: "data", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => MsgData },
            { no: 2, name: "msg_responses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Any }
        ], { "gogoproto.stringer": true });
    }
...
class SearchTxsResult$Type extends MessageType<SearchTxsResult> {
    constructor() {
        super("cosmos.base.abci.v1beta1.SearchTxsResult", [
            ...
            { no: 6, name: "txs", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TxResponse }
        ], { "gogoproto.stringer": true });
    }
...
// @generated message type with reflection information, may provide speed optimized methods
class SearchBlocksResult$Type extends MessageType<SearchBlocksResult> {
    constructor() {
        super("cosmos.base.abci.v1beta1.SearchBlocksResult", [
            ...
            { no: 3, name: "page_number", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 4, name: "page_total", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 5, name: "limit", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 6, name: "blocks", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Block }
        ], { "gogoproto.stringer": true });
    }
    create(value?: PartialMessage<SearchBlocksResult>): SearchBlocksResult {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.totalCount = 0n;
        message.count = 0n;
        message.pageNumber = 0n;
        ...
        message.blocks = [];
        if (value !== undefined)
            reflectionMergePartial<SearchBlocksResult>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SearchBlocksResult): SearchBlocksResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SearchBlocksResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 total_count = 1; */
        if (message.totalCount !== 0n)
...
/**
 * @generated MessageType for protobuf message cosmos.base.abci.v1beta1.SearchBlocksResult
 */
export const SearchBlocksResult = new SearchBlocksResult$Type();
