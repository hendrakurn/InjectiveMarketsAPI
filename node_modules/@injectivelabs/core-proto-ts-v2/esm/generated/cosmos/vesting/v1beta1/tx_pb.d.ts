...
class MsgCreateVestingAccount$Type extends MessageType<MsgCreateVestingAccount> {
    constructor() {
        ...
        ], { "gogoproto.equal": true, "amino.name": "cosmos-sdk/MsgCreateVestingAccount", "cosmos.msg.v1.signer": ["from_address"] });
    }
...
class MsgCreatePermanentLockedAccount$Type extends MessageType<MsgCreatePermanentLockedAccount> {
    constructor() {
        super("cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccount", [
            ...
            { no: 3, name: "amount", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins", "amino.encoding": "legacy_coins", "amino.dont_omitempty": true } }
        ], { "gogoproto.equal": true, "amino.name": "cosmos-sdk/MsgCreatePermLockedAccount", "cosmos.msg.v1.signer": ["from_address"] });
    }
...
class MsgCreatePeriodicVestingAccount$Type extends MessageType<MsgCreatePeriodicVestingAccount> {
    constructor() {
        super("cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccount", [
            ...
            { no: 4, name: "vesting_periods", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Period, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ], { "gogoproto.equal": false, "amino.name": "cosmos-sdk/MsgCreatePeriodVestAccount", "cosmos.msg.v1.signer": ["from_address"] });
    }
