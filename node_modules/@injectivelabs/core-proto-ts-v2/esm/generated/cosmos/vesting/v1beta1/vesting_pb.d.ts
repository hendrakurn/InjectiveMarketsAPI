...
class BaseVestingAccount$Type extends MessageType<BaseVestingAccount> {
    constructor() {
        super("cosmos.vesting.v1beta1.BaseVestingAccount", [
            ...
            { no: 2, name: "original_vesting", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins", "amino.encoding": "legacy_coins", "amino.dont_omitempty": true } },
            { no: 3, name: "delegated_free", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins", "amino.encoding": "legacy_coins", "amino.dont_omitempty": true } },
            { no: 4, name: "delegated_vesting", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins", "amino.encoding": "legacy_coins", "amino.dont_omitempty": true } },
            { no: 5, name: "end_time", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ], { "gogoproto.goproto_getters": false, "amino.name": "cosmos-sdk/BaseVestingAccount" });
    }
...
class ContinuousVestingAccount$Type extends MessageType<ContinuousVestingAccount> {
    constructor() {
        ...
        ], { "gogoproto.goproto_getters": false, "amino.name": "cosmos-sdk/ContinuousVestingAccount" });
    }
...
class DelayedVestingAccount$Type extends MessageType<DelayedVestingAccount> {
    constructor() {
        super("cosmos.vesting.v1beta1.DelayedVestingAccount", [
            { no: 1, name: "base_vesting_account", kind: "message", T: () => BaseVestingAccount, options: { "gogoproto.embed": true } }
        ], { "gogoproto.goproto_getters": false, "amino.name": "cosmos-sdk/DelayedVestingAccount" });
    }
...
class Period$Type extends MessageType<Period> {
    constructor() {
        super("cosmos.vesting.v1beta1.Period", [
            ...
            { no: 2, name: "amount", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins", "amino.encoding": "legacy_coins", "amino.dont_omitempty": true } }
        ]);
    }
...
class PeriodicVestingAccount$Type extends MessageType<PeriodicVestingAccount> {
    constructor() {
        super("cosmos.vesting.v1beta1.PeriodicVestingAccount", [
            { no: 1, name: "base_vesting_account", kind: "message", T: () => BaseVestingAccount, options: { "gogoproto.embed": true } },
            { no: 2, name: "start_time", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "vesting_periods", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Period, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ], { "gogoproto.goproto_getters": false, "amino.name": "cosmos-sdk/PeriodicVestingAccount" });
    }
...
class PermanentLockedAccount$Type extends MessageType<PermanentLockedAccount> {
    constructor() {
        super("cosmos.vesting.v1beta1.PermanentLockedAccount", [
            { no: 1, name: "base_vesting_account", kind: "message", T: () => BaseVestingAccount, options: { "gogoproto.embed": true } }
        ], { "gogoproto.goproto_getters": false, "amino.name": "cosmos-sdk/PermanentLockedAccount" });
    }
