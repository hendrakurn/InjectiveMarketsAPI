...
// @generated from protobuf file "cosmos/upgrade/v1beta1/tx.proto" (package "cosmos.upgrade.v1beta1", syntax proto3)
// tslint:disable
...
class MsgSoftwareUpgrade$Type extends MessageType<MsgSoftwareUpgrade> {
    constructor() {
        super("cosmos.upgrade.v1beta1.MsgSoftwareUpgrade", [
            ...
            { no: 2, name: "plan", kind: "message", T: () => Plan, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ], { "amino.name": "cosmos-sdk/MsgSoftwareUpgrade", "cosmos.msg.v1.signer": ["authority"] });
    }
...
class MsgCancelUpgrade$Type extends MessageType<MsgCancelUpgrade> {
    constructor() {
        super("cosmos.upgrade.v1beta1.MsgCancelUpgrade", [
            { no: 1, name: "authority", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ], { "amino.name": "cosmos-sdk/MsgCancelUpgrade", "cosmos.msg.v1.signer": ["authority"] });
    }
