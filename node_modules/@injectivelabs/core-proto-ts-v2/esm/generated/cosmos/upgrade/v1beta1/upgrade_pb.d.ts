...
class Plan$Type extends MessageType<Plan> {
    constructor() {
        super("cosmos.upgrade.v1beta1.Plan", [
            ...
            { no: 2, name: "time", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true, "amino.dont_omitempty": true } },
        ...
        ], { "gogoproto.equal": true, "amino.name": "cosmos-sdk/Plan" });
    }
...
class SoftwareUpgradeProposal$Type extends MessageType<SoftwareUpgradeProposal> {
    constructor() {
        super("cosmos.upgrade.v1beta1.SoftwareUpgradeProposal", [
            ...
            { no: 3, name: "plan", kind: "message", T: () => Plan, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ], { "gogoproto.equal": true, "cosmos_proto.implements_interface": ["cosmos.gov.v1beta1.Content"], "amino.name": "cosmos-sdk/SoftwareUpgradeProposal" });
    }
...
class CancelSoftwareUpgradeProposal$Type extends MessageType<CancelSoftwareUpgradeProposal> {
    constructor() {
        super("cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ], { "gogoproto.equal": true, "cosmos_proto.implements_interface": ["cosmos.gov.v1beta1.Content"], "amino.name": "cosmos-sdk/CancelSoftwareUpgradeProposal" });
    }
