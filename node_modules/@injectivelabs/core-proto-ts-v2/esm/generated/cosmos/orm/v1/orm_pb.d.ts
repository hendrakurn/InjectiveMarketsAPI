...
// @generated from protobuf file "cosmos/orm/v1/orm.proto" (package "cosmos.orm.v1", syntax proto3)
// tslint:disable
...
class TableDescriptor$Type extends MessageType<TableDescriptor> {
    constructor() {
        super("cosmos.orm.v1.TableDescriptor", [
            ...
            { no: 2, name: "index", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => SecondaryIndexDescriptor },
