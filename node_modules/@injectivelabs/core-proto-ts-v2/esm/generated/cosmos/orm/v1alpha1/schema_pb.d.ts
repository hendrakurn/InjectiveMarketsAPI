...
// @generated from protobuf file "cosmos/orm/v1alpha1/schema.proto" (package "cosmos.orm.v1alpha1", syntax proto3)
// tslint:disable
...
class ModuleSchemaDescriptor$Type extends MessageType<ModuleSchemaDescriptor> {
    constructor() {
        super("cosmos.orm.v1alpha1.ModuleSchemaDescriptor", [
            { no: 1, name: "schema_file", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ModuleSchemaDescriptor_FileEntry },
