...
// @generated from protobuf file "cosmos/store/snapshots/v1/snapshot.proto" (package "cosmos.store.snapshots.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message cosmos.store.snapshots.v1.Snapshot
 */
export interface Snapshot {
    ...
    hash: Uint8Array;
    /**
     * @generated from protobuf field: cosmos.store.snapshots.v1.Metadata metadata = 5
     */
    metadata?: Metadata;
}
/**
 ...
 *
 * @generated from protobuf message cosmos.store.snapshots.v1.Metadata
 */
 ...
 *
 * @generated from protobuf message cosmos.store.snapshots.v1.SnapshotItem
 */
export interface SnapshotItem {
    ...
    item: {
        oneofKind: "store";
        /**
         * @generated from protobuf field: cosmos.store.snapshots.v1.SnapshotStoreItem store = 1
         */
        store: SnapshotStoreItem;
    } | {
        oneofKind: "iavl";
        /**
         * @generated from protobuf field: cosmos.store.snapshots.v1.SnapshotIAVLItem iavl = 2
         */
        iavl: SnapshotIAVLItem;
    } | {
        oneofKind: "extension";
        /**
         * @generated from protobuf field: cosmos.store.snapshots.v1.SnapshotExtensionMeta extension = 3
         */
        extension: SnapshotExtensionMeta;
    } | {
        oneofKind: "extensionPayload";
        /**
         * @generated from protobuf field: cosmos.store.snapshots.v1.SnapshotExtensionPayload extension_payload = 4
         */
 ...
 * Since: cosmos-sdk 0.46
 *
 * @generated from protobuf message cosmos.store.snapshots.v1.SnapshotStoreItem
 */
 ...
 * Since: cosmos-sdk 0.46
 *
 * @generated from protobuf message cosmos.store.snapshots.v1.SnapshotIAVLItem
 */
 ...
 * Since: cosmos-sdk 0.46
 *
 * @generated from protobuf message cosmos.store.snapshots.v1.SnapshotExtensionMeta
 */
 ...
 * Since: cosmos-sdk 0.46
 *
 * @generated from protobuf message cosmos.store.snapshots.v1.SnapshotExtensionPayload
 */
...
class Snapshot$Type extends MessageType<Snapshot> {
    constructor() {
        super("cosmos.store.snapshots.v1.Snapshot", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bytes hash */ 4:
                    ...
                    break;
                case /* cosmos.store.snapshots.v1.Metadata metadata */ 5:
    ...
    internalBinaryWrite(message: Snapshot, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* cosmos.store.snapshots.v1.Metadata metadata = 5; */
        if (message.metadata)
...
/**
 * @generated MessageType for protobuf message cosmos.store.snapshots.v1.Snapshot
 */
export const Snapshot = new Snapshot$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Metadata$Type extends MessageType<Metadata> {
    constructor() {
        super("cosmos.store.snapshots.v1.Metadata", [
...
/**
 * @generated MessageType for protobuf message cosmos.store.snapshots.v1.Metadata
 */
export const Metadata = new Metadata$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SnapshotItem$Type extends MessageType<SnapshotItem> {
    constructor() {
        super("cosmos.store.snapshots.v1.SnapshotItem", [
    ...
    internalBinaryWrite(message: SnapshotItem, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* cosmos.store.snapshots.v1.SnapshotStoreItem store = 1; */
        ...
        /* cosmos.store.snapshots.v1.SnapshotIAVLItem iavl = 2; */
        ...
        /* cosmos.store.snapshots.v1.SnapshotExtensionMeta extension = 3; */
        ...
        /* cosmos.store.snapshots.v1.SnapshotExtensionPayload extension_payload = 4; */
...
/**
 * @generated MessageType for protobuf message cosmos.store.snapshots.v1.SnapshotItem
 */
export const SnapshotItem = new SnapshotItem$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SnapshotStoreItem$Type extends MessageType<SnapshotStoreItem> {
    constructor() {
        super("cosmos.store.snapshots.v1.SnapshotStoreItem", [
...
/**
 * @generated MessageType for protobuf message cosmos.store.snapshots.v1.SnapshotStoreItem
 */
...
class SnapshotIAVLItem$Type extends MessageType<SnapshotIAVLItem> {
    constructor() {
        super("cosmos.store.snapshots.v1.SnapshotIAVLItem", [
...
/**
 * @generated MessageType for protobuf message cosmos.store.snapshots.v1.SnapshotIAVLItem
 */
...
class SnapshotExtensionMeta$Type extends MessageType<SnapshotExtensionMeta> {
    constructor() {
        super("cosmos.store.snapshots.v1.SnapshotExtensionMeta", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "format", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message cosmos.store.snapshots.v1.SnapshotExtensionMeta
 */
...
class SnapshotExtensionPayload$Type extends MessageType<SnapshotExtensionPayload> {
    constructor() {
        super("cosmos.store.snapshots.v1.SnapshotExtensionPayload", [
...
/**
 * @generated MessageType for protobuf message cosmos.store.snapshots.v1.SnapshotExtensionPayload
 */
