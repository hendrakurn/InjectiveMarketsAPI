...
// @generated from protobuf file "cosmos/store/internal/kv/v1beta1/kv.proto" (package "cosmos.store.internal.kv.v1beta1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message cosmos.store.internal.kv.v1beta1.Pairs
 */
export interface Pairs {
    /**
     * @generated from protobuf field: repeated cosmos.store.internal.kv.v1beta1.Pair pairs = 1
     */
    pairs: Pair[];
}
/**
 ...
 *
 * @generated from protobuf message cosmos.store.internal.kv.v1beta1.Pair
 */
...
class Pairs$Type extends MessageType<Pairs> {
    constructor() {
        super("cosmos.store.internal.kv.v1beta1.Pairs", [
            { no: 1, name: "pairs", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Pair, options: { "gogoproto.nullable": false } }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Pairs): Pairs {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated cosmos.store.internal.kv.v1beta1.Pair pairs */ 1:
    ...
    internalBinaryWrite(message: Pairs, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated cosmos.store.internal.kv.v1beta1.Pair pairs = 1; */
...
/**
 * @generated MessageType for protobuf message cosmos.store.internal.kv.v1beta1.Pairs
 */
export const Pairs = new Pairs$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Pair$Type extends MessageType<Pair> {
    constructor() {
        super("cosmos.store.internal.kv.v1beta1.Pair", [
...
/**
 * @generated MessageType for protobuf message cosmos.store.internal.kv.v1beta1.Pair
 */
