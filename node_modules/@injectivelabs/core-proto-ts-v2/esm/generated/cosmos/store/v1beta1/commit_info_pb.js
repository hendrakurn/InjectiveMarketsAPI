...
class CommitInfo$Type extends MessageType {
  constructor() {
    super("cosmos.store.v1beta1.CommitInfo", [
      {
        no: 1,
        name: "version",
        kind: "scalar",
      ...
      { no: 2, name: "store_infos", kind: "message", repeat: 2, T: () => StoreInfo, options: { "gogoproto.nullable": false } },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          ...
          break;
        case /* repeated cosmos.store.v1beta1.StoreInfo store_infos */
        2:
...
class StoreInfo$Type extends MessageType {
  constructor() {
    super("cosmos.store.v1beta1.StoreInfo", [
      {
        no: 1,
        name: "name",
        kind: "scalar",
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          ...
          break;
        case /* cosmos.store.v1beta1.CommitID commit_id */
        2:
...
const StoreInfo = new StoreInfo$Type();
class CommitID$Type extends MessageType {
  constructor() {
    super("cosmos.store.v1beta1.CommitID", [
      {
        no: 1,
        name: "version",
        kind: "scalar",
...
const CommitID = new CommitID$Type();
export {
  CommitID,
  CommitInfo,
  StoreInfo
