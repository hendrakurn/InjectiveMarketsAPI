...
import { TallyResult } from "./gov_pb.js";
import { Deposit } from "./gov_pb.js";
import { Params } from "./gov_pb.js";
import { TallyParams } from "./gov_pb.js";
import { DepositParams } from "./gov_pb.js";
import { VotingParams } from "./gov_pb.js";
import { Vote } from "./gov_pb.js";
import { PageResponse } from "../../base/query/v1beta1/pagination_pb.js";
import { PageRequest } from "../../base/query/v1beta1/pagination_pb.js";
import { ProposalStatus } from "./gov_pb.js";
import { Proposal } from "./gov_pb.js";
class QueryConstitutionRequest$Type extends MessageType {
  constructor() {
...
const QueryConstitutionRequest = new QueryConstitutionRequest$Type();
class QueryConstitutionResponse$Type extends MessageType {
  constructor() {
...
const QueryConstitutionResponse = new QueryConstitutionResponse$Type();
...
const QueryProposalRequest = new QueryProposalRequest$Type();
class QueryProposalResponse$Type extends MessageType {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* cosmos.gov.v1.Proposal proposal */
        1:
...
const QueryProposalResponse = new QueryProposalResponse$Type();
class QueryProposalsRequest$Type extends MessageType {
  constructor() {
    super("cosmos.gov.v1.QueryProposalsRequest", [
      ...
      { no: 2, name: "voter", kind: "scalar", T: 9, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
      { no: 3, name: "depositor", kind: "scalar", T: 9, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* cosmos.gov.v1.ProposalStatus proposal_status */
        1:
...
const QueryProposalsRequest = new QueryProposalsRequest$Type();
class QueryProposalsResponse$Type extends MessageType {
  constructor() {
    super("cosmos.gov.v1.QueryProposalsResponse", [
      { no: 1, name: "proposals", kind: "message", repeat: 2, T: () => Proposal },
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* repeated cosmos.gov.v1.Proposal proposals */
        1:
...
const QueryProposalsResponse = new QueryProposalsResponse$Type();
...
const QueryVoteRequest = new QueryVoteRequest$Type();
...
const QueryVoteResponse = new QueryVoteResponse$Type();
...
const QueryVotesRequest = new QueryVotesRequest$Type();
class QueryVotesResponse$Type extends MessageType {
  constructor() {
    super("cosmos.gov.v1.QueryVotesResponse", [
      { no: 1, name: "votes", kind: "message", repeat: 2, T: () => Vote },
      { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
    ]);
  }
  create(value) {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* repeated cosmos.gov.v1.Vote votes */
        1:
...
const QueryVotesResponse = new QueryVotesResponse$Type();
...
class QueryDepositRequest$Type extends MessageType {
  constructor() {
    super("cosmos.gov.v1.QueryDepositRequest", [
      ...
      { no: 2, name: "depositor", kind: "scalar", T: 9, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
    ]);
  }
  create(value) {
    const message = globalThis.Object.create(this.messagePrototype);
...
const QueryDepositRequest = new QueryDepositRequest$Type();
class QueryDepositResponse$Type extends MessageType {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* cosmos.gov.v1.Deposit deposit */
        1:
...
const QueryDepositResponse = new QueryDepositResponse$Type();
...
const QueryDepositsRequest = new QueryDepositsRequest$Type();
class QueryDepositsResponse$Type extends MessageType {
  constructor() {
    super("cosmos.gov.v1.QueryDepositsResponse", [
      { no: 1, name: "deposits", kind: "message", repeat: 2, T: () => Deposit },
      { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
    ]);
  }
  create(value) {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* repeated cosmos.gov.v1.Deposit deposits */
        1:
...
const QueryDepositsResponse = new QueryDepositsResponse$Type();
...
const QueryTallyResultRequest = new QueryTallyResultRequest$Type();
class QueryTallyResultResponse$Type extends MessageType {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* cosmos.gov.v1.TallyResult tally */
        1:
...
const QueryTallyResultResponse = new QueryTallyResultResponse$Type();
const Query = new ServiceType("cosmos.gov.v1.Query", [
