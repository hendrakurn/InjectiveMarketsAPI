...
// @generated from protobuf file "cosmos/gov/v1/query.proto" (package "cosmos.gov.v1", syntax proto3)
// tslint:disable
...
import { TallyResult } from "./gov_pb";
import { Deposit } from "./gov_pb";
import { Params } from "./gov_pb";
import { TallyParams } from "./gov_pb";
import { DepositParams } from "./gov_pb";
import { VotingParams } from "./gov_pb";
import { Vote } from "./gov_pb";
import { PageResponse } from "../../base/query/v1beta1/pagination_pb";
import { PageRequest } from "../../base/query/v1beta1/pagination_pb";
import { ProposalStatus } from "./gov_pb";
import { Proposal } from "./gov_pb";
/**
 * QueryConstitutionRequest is the request type for the Query/Constitution RPC method
 *
 * @generated from protobuf message cosmos.gov.v1.QueryConstitutionRequest
 */
 ...
 *
 * @generated from protobuf message cosmos.gov.v1.QueryConstitutionResponse
 */
export interface QueryConstitutionResponse {
    /**
     * @generated from protobuf field: string constitution = 1
     */
    constitution: string;
}
/**
...
class QueryConstitutionRequest$Type extends MessageType<QueryConstitutionRequest> {
    constructor() {
        super("cosmos.gov.v1.QueryConstitutionRequest", []);
    }
    create(value?: PartialMessage<QueryConstitutionRequest>): QueryConstitutionRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<QueryConstitutionRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryConstitutionRequest): QueryConstitutionRequest {
    ...
    internalBinaryWrite(message: QueryConstitutionRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message cosmos.gov.v1.QueryConstitutionRequest
 */
export const QueryConstitutionRequest = new QueryConstitutionRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class QueryConstitutionResponse$Type extends MessageType<QueryConstitutionResponse> {
    constructor() {
        super("cosmos.gov.v1.QueryConstitutionResponse", [
            { no: 1, name: "constitution", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<QueryConstitutionResponse>): QueryConstitutionResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.constitution = "";
        if (value !== undefined)
            reflectionMergePartial<QueryConstitutionResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryConstitutionResponse): QueryConstitutionResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string constitution */ 1:
    ...
    internalBinaryWrite(message: QueryConstitutionResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string constitution = 1; */
        if (message.constitution !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.constitution);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message cosmos.gov.v1.QueryConstitutionResponse
 */
export const QueryConstitutionResponse = new QueryConstitutionResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class QueryProposalsResponse$Type extends MessageType<QueryProposalsResponse> {
    constructor() {
        super("cosmos.gov.v1.QueryProposalsResponse", [
            { no: 1, name: "proposals", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Proposal },
...
class QueryVotesResponse$Type extends MessageType<QueryVotesResponse> {
    constructor() {
        super("cosmos.gov.v1.QueryVotesResponse", [
            { no: 1, name: "votes", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Vote },
            { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
        ]);
    }
...
class QueryParamsResponse$Type extends MessageType<QueryParamsResponse> {
    ...
    internalBinaryWrite(message: QueryParamsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* cosmos.gov.v1.VotingParams voting_params = 1 [deprecated = true]; */
        ...
        /* cosmos.gov.v1.DepositParams deposit_params = 2 [deprecated = true]; */
        ...
        /* cosmos.gov.v1.TallyParams tally_params = 3 [deprecated = true]; */
...
class QueryDepositsResponse$Type extends MessageType<QueryDepositsResponse> {
    constructor() {
        super("cosmos.gov.v1.QueryDepositsResponse", [
            { no: 1, name: "deposits", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Deposit },
            { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
        ]);
    }
...
export const Query = new ServiceType("cosmos.gov.v1.Query", [
    { name: "Constitution", options: { "google.api.http": { get: "/cosmos/gov/v1/constitution" } }, I: QueryConstitutionRequest, O: QueryConstitutionResponse },
