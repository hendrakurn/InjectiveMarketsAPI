...
class GenesisState$Type extends MessageType {
  constructor() {
    super("cosmos.gov.v1.GenesisState", [
      ...
      { no: 2, name: "deposits", kind: "message", repeat: 2, T: () => Deposit },
      { no: 3, name: "votes", kind: "message", repeat: 2, T: () => Vote },
      { no: 4, name: "proposals", kind: "message", repeat: 2, T: () => Proposal },
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* uint64 starting_proposal_id */
        1:
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.params)
      Params.internalBinaryWrite(message.params, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
    if (message.constitution !== "")
      writer.tag(9, WireType.LengthDelimited).string(message.constitution);
