...
class QueryProposalResponse$Type extends MessageType<QueryProposalResponse> {
    constructor() {
        super("cosmos.gov.v1beta1.QueryProposalResponse", [
            { no: 1, name: "proposal", kind: "message", T: () => Proposal, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
...
class QueryProposalsResponse$Type extends MessageType<QueryProposalsResponse> {
    constructor() {
        super("cosmos.gov.v1beta1.QueryProposalsResponse", [
            { no: 1, name: "proposals", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Proposal, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
...
class QueryVoteResponse$Type extends MessageType<QueryVoteResponse> {
    constructor() {
        super("cosmos.gov.v1beta1.QueryVoteResponse", [
            { no: 1, name: "vote", kind: "message", T: () => Vote, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
...
class QueryVotesResponse$Type extends MessageType<QueryVotesResponse> {
    constructor() {
        super("cosmos.gov.v1beta1.QueryVotesResponse", [
            { no: 1, name: "votes", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Vote, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
        ]);
    }
...
class QueryParamsResponse$Type extends MessageType<QueryParamsResponse> {
    constructor() {
        super("cosmos.gov.v1beta1.QueryParamsResponse", [
            { no: 1, name: "voting_params", kind: "message", T: () => VotingParams, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 2, name: "deposit_params", kind: "message", T: () => DepositParams, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 3, name: "tally_params", kind: "message", T: () => TallyParams, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
...
class QueryDepositResponse$Type extends MessageType<QueryDepositResponse> {
    constructor() {
        super("cosmos.gov.v1beta1.QueryDepositResponse", [
            { no: 1, name: "deposit", kind: "message", T: () => Deposit, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
...
class QueryDepositsResponse$Type extends MessageType<QueryDepositsResponse> {
    constructor() {
        super("cosmos.gov.v1beta1.QueryDepositsResponse", [
            { no: 1, name: "deposits", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Deposit, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
        ]);
    }
...
class QueryTallyResultResponse$Type extends MessageType<QueryTallyResultResponse> {
    constructor() {
        super("cosmos.gov.v1beta1.QueryTallyResultResponse", [
            { no: 1, name: "tally", kind: "message", T: () => TallyResult, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
