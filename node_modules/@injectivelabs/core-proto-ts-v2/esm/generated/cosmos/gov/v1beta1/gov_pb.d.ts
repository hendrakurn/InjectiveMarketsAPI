...
class WeightedVoteOption$Type extends MessageType<WeightedVoteOption> {
    constructor() {
        super("cosmos.gov.v1beta1.WeightedVoteOption", [
            ...
            { no: 2, name: "weight", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "cosmos_proto.scalar": "cosmos.Dec", "amino.dont_omitempty": true } }
        ]);
    }
...
class TextProposal$Type extends MessageType<TextProposal> {
    constructor() {
        ...
        ], { "gogoproto.equal": true, "cosmos_proto.implements_interface": ["cosmos.gov.v1beta1.Content"], "amino.name": "cosmos-sdk/TextProposal" });
    }
...
class Deposit$Type extends MessageType<Deposit> {
    constructor() {
        super("cosmos.gov.v1beta1.Deposit", [
            ...
            { no: 3, name: "amount", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins", "amino.dont_omitempty": true } }
...
class Proposal$Type extends MessageType<Proposal> {
    constructor() {
        super("cosmos.gov.v1beta1.Proposal", [
            { no: 1, name: "proposal_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "content", kind: "message", T: () => Any, options: { "cosmos_proto.accepts_interface": "cosmos.gov.v1beta1.Content" } },
            { no: 3, name: "status", kind: "enum", T: () => ["cosmos.gov.v1beta1.ProposalStatus", ProposalStatus, "PROPOSAL_STATUS_"] },
            { no: 4, name: "final_tally_result", kind: "message", T: () => TallyResult, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            ...
            { no: 6, name: "deposit_end_time", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true, "amino.dont_omitempty": true } },
            { no: 7, name: "total_deposit", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins", "amino.dont_omitempty": true } },
            { no: 8, name: "voting_start_time", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true, "amino.dont_omitempty": true } },
            { no: 9, name: "voting_end_time", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true, "amino.dont_omitempty": true } }
...
class TallyResult$Type extends MessageType<TallyResult> {
    constructor() {
        super("cosmos.gov.v1beta1.TallyResult", [
            { no: 1, name: "yes", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.Int", "cosmos_proto.scalar": "cosmos.Int" } },
            { no: 2, name: "abstain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.Int", "cosmos_proto.scalar": "cosmos.Int" } },
            { no: 3, name: "no", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.Int", "cosmos_proto.scalar": "cosmos.Int" } },
            { no: 4, name: "no_with_veto", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.Int", "cosmos_proto.scalar": "cosmos.Int" } }
        ], { "gogoproto.equal": true });
    }
...
class Vote$Type extends MessageType<Vote> {
    constructor() {
        super("cosmos.gov.v1beta1.Vote", [
            { no: 1, name: "proposal_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/, options: { "gogoproto.jsontag": "id", "amino.field_name": "id", "amino.dont_omitempty": true } },
            ...
            { no: 4, name: "options", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => WeightedVoteOption, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
...
class DepositParams$Type extends MessageType<DepositParams> {
    constructor() {
        super("cosmos.gov.v1beta1.DepositParams", [
            { no: 1, name: "min_deposit", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.jsontag": "min_deposit,omitempty", "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins" } },
...
class TallyParams$Type extends MessageType<TallyParams> {
    constructor() {
        super("cosmos.gov.v1beta1.TallyParams", [
            { no: 1, name: "quorum", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "gogoproto.jsontag": "quorum,omitempty", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 2, name: "threshold", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "gogoproto.jsontag": "threshold,omitempty", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 3, name: "veto_threshold", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "gogoproto.jsontag": "veto_threshold,omitempty", "cosmos_proto.scalar": "cosmos.Dec" } }
        ]);
    }
