...
// @generated from protobuf file "cosmos/app/v1alpha1/module.proto" (package "cosmos.app.v1alpha1", syntax proto3)
// tslint:disable
...
class ModuleDescriptor$Type extends MessageType<ModuleDescriptor> {
    constructor() {
        super("cosmos.app.v1alpha1.ModuleDescriptor", [
            ...
            { no: 2, name: "use_package", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PackageReference },
            { no: 3, name: "can_migrate_from", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => MigrateFromInfo }
        ]);
    }
