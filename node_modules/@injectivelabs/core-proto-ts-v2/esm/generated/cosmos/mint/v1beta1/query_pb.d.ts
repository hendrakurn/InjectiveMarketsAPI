...
class QueryInflationResponse$Type extends MessageType<QueryInflationResponse> {
    constructor() {
        super("cosmos.mint.v1beta1.QueryInflationResponse", [
            { no: 1, name: "inflation", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "cosmos_proto.scalar": "cosmos.Dec", "amino.dont_omitempty": true } }
        ]);
    }
...
class QueryAnnualProvisionsResponse$Type extends MessageType<QueryAnnualProvisionsResponse> {
    constructor() {
        super("cosmos.mint.v1beta1.QueryAnnualProvisionsResponse", [
            { no: 1, name: "annual_provisions", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "cosmos_proto.scalar": "cosmos.Dec", "amino.dont_omitempty": true } }
        ]);
    }
