...
// @generated from protobuf file "cosmos/mint/v1beta1/tx.proto" (package "cosmos.mint.v1beta1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message cosmos.mint.v1beta1.MsgUpdateParams
 */
 ...
 * Since: cosmos-sdk 0.47
 *
 * @generated from protobuf message cosmos.mint.v1beta1.MsgUpdateParamsResponse
 */
...
class MsgUpdateParams$Type extends MessageType<MsgUpdateParams> {
    constructor() {
        super("cosmos.mint.v1beta1.MsgUpdateParams", [
        ...
        ], { "amino.name": "cosmos-sdk/x/mint/MsgUpdateParams", "cosmos.msg.v1.signer": ["authority"] });
    }
...
/**
 * @generated MessageType for protobuf message cosmos.mint.v1beta1.MsgUpdateParams
 */
...
class MsgUpdateParamsResponse$Type extends MessageType<MsgUpdateParamsResponse> {
    constructor() {
        super("cosmos.mint.v1beta1.MsgUpdateParamsResponse", []);
    }
...
/**
 * @generated MessageType for protobuf message cosmos.mint.v1beta1.MsgUpdateParamsResponse
 */
export const MsgUpdateParamsResponse = new MsgUpdateParamsResponse$Type();
/**
 * @generated ServiceType for protobuf service cosmos.mint.v1beta1.Msg
 */
export const Msg = new ServiceType("cosmos.mint.v1beta1.Msg", [
