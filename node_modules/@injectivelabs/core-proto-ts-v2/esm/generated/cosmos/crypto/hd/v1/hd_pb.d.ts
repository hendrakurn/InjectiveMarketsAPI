...
// @generated from protobuf file "cosmos/crypto/hd/v1/hd.proto" (package "cosmos.crypto.hd.v1", syntax proto3)
// tslint:disable
...
class BIP44Params$Type extends MessageType<BIP44Params> {
    constructor() {
        ...
        ], { "gogoproto.goproto_stringer": false, "amino.name": "crypto/keys/hd/BIP44Params" });
    }
