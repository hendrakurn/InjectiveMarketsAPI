...
class LegacyAminoPubKey$Type extends MessageType<LegacyAminoPubKey> {
    constructor() {
        super("cosmos.crypto.multisig.LegacyAminoPubKey", [
            ...
            { no: 2, name: "public_keys", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Any, options: { "gogoproto.customname": "PubKeys", "amino.field_name": "pubkeys" } }
        ], { "gogoproto.goproto_getters": false, "amino.name": "tendermint/PubKeyMultisigThreshold", "amino.message_encoding": "threshold_string" });
    }
