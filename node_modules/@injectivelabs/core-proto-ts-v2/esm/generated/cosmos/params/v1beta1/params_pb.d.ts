...
class ParameterChangeProposal$Type extends MessageType<ParameterChangeProposal> {
    constructor() {
        super("cosmos.params.v1beta1.ParameterChangeProposal", [
            ...
            { no: 3, name: "changes", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ParamChange, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ], { "gogoproto.goproto_getters": false, "cosmos_proto.implements_interface": ["cosmos.gov.v1beta1.Content"], "amino.name": "cosmos-sdk/ParameterChangeProposal" });
    }
