...
class MsgUnjail$Type extends MessageType {
  constructor() {
    super("cosmos.slashing.v1beta1.MsgUnjail", [
      { no: 1, name: "validator_addr", kind: "scalar", T: 9, options: { "gogoproto.jsontag": "address", "cosmos_proto.scalar": "cosmos.ValidatorAddressString", "amino.field_name": "address", "amino.dont_omitempty": true } }
...
const MsgUnjail = new MsgUnjail$Type();
...
const MsgUnjailResponse = new MsgUnjailResponse$Type();
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          ...
          break;
        case /* cosmos.slashing.v1beta1.Params params */
        2:
...
const Msg = new ServiceType("cosmos.slashing.v1beta1.Msg", [
