 ...
 *
 * @generated from protobuf message cosmos.slashing.v1beta1.MsgUpdateParams
 */
export interface MsgUpdateParams {
     ...
     *
     * @generated from protobuf field: cosmos.slashing.v1beta1.Params params = 2
     */
    params?: Params;
}
/**
 ...
 * Since: cosmos-sdk 0.47
 *
 * @generated from protobuf message cosmos.slashing.v1beta1.MsgUpdateParamsResponse
 */
...
class MsgUnjail$Type extends MessageType<MsgUnjail> {
    constructor() {
        super("cosmos.slashing.v1beta1.MsgUnjail", [
            { no: 1, name: "validator_addr", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.jsontag": "address", "cosmos_proto.scalar": "cosmos.ValidatorAddressString", "amino.field_name": "address", "amino.dont_omitempty": true } }
        ], { "gogoproto.goproto_getters": false, "amino.name": "cosmos-sdk/MsgUnjail", "cosmos.msg.v1.signer": ["validator_addr"] });
    }
...
class MsgUpdateParams$Type extends MessageType<MsgUpdateParams> {
    constructor() {
        super("cosmos.slashing.v1beta1.MsgUpdateParams", [
        ...
        ], { "amino.name": "cosmos-sdk/x/slashing/MsgUpdateParams", "cosmos.msg.v1.signer": ["authority"] });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string authority */ 1:
                    ...
                    break;
                case /* cosmos.slashing.v1beta1.Params params */ 2:
    ...
    internalBinaryWrite(message: MsgUpdateParams, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* cosmos.slashing.v1beta1.Params params = 2; */
        if (message.params)
...
/**
 * @generated MessageType for protobuf message cosmos.slashing.v1beta1.MsgUpdateParams
 */
...
class MsgUpdateParamsResponse$Type extends MessageType<MsgUpdateParamsResponse> {
    constructor() {
        super("cosmos.slashing.v1beta1.MsgUpdateParamsResponse", []);
    }
...
/**
 * @generated MessageType for protobuf message cosmos.slashing.v1beta1.MsgUpdateParamsResponse
 */
