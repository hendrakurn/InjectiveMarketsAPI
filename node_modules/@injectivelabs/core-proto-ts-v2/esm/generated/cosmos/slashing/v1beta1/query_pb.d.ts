...
class QuerySigningInfoRequest$Type extends MessageType<QuerySigningInfoRequest> {
    constructor() {
        super("cosmos.slashing.v1beta1.QuerySigningInfoRequest", [
            { no: 1, name: "cons_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.ConsensusAddressString" } }
        ]);
    }
...
class QuerySigningInfoResponse$Type extends MessageType<QuerySigningInfoResponse> {
    constructor() {
        super("cosmos.slashing.v1beta1.QuerySigningInfoResponse", [
            { no: 1, name: "val_signing_info", kind: "message", T: () => ValidatorSigningInfo, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
...
class QuerySigningInfosResponse$Type extends MessageType<QuerySigningInfosResponse> {
    constructor() {
        super("cosmos.slashing.v1beta1.QuerySigningInfosResponse", [
            { no: 1, name: "info", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ValidatorSigningInfo, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
