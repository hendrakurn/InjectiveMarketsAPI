...
import { ValidatorSigningInfo } from "./slashing_pb";
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("cosmos.slashing.v1beta1.GenesisState", [
            ...
            { no: 2, name: "signing_infos", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => SigningInfo, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 3, name: "missed_blocks", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ValidatorMissedBlocks, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
...
class SigningInfo$Type extends MessageType<SigningInfo> {
    constructor() {
        super("cosmos.slashing.v1beta1.SigningInfo", [
            ...
            { no: 2, name: "validator_signing_info", kind: "message", T: () => ValidatorSigningInfo, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
...
class ValidatorMissedBlocks$Type extends MessageType<ValidatorMissedBlocks> {
    constructor() {
        super("cosmos.slashing.v1beta1.ValidatorMissedBlocks", [
            { no: 1, name: "address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.ConsensusAddressString" } },
            { no: 2, name: "missed_blocks", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => MissedBlock, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
