...
class ValidatorSigningInfo$Type extends MessageType<ValidatorSigningInfo> {
    constructor() {
        super("cosmos.slashing.v1beta1.ValidatorSigningInfo", [
            { no: 1, name: "address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.ConsensusAddressString" } },
            ...
            { no: 4, name: "jailed_until", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true, "amino.dont_omitempty": true } },
    ...
    create(value?: PartialMessage<ValidatorSigningInfo>): ValidatorSigningInfo {
        ...
        message.indexOffset = 0n;
        message.tombstoned = false;
        message.missedBlocksCounter = 0n;
        if (value !== undefined)
...
class Params$Type extends MessageType<Params> {
    constructor() {
        super("cosmos.slashing.v1beta1.Params", [
            ...
            { no: 2, name: "min_signed_per_window", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "cosmos_proto.scalar": "cosmos.Dec", "amino.dont_omitempty": true } },
            { no: 3, name: "downtime_jail_duration", kind: "message", T: () => Duration, options: { "gogoproto.nullable": false, "gogoproto.stdduration": true, "amino.dont_omitempty": true } },
            { no: 4, name: "slash_fraction_double_sign", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "cosmos_proto.scalar": "cosmos.Dec", "amino.dont_omitempty": true } },
            { no: 5, name: "slash_fraction_downtime", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "cosmos_proto.scalar": "cosmos.Dec", "amino.dont_omitempty": true } }
        ], { "amino.name": "cosmos-sdk/x/slashing/Params" });
    }
    create(value?: PartialMessage<Params>): Params {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.signedBlocksWindow = 0n;
