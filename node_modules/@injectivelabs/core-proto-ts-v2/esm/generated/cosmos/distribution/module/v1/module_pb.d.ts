...
// @generated from protobuf file "cosmos/distribution/module/v1/module.proto" (package "cosmos.distribution.module.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message cosmos.distribution.module.v1.Module
 */
export interface Module {
    /**
     * @generated from protobuf field: string fee_collector_name = 1
     */
...
class Module$Type extends MessageType<Module> {
    constructor() {
        super("cosmos.distribution.module.v1.Module", [
            { no: 1, name: "fee_collector_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "authority", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ], { "cosmos.app.v1alpha1.module": { goImport: "github.com/cosmos/cosmos-sdk/x/distribution" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Module): Module {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string fee_collector_name */ 1:
    ...
    internalBinaryWrite(message: Module, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.feeCollectorName !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.feeCollectorName);
        /* string authority = 2; */
...
/**
 * @generated MessageType for protobuf message cosmos.distribution.module.v1.Module
 */
