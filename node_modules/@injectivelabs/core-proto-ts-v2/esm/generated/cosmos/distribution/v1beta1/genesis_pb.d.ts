...
import { FeePool } from "./distribution_pb";
import { Params } from "./distribution_pb";
import { ValidatorSlashEvent } from "./distribution_pb";
import { DelegatorStartingInfo } from "./distribution_pb";
import { ValidatorCurrentRewards } from "./distribution_pb";
import { ValidatorHistoricalRewards } from "./distribution_pb";
...
class ValidatorOutstandingRewardsRecord$Type extends MessageType<ValidatorOutstandingRewardsRecord> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorOutstandingRewardsRecord", [
            ...
            { no: 2, name: "outstanding_rewards", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DecCoin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.DecCoins", "amino.dont_omitempty": true } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
...
class ValidatorAccumulatedCommissionRecord$Type extends MessageType<ValidatorAccumulatedCommissionRecord> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorAccumulatedCommissionRecord", [
            { no: 1, name: "validator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.ValidatorAddressString" } },
            { no: 2, name: "accumulated", kind: "message", T: () => ValidatorAccumulatedCommission, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
...
class ValidatorHistoricalRewardsRecord$Type extends MessageType<ValidatorHistoricalRewardsRecord> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorHistoricalRewardsRecord", [
            ...
            { no: 3, name: "rewards", kind: "message", T: () => ValidatorHistoricalRewards, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
...
class ValidatorCurrentRewardsRecord$Type extends MessageType<ValidatorCurrentRewardsRecord> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorCurrentRewardsRecord", [
            { no: 1, name: "validator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.ValidatorAddressString" } },
            { no: 2, name: "rewards", kind: "message", T: () => ValidatorCurrentRewards, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
...
class DelegatorStartingInfoRecord$Type extends MessageType<DelegatorStartingInfoRecord> {
    constructor() {
        super("cosmos.distribution.v1beta1.DelegatorStartingInfoRecord", [
            ...
            { no: 3, name: "starting_info", kind: "message", T: () => DelegatorStartingInfo, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
...
class ValidatorSlashEventRecord$Type extends MessageType<ValidatorSlashEventRecord> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorSlashEventRecord", [
            ...
            { no: 4, name: "validator_slash_event", kind: "message", T: () => ValidatorSlashEvent, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("cosmos.distribution.v1beta1.GenesisState", [
            ...
            { no: 2, name: "fee_pool", kind: "message", T: () => FeePool, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 3, name: "delegator_withdraw_infos", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DelegatorWithdrawInfo, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 4, name: "previous_proposer", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 5, name: "outstanding_rewards", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ValidatorOutstandingRewardsRecord, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 6, name: "validator_accumulated_commissions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ValidatorAccumulatedCommissionRecord, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 7, name: "validator_historical_rewards", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ValidatorHistoricalRewardsRecord, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 8, name: "validator_current_rewards", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ValidatorCurrentRewardsRecord, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 9, name: "delegator_starting_infos", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DelegatorStartingInfoRecord, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 10, name: "validator_slash_events", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ValidatorSlashEventRecord, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
