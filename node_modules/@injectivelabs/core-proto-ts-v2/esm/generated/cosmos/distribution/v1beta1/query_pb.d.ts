...
import { DelegationDelegatorReward } from "./distribution_pb";
import { PageResponse } from "../../base/query/v1beta1/pagination_pb";
import { ValidatorSlashEvent } from "./distribution_pb";
import { PageRequest } from "../../base/query/v1beta1/pagination_pb";
import { ValidatorAccumulatedCommission } from "./distribution_pb";
import { ValidatorOutstandingRewards } from "./distribution_pb";
 ...
 *
 * @generated from protobuf message cosmos.distribution.v1beta1.QueryValidatorDistributionInfoRequest
 */
 ...
 *
 * @generated from protobuf message cosmos.distribution.v1beta1.QueryValidatorDistributionInfoResponse
 */
export interface QueryValidatorDistributionInfoResponse {
     ...
     *
     * @generated from protobuf field: repeated cosmos.base.v1beta1.DecCoin self_bond_rewards = 2
     */
    selfBondRewards: DecCoin[];
    /**
     * commission defines the commission the validator received.
     *
     * @generated from protobuf field: repeated cosmos.base.v1beta1.DecCoin commission = 3
     */
    commission: DecCoin[];
}
/**
...
// @generated message type with reflection information, may provide speed optimized methods
class QueryValidatorDistributionInfoRequest$Type extends MessageType<QueryValidatorDistributionInfoRequest> {
    constructor() {
    ...
    create(value?: PartialMessage<QueryValidatorDistributionInfoRequest>): QueryValidatorDistributionInfoRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.validatorAddress = "";
        if (value !== undefined)
            reflectionMergePartial<QueryValidatorDistributionInfoRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryValidatorDistributionInfoRequest): QueryValidatorDistributionInfoRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: QueryValidatorDistributionInfoRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message cosmos.distribution.v1beta1.QueryValidatorDistributionInfoRequest
 */
export const QueryValidatorDistributionInfoRequest = new QueryValidatorDistributionInfoRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class QueryValidatorDistributionInfoResponse$Type extends MessageType<QueryValidatorDistributionInfoResponse> {
    constructor() {
        super("cosmos.distribution.v1beta1.QueryValidatorDistributionInfoResponse", [
            { no: 1, name: "operator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.ValidatorAddressString" } },
            { no: 2, name: "self_bond_rewards", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DecCoin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.DecCoins", "amino.dont_omitempty": true } },
            { no: 3, name: "commission", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DecCoin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.DecCoins" } }
        ]);
    }
    create(value?: PartialMessage<QueryValidatorDistributionInfoResponse>): QueryValidatorDistributionInfoResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.operatorAddress = "";
        message.selfBondRewards = [];
        message.commission = [];
        if (value !== undefined)
            reflectionMergePartial<QueryValidatorDistributionInfoResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryValidatorDistributionInfoResponse): QueryValidatorDistributionInfoResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string operator_address */ 1:
                    ...
                    break;
                case /* repeated cosmos.base.v1beta1.DecCoin self_bond_rewards */ 2:
                    message.selfBondRewards.push(DecCoin.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated cosmos.base.v1beta1.DecCoin commission */ 3:
    ...
    internalBinaryWrite(message: QueryValidatorDistributionInfoResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message cosmos.distribution.v1beta1.QueryValidatorDistributionInfoResponse
 */
export const QueryValidatorDistributionInfoResponse = new QueryValidatorDistributionInfoResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class QueryValidatorSlashesResponse$Type extends MessageType<QueryValidatorSlashesResponse> {
    constructor() {
        super("cosmos.distribution.v1beta1.QueryValidatorSlashesResponse", [
            { no: 1, name: "slashes", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ValidatorSlashEvent, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
...
class QueryDelegationRewardsResponse$Type extends MessageType<QueryDelegationRewardsResponse> {
    constructor() {
        super("cosmos.distribution.v1beta1.QueryDelegationRewardsResponse", [
            { no: 1, name: "rewards", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DecCoin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.DecCoins", "amino.dont_omitempty": true } }
        ]);
    }
...
class QueryDelegationTotalRewardsResponse$Type extends MessageType<QueryDelegationTotalRewardsResponse> {
    constructor() {
        super("cosmos.distribution.v1beta1.QueryDelegationTotalRewardsResponse", [
            { no: 1, name: "rewards", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DelegationDelegatorReward, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 2, name: "total", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DecCoin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.DecCoins", "amino.dont_omitempty": true } }
        ]);
    }
...
class QueryCommunityPoolResponse$Type extends MessageType<QueryCommunityPoolResponse> {
    constructor() {
        super("cosmos.distribution.v1beta1.QueryCommunityPoolResponse", [
            { no: 1, name: "pool", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DecCoin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.DecCoins", "amino.dont_omitempty": true } }
        ]);
    }
