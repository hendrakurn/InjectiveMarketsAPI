...
class Params$Type extends MessageType<Params> {
    constructor() {
        super("cosmos.distribution.v1beta1.Params", [
            { no: 1, name: "community_tax", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "cosmos_proto.scalar": "cosmos.Dec", "amino.dont_omitempty": true } },
            { no: 2, name: "base_proposer_reward", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "cosmos_proto.scalar": "cosmos.Dec", "amino.dont_omitempty": true } },
            { no: 3, name: "bonus_proposer_reward", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "cosmos_proto.scalar": "cosmos.Dec", "amino.dont_omitempty": true } },
            { no: 4, name: "withdraw_addr_enabled", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ], { "amino.name": "cosmos-sdk/x/distribution/Params" });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string community_tax */ 1:
                    ...
                    break;
                case /* string base_proposer_reward = 2 [deprecated = true] */ 2:
                    message.baseProposerReward = reader.string();
                    break;
                case /* string bonus_proposer_reward = 3 [deprecated = true] */ 3:
    ...
    internalBinaryWrite(message: Params, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string base_proposer_reward = 2 [deprecated = true]; */
        if (message.baseProposerReward !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.baseProposerReward);
        /* string bonus_proposer_reward = 3 [deprecated = true]; */
...
class ValidatorHistoricalRewards$Type extends MessageType<ValidatorHistoricalRewards> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorHistoricalRewards", [
            { no: 1, name: "cumulative_reward_ratio", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DecCoin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.DecCoins", "amino.dont_omitempty": true } },
...
class ValidatorAccumulatedCommission$Type extends MessageType<ValidatorAccumulatedCommission> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorAccumulatedCommission", [
            { no: 1, name: "commission", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DecCoin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.DecCoins", "amino.dont_omitempty": true } }
        ]);
    }
...
class ValidatorSlashEvent$Type extends MessageType<ValidatorSlashEvent> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorSlashEvent", [
            ...
            { no: 2, name: "fraction", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "cosmos_proto.scalar": "cosmos.Dec" } }
        ]);
    }
    create(value?: PartialMessage<ValidatorSlashEvent>): ValidatorSlashEvent {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.validatorPeriod = 0n;
        message.fraction = "";
        if (value !== undefined)
...
class ValidatorSlashEvents$Type extends MessageType<ValidatorSlashEvents> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorSlashEvents", [
            { no: 1, name: "validator_slash_events", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ValidatorSlashEvent, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
...
class FeePool$Type extends MessageType<FeePool> {
    constructor() {
        super("cosmos.distribution.v1beta1.FeePool", [
            { no: 1, name: "community_pool", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DecCoin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.DecCoins", "amino.dont_omitempty": true } }
        ]);
    }
...
class CommunityPoolSpendProposal$Type extends MessageType<CommunityPoolSpendProposal> {
    constructor() {
        super("cosmos.distribution.v1beta1.CommunityPoolSpendProposal", [
            ...
            { no: 4, name: "amount", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins", "amino.encoding": "legacy_coins", "amino.dont_omitempty": true } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false, "cosmos_proto.implements_interface": ["cosmos.gov.v1beta1.Content"] });
    }
...
class DelegatorStartingInfo$Type extends MessageType<DelegatorStartingInfo> {
    constructor() {
        super("cosmos.distribution.v1beta1.DelegatorStartingInfo", [
            ...
            { no: 2, name: "stake", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec", "cosmos_proto.scalar": "cosmos.Dec", "amino.dont_omitempty": true } },
            { no: 3, name: "height", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/, options: { "gogoproto.jsontag": "creation_height", "amino.field_name": "creation_height", "amino.dont_omitempty": true } }
        ]);
    }
    create(value?: PartialMessage<DelegatorStartingInfo>): DelegatorStartingInfo {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.previousPeriod = 0n;
        message.stake = "";
        message.height = 0n;
        if (value !== undefined)
...
class DelegationDelegatorReward$Type extends MessageType<DelegationDelegatorReward> {
    constructor() {
        super("cosmos.distribution.v1beta1.DelegationDelegatorReward", [
            ...
            { no: 2, name: "reward", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DecCoin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.DecCoins", "amino.dont_omitempty": true } }
