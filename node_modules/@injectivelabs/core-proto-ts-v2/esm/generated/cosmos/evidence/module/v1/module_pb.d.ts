...
// @generated from protobuf file "cosmos/evidence/module/v1/module.proto" (package "cosmos.evidence.module.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message cosmos.evidence.module.v1.Module
 */
...
class Module$Type extends MessageType<Module> {
    constructor() {
        super("cosmos.evidence.module.v1.Module", [], { "cosmos.app.v1alpha1.module": { goImport: "cosmossdk.io/x/evidence" } });
    }
...
/**
 * @generated MessageType for protobuf message cosmos.evidence.module.v1.Module
 */
