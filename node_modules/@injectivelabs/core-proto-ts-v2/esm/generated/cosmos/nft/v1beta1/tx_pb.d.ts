...
// @generated from protobuf file "cosmos/nft/v1beta1/tx.proto" (package "cosmos.nft.v1beta1", syntax proto3)
// tslint:disable
...
class MsgSend$Type extends MessageType<MsgSend> {
    constructor() {
        super("cosmos.nft.v1beta1.MsgSend", [
            ...
            { no: 3, name: "sender", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 4, name: "receiver", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
