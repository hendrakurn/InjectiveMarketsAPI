...
// @generated from protobuf file "cosmos/nft/v1beta1/query.proto" (package "cosmos.nft.v1beta1", syntax proto3)
// tslint:disable
...
class QueryNFTsResponse$Type extends MessageType<QueryNFTsResponse> {
    constructor() {
        super("cosmos.nft.v1beta1.QueryNFTsResponse", [
            { no: 1, name: "nfts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => NFT },
...
class QueryClassesResponse$Type extends MessageType<QueryClassesResponse> {
    constructor() {
        super("cosmos.nft.v1beta1.QueryClassesResponse", [
            { no: 1, name: "classes", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Class },
            { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
        ]);
    }
