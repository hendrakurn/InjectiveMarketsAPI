...
// @generated from protobuf file "cosmos/nft/v1beta1/genesis.proto" (package "cosmos.nft.v1beta1", syntax proto3)
// tslint:disable
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("cosmos.nft.v1beta1.GenesisState", [
            ...
            { no: 2, name: "entries", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Entry }
        ]);
    }
...
class Entry$Type extends MessageType<Entry> {
    constructor() {
        super("cosmos.nft.v1beta1.Entry", [
            ...
            { no: 2, name: "nfts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => NFT }
        ]);
    }
