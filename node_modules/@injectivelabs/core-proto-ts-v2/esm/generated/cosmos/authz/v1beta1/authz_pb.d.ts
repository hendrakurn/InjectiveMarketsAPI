...
class GenericAuthorization$Type extends MessageType<GenericAuthorization> {
    constructor() {
        ...
        ], { "cosmos_proto.implements_interface": ["cosmos.authz.v1beta1.Authorization"], "amino.name": "cosmos-sdk/GenericAuthorization" });
    }
...
class Grant$Type extends MessageType<Grant> {
    constructor() {
        super("cosmos.authz.v1beta1.Grant", [
            { no: 1, name: "authorization", kind: "message", T: () => Any, options: { "cosmos_proto.accepts_interface": "cosmos.authz.v1beta1.Authorization" } },
...
class GrantAuthorization$Type extends MessageType<GrantAuthorization> {
    constructor() {
        super("cosmos.authz.v1beta1.GrantAuthorization", [
            ...
            { no: 3, name: "authorization", kind: "message", T: () => Any, options: { "cosmos_proto.accepts_interface": "cosmos.authz.v1beta1.Authorization" } },
