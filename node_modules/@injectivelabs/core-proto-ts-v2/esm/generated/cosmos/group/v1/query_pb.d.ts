...
// @generated from protobuf file "cosmos/group/v1/query.proto" (package "cosmos.group.v1", syntax proto3)
// tslint:disable
...
import { TallyResult } from "./types_pb";
import { Vote } from "./types_pb";
import { Proposal } from "./types_pb";
import { PageResponse } from "../../base/query/v1beta1/pagination_pb";
import { GroupMember } from "./types_pb";
import { PageRequest } from "../../base/query/v1beta1/pagination_pb";
import { GroupPolicyInfo } from "./types_pb";
import { GroupInfo } from "./types_pb";
/**
 ...
 *
 * @generated from protobuf message cosmos.group.v1.QueryGroupsRequest
 */
 ...
 * Since: cosmos-sdk 0.47.1
 *
 * @generated from protobuf message cosmos.group.v1.QueryGroupsResponse
 */
...
class QueryGroupMembersResponse$Type extends MessageType<QueryGroupMembersResponse> {
    constructor() {
        super("cosmos.group.v1.QueryGroupMembersResponse", [
            { no: 1, name: "members", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => GroupMember },
...
class QueryGroupPoliciesByGroupResponse$Type extends MessageType<QueryGroupPoliciesByGroupResponse> {
    constructor() {
        super("cosmos.group.v1.QueryGroupPoliciesByGroupResponse", [
            { no: 1, name: "group_policies", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => GroupPolicyInfo },
            { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
        ]);
    }
...
class QueryGroupsRequest$Type extends MessageType<QueryGroupsRequest> {
    constructor() {
        super("cosmos.group.v1.QueryGroupsRequest", [
            { no: 2, name: "pagination", kind: "message", T: () => PageRequest }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message cosmos.group.v1.QueryGroupsRequest
 */
...
class QueryGroupsResponse$Type extends MessageType<QueryGroupsResponse> {
    constructor() {
        super("cosmos.group.v1.QueryGroupsResponse", [
            { no: 1, name: "groups", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => GroupInfo },
            { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message cosmos.group.v1.QueryGroupsResponse
 */
...
export const Query = new ServiceType("cosmos.group.v1.Query", [
    ...
    { name: "Groups", options: { "google.api.http": { get: "/cosmos/group/v1/groups" } }, I: QueryGroupsRequest, O: QueryGroupsResponse }
]);
