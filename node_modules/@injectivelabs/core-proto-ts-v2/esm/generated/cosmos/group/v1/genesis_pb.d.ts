...
// @generated from protobuf file "cosmos/group/v1/genesis.proto" (package "cosmos.group.v1", syntax proto3)
// tslint:disable
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("cosmos.group.v1.GenesisState", [
            ...
            { no: 2, name: "groups", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => GroupInfo },
            { no: 3, name: "group_members", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => GroupMember },
            { no: 4, name: "group_policy_seq", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 5, name: "group_policies", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => GroupPolicyInfo },
            { no: 6, name: "proposal_seq", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 7, name: "proposals", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Proposal },
            { no: 8, name: "votes", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Vote }
        ]);
    }
    create(value?: PartialMessage<GenesisState>): GenesisState {
        ...
        message.groupPolicySeq = 0n;
        message.groupPolicies = [];
        message.proposalSeq = 0n;
        message.proposals = [];
        message.votes = [];
        if (value !== undefined)
