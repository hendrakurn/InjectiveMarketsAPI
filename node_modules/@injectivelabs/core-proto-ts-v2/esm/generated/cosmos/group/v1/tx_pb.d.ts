...
// @generated from protobuf file "cosmos/group/v1/tx.proto" (package "cosmos.group.v1", syntax proto3)
// tslint:disable
...
import { VoteOption } from "./types_pb";
import { Any } from "../../../google/protobuf/any_pb";
import { MemberRequest } from "./types_pb";
// 
// Groups
// 
...
export interface MsgCreateGroup {
     ...
     *
     * @generated from protobuf field: repeated cosmos.group.v1.MemberRequest members = 2
     */
...
export interface MsgUpdateGroupMembers {
     ...
     *
     * @generated from protobuf field: repeated cosmos.group.v1.MemberRequest member_updates = 3
     */
...
export interface MsgSubmitProposal {
     ...
     * group_policy_address is the account address of group policy.
     *
     * @generated from protobuf field: string group_policy_address = 1
     */
    groupPolicyAddress: string;
    /**
...
export interface MsgExec {
     ...
     *
     * @generated from protobuf field: string executor = 2
     */
    executor: string;
}
/**
...
class MsgCreateGroup$Type extends MessageType<MsgCreateGroup> {
    constructor() {
        super("cosmos.group.v1.MsgCreateGroup", [
            ...
            { no: 2, name: "members", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => MemberRequest, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 3, name: "metadata", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ], { "amino.name": "cosmos-sdk/MsgCreateGroup", "cosmos.msg.v1.signer": ["admin"] });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string admin */ 1:
                    ...
                    break;
                case /* repeated cosmos.group.v1.MemberRequest members */ 2:
                    message.members.push(MemberRequest.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: MsgCreateGroup, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated cosmos.group.v1.MemberRequest members = 2; */
        for (let i = 0; i < message.members.length; i++)
            MemberRequest.internalBinaryWrite(message.members[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* string metadata = 3; */
        if (message.metadata !== "")
...
class MsgUpdateGroupMembers$Type extends MessageType<MsgUpdateGroupMembers> {
    constructor() {
        super("cosmos.group.v1.MsgUpdateGroupMembers", [
            ...
            { no: 3, name: "member_updates", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => MemberRequest, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ], { "amino.name": "cosmos-sdk/MsgUpdateGroupMembers", "cosmos.msg.v1.signer": ["admin"] });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 group_id */ 2:
                    message.groupId = reader.uint64().toBigInt();
                    break;
                case /* repeated cosmos.group.v1.MemberRequest member_updates */ 3:
                    message.memberUpdates.push(MemberRequest.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: MsgUpdateGroupMembers, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated cosmos.group.v1.MemberRequest member_updates = 3; */
        for (let i = 0; i < message.memberUpdates.length; i++)
            MemberRequest.internalBinaryWrite(message.memberUpdates[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class MsgUpdateGroupAdmin$Type extends MessageType<MsgUpdateGroupAdmin> {
    constructor() {
        ...
        ], { "amino.name": "cosmos-sdk/MsgUpdateGroupAdmin", "cosmos.msg.v1.signer": ["admin"] });
    }
...
class MsgUpdateGroupMetadata$Type extends MessageType<MsgUpdateGroupMetadata> {
    constructor() {
        super("cosmos.group.v1.MsgUpdateGroupMetadata", [
            ...
            { no: 2, name: "group_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "metadata", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ], { "amino.name": "cosmos-sdk/MsgUpdateGroupMetadata", "cosmos.msg.v1.signer": ["admin"] });
    }
...
class MsgCreateGroupPolicy$Type extends MessageType<MsgCreateGroupPolicy> {
    constructor() {
        super("cosmos.group.v1.MsgCreateGroupPolicy", [
            ...
            { no: 2, name: "group_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "metadata", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "decision_policy", kind: "message", T: () => Any, options: { "cosmos_proto.accepts_interface": "cosmos.group.v1.DecisionPolicy" } }
        ], { "gogoproto.goproto_getters": false, "amino.name": "cosmos-sdk/MsgCreateGroupPolicy", "cosmos.msg.v1.signer": ["admin"] });
    }
...
class MsgUpdateGroupPolicyAdmin$Type extends MessageType<MsgUpdateGroupPolicyAdmin> {
    constructor() {
        super("cosmos.group.v1.MsgUpdateGroupPolicyAdmin", [
            ...
            { no: 3, name: "new_admin", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ], { "amino.name": "cosmos-sdk/MsgUpdateGroupPolicyAdmin", "cosmos.msg.v1.signer": ["admin"] });
    }
...
class MsgCreateGroupWithPolicy$Type extends MessageType<MsgCreateGroupWithPolicy> {
    constructor() {
        ...
        ], { "gogoproto.goproto_getters": false, "amino.name": "cosmos-sdk/MsgCreateGroupWithPolicy", "cosmos.msg.v1.signer": ["admin"] });
    }
...
class MsgUpdateGroupPolicyDecisionPolicy$Type extends MessageType<MsgUpdateGroupPolicyDecisionPolicy> {
    constructor() {
        super("cosmos.group.v1.MsgUpdateGroupPolicyDecisionPolicy", [
            { no: 1, name: "admin", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "group_policy_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 3, name: "decision_policy", kind: "message", T: () => Any, options: { "cosmos_proto.accepts_interface": "cosmos.group.v1.DecisionPolicy" } }
        ], { "gogoproto.goproto_getters": false, "amino.name": "cosmos-sdk/MsgUpdateGroupDecisionPolicy", "cosmos.msg.v1.signer": ["admin"] });
    }
...
class MsgUpdateGroupPolicyMetadata$Type extends MessageType<MsgUpdateGroupPolicyMetadata> {
    constructor() {
        super("cosmos.group.v1.MsgUpdateGroupPolicyMetadata", [
            ...
            { no: 2, name: "group_policy_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 3, name: "metadata", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ], { "amino.name": "cosmos-sdk/MsgUpdateGroupPolicyMetadata", "cosmos.msg.v1.signer": ["admin"] });
    }
...
class MsgSubmitProposal$Type extends MessageType<MsgSubmitProposal> {
    constructor() {
        super("cosmos.group.v1.MsgSubmitProposal", [
            { no: 1, name: "group_policy_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "proposers", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "metadata", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "messages", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Any },
        ...
        ], { "gogoproto.goproto_getters": false, "amino.name": "cosmos-sdk/group/MsgSubmitProposal", "cosmos.msg.v1.signer": ["proposers"] });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MsgSubmitProposal): MsgSubmitProposal {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string group_policy_address */ 1:
                    message.groupPolicyAddress = reader.string();
                    break;
    ...
    internalBinaryWrite(message: MsgSubmitProposal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string group_policy_address = 1; */
        if (message.groupPolicyAddress !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.groupPolicyAddress);
...
class MsgWithdrawProposal$Type extends MessageType<MsgWithdrawProposal> {
    constructor() {
        ...
        ], { "amino.name": "cosmos-sdk/group/MsgWithdrawProposal", "cosmos.msg.v1.signer": ["address"] });
    }
...
class MsgVote$Type extends MessageType<MsgVote> {
    constructor() {
        super("cosmos.group.v1.MsgVote", [
            ...
            { no: 5, name: "exec", kind: "enum", T: () => ["cosmos.group.v1.Exec", Exec, "EXEC_"] }
        ], { "amino.name": "cosmos-sdk/group/MsgVote", "cosmos.msg.v1.signer": ["voter"] });
    }
...
class MsgExec$Type extends MessageType<MsgExec> {
    constructor() {
        super("cosmos.group.v1.MsgExec", [
            { no: 1, name: "proposal_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "executor", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ], { "amino.name": "cosmos-sdk/group/MsgExec", "cosmos.msg.v1.signer": ["executor"] });
    }
    ...
    internalBinaryWrite(message: MsgExec, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string executor = 2; */
        if (message.executor !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.executor);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class MsgLeaveGroup$Type extends MessageType<MsgLeaveGroup> {
    constructor() {
        super("cosmos.group.v1.MsgLeaveGroup", [
            { no: 1, name: "address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "group_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ], { "amino.name": "cosmos-sdk/group/MsgLeaveGroup", "cosmos.msg.v1.signer": ["address"] });
    }
