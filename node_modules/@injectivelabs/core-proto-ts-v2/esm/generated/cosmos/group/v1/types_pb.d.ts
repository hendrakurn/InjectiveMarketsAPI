...
// @generated from protobuf file "cosmos/group/v1/types.proto" (package "cosmos.group.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message cosmos.group.v1.MemberRequest
 */
...
export interface Proposal {
     ...
     *
     * @generated from protobuf field: cosmos.group.v1.TallyResult final_tally_result = 9
     */
     ...
     * accordingly updated.
     *
     * @generated from protobuf field: google.protobuf.Timestamp voting_period_end = 10
     */
    votingPeriodEnd?: Timestamp;
    /**
     * executor_result is the final result of the proposal execution. Initial value is NotRun.
     *
     * @generated from protobuf field: cosmos.group.v1.ProposalExecutorResult executor_result = 11
     */
    executorResult: ProposalExecutorResult;
    /**
     * messages is a list of `sdk.Msg`s that will be executed if the proposal passes.
     *
     * @generated from protobuf field: repeated google.protobuf.Any messages = 12
     */
    messages: Any[];
    /**
     ...
     *
     * @generated from protobuf field: string title = 13
     */
    title: string;
    /**
...
export enum ProposalStatus {
     ...
     *
     * @generated from protobuf enum value: PROPOSAL_STATUS_ACCEPTED = 2;
     */
    ACCEPTED = 2,
    /**
     * Final status of a proposal when the final tally is done and the outcome
     ...
     *
     * @generated from protobuf enum value: PROPOSAL_STATUS_REJECTED = 3;
     */
    REJECTED = 3,
    /**
     ...
     * final tally.
     *
     * @generated from protobuf enum value: PROPOSAL_STATUS_ABORTED = 4;
     */
    ABORTED = 4,
    /**
     ...
     *
     * @generated from protobuf enum value: PROPOSAL_STATUS_WITHDRAWN = 5;
     */
    WITHDRAWN = 5
}
/**
...
class Member$Type extends MessageType<Member> {
    constructor() {
        super("cosmos.group.v1.Member", [
            ...
            { no: 4, name: "added_at", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true, "amino.dont_omitempty": true } }
        ]);
    }
...
class MemberRequest$Type extends MessageType<MemberRequest> {
    constructor() {
        super("cosmos.group.v1.MemberRequest", [
            { no: 1, name: "address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "weight", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "metadata", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    ...
    create(value?: PartialMessage<MemberRequest>): MemberRequest {
        ...
        message.metadata = "";
        if (value !== undefined)
            reflectionMergePartial<MemberRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MemberRequest): MemberRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
...
/**
 * @generated MessageType for protobuf message cosmos.group.v1.MemberRequest
 */
...
class ThresholdDecisionPolicy$Type extends MessageType<ThresholdDecisionPolicy> {
    constructor() {
        ...
        ], { "cosmos_proto.implements_interface": ["cosmos.group.v1.DecisionPolicy"], "amino.name": "cosmos-sdk/ThresholdDecisionPolicy" });
    }
...
class PercentageDecisionPolicy$Type extends MessageType<PercentageDecisionPolicy> {
    constructor() {
        super("cosmos.group.v1.PercentageDecisionPolicy", [
            ...
            { no: 2, name: "windows", kind: "message", T: () => DecisionPolicyWindows }
        ], { "cosmos_proto.implements_interface": ["cosmos.group.v1.DecisionPolicy"], "amino.name": "cosmos-sdk/PercentageDecisionPolicy" });
    }
...
class DecisionPolicyWindows$Type extends MessageType<DecisionPolicyWindows> {
    constructor() {
        super("cosmos.group.v1.DecisionPolicyWindows", [
            { no: 1, name: "voting_period", kind: "message", T: () => Duration, options: { "gogoproto.nullable": false, "gogoproto.stdduration": true, "amino.dont_omitempty": true } },
            { no: 2, name: "min_execution_period", kind: "message", T: () => Duration, options: { "gogoproto.nullable": false, "gogoproto.stdduration": true, "amino.dont_omitempty": true } }
        ]);
    }
...
class GroupInfo$Type extends MessageType<GroupInfo> {
    constructor() {
        super("cosmos.group.v1.GroupInfo", [
            ...
            { no: 6, name: "created_at", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true, "amino.dont_omitempty": true } }
        ]);
    }
...
class GroupPolicyInfo$Type extends MessageType<GroupPolicyInfo> {
    constructor() {
        super("cosmos.group.v1.GroupPolicyInfo", [
            ...
            { no: 6, name: "decision_policy", kind: "message", T: () => Any, options: { "cosmos_proto.accepts_interface": "cosmos.group.v1.DecisionPolicy" } },
            { no: 7, name: "created_at", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true, "amino.dont_omitempty": true } }
...
class Proposal$Type extends MessageType<Proposal> {
    constructor() {
        super("cosmos.group.v1.Proposal", [
            ...
            { no: 5, name: "submit_time", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true, "amino.dont_omitempty": true } },
            ...
            { no: 9, name: "final_tally_result", kind: "message", T: () => TallyResult, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 10, name: "voting_period_end", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true, "amino.dont_omitempty": true } },
            { no: 11, name: "executor_result", kind: "enum", T: () => ["cosmos.group.v1.ProposalExecutorResult", ProposalExecutorResult, "PROPOSAL_EXECUTOR_RESULT_"] },
            { no: 12, name: "messages", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Any },
    ...
    create(value?: PartialMessage<Proposal>): Proposal {
        ...
        message.metadata = "";
        message.proposers = [];
        message.groupVersion = 0n;
        message.groupPolicyVersion = 0n;
        message.status = 0;
    ...
    internalBinaryWrite(message: Proposal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* cosmos.group.v1.TallyResult final_tally_result = 9; */
        if (message.finalTallyResult)
            TallyResult.internalBinaryWrite(message.finalTallyResult, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
        /* google.protobuf.Timestamp voting_period_end = 10; */
        if (message.votingPeriodEnd)
            Timestamp.internalBinaryWrite(message.votingPeriodEnd, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
        /* cosmos.group.v1.ProposalExecutorResult executor_result = 11; */
        if (message.executorResult !== 0)
            writer.tag(11, WireType.Varint).int32(message.executorResult);
        /* repeated google.protobuf.Any messages = 12; */
        for (let i = 0; i < message.messages.length; i++)
            Any.internalBinaryWrite(message.messages[i], writer.tag(12, WireType.LengthDelimited).fork(), options).join();
        /* string title = 13; */
        if (message.title !== "")
