...
class SignDocDirectAux$Type extends MessageType<SignDocDirectAux> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 sequence */ 5:
                    ...
                    break;
                case /* cosmos.tx.v1beta1.Tip tip = 6 [deprecated = true] */ 6:
    ...
    internalBinaryWrite(message: SignDocDirectAux, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* cosmos.tx.v1beta1.Tip tip = 6 [deprecated = true]; */
        if (message.tip)
...
class TxBody$Type extends MessageType<TxBody> {
    constructor() {
        super("cosmos.tx.v1beta1.TxBody", [
            { no: 1, name: "messages", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Any },
            ...
            { no: 1023, name: "extension_options", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Any },
            { no: 2047, name: "non_critical_extension_options", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Any }
        ]);
    }
...
class AuthInfo$Type extends MessageType<AuthInfo> {
    constructor() {
        super("cosmos.tx.v1beta1.AuthInfo", [
            { no: 1, name: "signer_infos", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => SignerInfo },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* cosmos.tx.v1beta1.Fee fee */ 2:
                    ...
                    break;
                case /* cosmos.tx.v1beta1.Tip tip = 3 [deprecated = true] */ 3:
                    message.tip = Tip.internalBinaryRead(reader, reader.uint32(), options, message.tip);
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: AuthInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* cosmos.tx.v1beta1.Tip tip = 3 [deprecated = true]; */
        if (message.tip)
...
class ModeInfo_Multi$Type extends MessageType<ModeInfo_Multi> {
    constructor() {
        super("cosmos.tx.v1beta1.ModeInfo.Multi", [
            ...
            { no: 2, name: "mode_infos", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ModeInfo }
        ]);
    }
