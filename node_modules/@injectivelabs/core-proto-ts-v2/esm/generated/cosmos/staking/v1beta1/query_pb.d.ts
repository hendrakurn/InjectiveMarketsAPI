...
import { Params } from "./staking_pb";
import { Pool } from "./staking_pb";
import { HistoricalInfo } from "./staking_pb";
import { RedelegationResponse } from "./staking_pb";
import { UnbondingDelegation } from "./staking_pb";
import { DelegationResponse } from "./staking_pb";
import { PageResponse } from "../../base/query/v1beta1/pagination_pb";
import { Validator } from "./staking_pb";
import { PageRequest } from "../../base/query/v1beta1/pagination_pb";
/**
 ...
 *
 * @generated from protobuf message cosmos.staking.v1beta1.QueryAllowedDelegationTransferReceiversRequest
 */
 ...
 * Query/AllowedDelegationTransferReceivers RPC method.
 *
 * @generated from protobuf message cosmos.staking.v1beta1.QueryAllowedDelegationTransferReceiversResponse
 */
...
class QueryValidatorsResponse$Type extends MessageType<QueryValidatorsResponse> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryValidatorsResponse", [
            { no: 1, name: "validators", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Validator, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
...
class QueryValidatorRequest$Type extends MessageType<QueryValidatorRequest> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryValidatorRequest", [
            { no: 1, name: "validator_addr", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.ValidatorAddressString" } }
        ]);
    }
...
class QueryValidatorResponse$Type extends MessageType<QueryValidatorResponse> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryValidatorResponse", [
            { no: 1, name: "validator", kind: "message", T: () => Validator, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
...
class QueryValidatorDelegationsResponse$Type extends MessageType<QueryValidatorDelegationsResponse> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryValidatorDelegationsResponse", [
            { no: 1, name: "delegation_responses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DelegationResponse, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "DelegationResponses", "amino.dont_omitempty": true } },
            { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
        ]);
    }
...
class QueryValidatorUnbondingDelegationsResponse$Type extends MessageType<QueryValidatorUnbondingDelegationsResponse> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryValidatorUnbondingDelegationsResponse", [
            { no: 1, name: "unbonding_responses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UnbondingDelegation, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
        ]);
    }
...
class QueryDelegationRequest$Type extends MessageType<QueryDelegationRequest> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryDelegationRequest", [
            ...
            { no: 2, name: "validator_addr", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.ValidatorAddressString" } }
...
class QueryUnbondingDelegationResponse$Type extends MessageType<QueryUnbondingDelegationResponse> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryUnbondingDelegationResponse", [
            { no: 1, name: "unbond", kind: "message", T: () => UnbondingDelegation, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
...
class QueryDelegatorDelegationsResponse$Type extends MessageType<QueryDelegatorDelegationsResponse> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryDelegatorDelegationsResponse", [
            { no: 1, name: "delegation_responses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DelegationResponse, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
        ]);
    }
...
class QueryRedelegationsRequest$Type extends MessageType<QueryRedelegationsRequest> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryRedelegationsRequest", [
            { no: 1, name: "delegator_addr", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "src_validator_addr", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.ValidatorAddressString" } },
            { no: 3, name: "dst_validator_addr", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.ValidatorAddressString" } },
...
class QueryRedelegationsResponse$Type extends MessageType<QueryRedelegationsResponse> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryRedelegationsResponse", [
            { no: 1, name: "redelegation_responses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => RedelegationResponse, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
        ]);
    }
...
// @generated message type with reflection information, may provide speed optimized methods
class QueryAllowedDelegationTransferReceiversRequest$Type extends MessageType<QueryAllowedDelegationTransferReceiversRequest> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryAllowedDelegationTransferReceiversRequest", []);
    }
    create(value?: PartialMessage<QueryAllowedDelegationTransferReceiversRequest>): QueryAllowedDelegationTransferReceiversRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<QueryAllowedDelegationTransferReceiversRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryAllowedDelegationTransferReceiversRequest): QueryAllowedDelegationTransferReceiversRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: QueryAllowedDelegationTransferReceiversRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message cosmos.staking.v1beta1.QueryAllowedDelegationTransferReceiversRequest
 */
export const QueryAllowedDelegationTransferReceiversRequest = new QueryAllowedDelegationTransferReceiversRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class QueryAllowedDelegationTransferReceiversResponse$Type extends MessageType<QueryAllowedDelegationTransferReceiversResponse> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryAllowedDelegationTransferReceiversResponse", [
    ...
    create(value?: PartialMessage<QueryAllowedDelegationTransferReceiversResponse>): QueryAllowedDelegationTransferReceiversResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.addresses = [];
        if (value !== undefined)
            reflectionMergePartial<QueryAllowedDelegationTransferReceiversResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryAllowedDelegationTransferReceiversResponse): QueryAllowedDelegationTransferReceiversResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: QueryAllowedDelegationTransferReceiversResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message cosmos.staking.v1beta1.QueryAllowedDelegationTransferReceiversResponse
 */
export const QueryAllowedDelegationTransferReceiversResponse = new QueryAllowedDelegationTransferReceiversResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class QueryPoolResponse$Type extends MessageType<QueryPoolResponse> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryPoolResponse", [
            { no: 1, name: "pool", kind: "message", T: () => Pool, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
...
export const Query = new ServiceType("cosmos.staking.v1beta1.Query", [
    { name: "Validators", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/validators" }, "cosmos.query.v1.module_query_safe": true }, I: QueryValidatorsRequest, O: QueryValidatorsResponse },
    { name: "Validator", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/validators/{validator_addr}" }, "cosmos.query.v1.module_query_safe": true }, I: QueryValidatorRequest, O: QueryValidatorResponse },
    { name: "ValidatorDelegations", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/validators/{validator_addr}/delegations" }, "cosmos.query.v1.module_query_safe": true }, I: QueryValidatorDelegationsRequest, O: QueryValidatorDelegationsResponse },
    { name: "ValidatorUnbondingDelegations", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/validators/{validator_addr}/unbonding_delegations" }, "cosmos.query.v1.module_query_safe": true }, I: QueryValidatorUnbondingDelegationsRequest, O: QueryValidatorUnbondingDelegationsResponse },
    { name: "Delegation", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/validators/{validator_addr}/delegations/{delegator_addr}" }, "cosmos.query.v1.module_query_safe": true }, I: QueryDelegationRequest, O: QueryDelegationResponse },
    { name: "UnbondingDelegation", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/validators/{validator_addr}/delegations/{delegator_addr}/unbonding_delegation" }, "cosmos.query.v1.module_query_safe": true }, I: QueryUnbondingDelegationRequest, O: QueryUnbondingDelegationResponse },
    { name: "DelegatorDelegations", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/delegations/{delegator_addr}" }, "cosmos.query.v1.module_query_safe": true }, I: QueryDelegatorDelegationsRequest, O: QueryDelegatorDelegationsResponse },
    { name: "DelegatorUnbondingDelegations", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/delegators/{delegator_addr}/unbonding_delegations" }, "cosmos.query.v1.module_query_safe": true }, I: QueryDelegatorUnbondingDelegationsRequest, O: QueryDelegatorUnbondingDelegationsResponse },
    { name: "Redelegations", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/delegators/{delegator_addr}/redelegations" }, "cosmos.query.v1.module_query_safe": true }, I: QueryRedelegationsRequest, O: QueryRedelegationsResponse },
    { name: "DelegatorValidators", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/delegators/{delegator_addr}/validators" }, "cosmos.query.v1.module_query_safe": true }, I: QueryDelegatorValidatorsRequest, O: QueryDelegatorValidatorsResponse },
    { name: "DelegatorValidator", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/delegators/{delegator_addr}/validators/{validator_addr}" }, "cosmos.query.v1.module_query_safe": true }, I: QueryDelegatorValidatorRequest, O: QueryDelegatorValidatorResponse },
    { name: "AllowedDelegationTransferReceivers", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/allowed_delegation_transfer_receivers" }, "cosmos.query.v1.module_query_safe": true }, I: QueryAllowedDelegationTransferReceiversRequest, O: QueryAllowedDelegationTransferReceiversResponse },
    { name: "HistoricalInfo", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/historical_info/{height}" }, "cosmos.query.v1.module_query_safe": true }, I: QueryHistoricalInfoRequest, O: QueryHistoricalInfoResponse },
    { name: "Pool", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/pool" }, "cosmos.query.v1.module_query_safe": true }, I: QueryPoolRequest, O: QueryPoolResponse },
    { name: "Params", options: { "google.api.http": { get: "/cosmos/staking/v1beta1/params" }, "cosmos.query.v1.module_query_safe": true }, I: QueryParamsRequest, O: QueryParamsResponse }
]);
