...
import { Redelegation } from "./staking_pb";
import { UnbondingDelegation } from "./staking_pb";
import { Delegation } from "./staking_pb";
...
export interface GenesisState {
     ...
     * transfers.
     *
     * @generated from protobuf field: repeated string allowed_delegation_transfer_receivers = 9
     */
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("cosmos.staking.v1beta1.GenesisState", [
            ...
            { no: 2, name: "last_total_power", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.Int", "cosmos_proto.scalar": "cosmos.Int", "amino.dont_omitempty": true } },
            { no: 3, name: "last_validator_powers", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => LastValidatorPower, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 4, name: "validators", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Validator, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 5, name: "delegations", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Delegation, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 6, name: "unbonding_delegations", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UnbondingDelegation, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 7, name: "redelegations", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Redelegation, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } },
            { no: 8, name: "exported", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 9, name: "allowed_delegation_transfer_receivers", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ]);
    }
    create(value?: PartialMessage<GenesisState>): GenesisState {
        ...
        message.allowedDelegationTransferReceivers = [];
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool exported */ 8:
                    ...
                    break;
                case /* repeated string allowed_delegation_transfer_receivers */ 9:
    ...
    internalBinaryWrite(message: GenesisState, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated string allowed_delegation_transfer_receivers = 9; */
        for (let i = 0; i < message.allowedDelegationTransferReceivers.length; i++)
            writer.tag(9, WireType.LengthDelimited).string(message.allowedDelegationTransferReceivers[i]);
