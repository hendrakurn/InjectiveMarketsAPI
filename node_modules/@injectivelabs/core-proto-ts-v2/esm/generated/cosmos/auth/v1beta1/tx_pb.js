...
class MsgUpdateParams$Type extends MessageType {
  constructor() {
    super("cosmos.auth.v1beta1.MsgUpdateParams", [
    ...
    ], { "amino.name": "cosmos-sdk/x/auth/MsgUpdateParams", "cosmos.msg.v1.signer": ["authority"] });
  }
  create(value) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          ...
          break;
        case /* cosmos.auth.v1beta1.Params params */
        2:
...
class MsgUpdateParamsResponse$Type extends MessageType {
  constructor() {
    super("cosmos.auth.v1beta1.MsgUpdateParamsResponse", []);
  }
  create(value) {
    const message = globalThis.Object.create(this.messagePrototype);
    if (value !== void 0)
...
const Msg = new ServiceType("cosmos.auth.v1beta1.Msg", [
