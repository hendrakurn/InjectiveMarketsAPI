...
class Params$Type extends MessageType<Params> {
    constructor() {
        super("cosmos.bank.v1beta1.Params", [
            { no: 1, name: "send_enabled", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => SendEnabled },
            { no: 2, name: "default_send_enabled", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ], { "amino.name": "cosmos-sdk/x/bank/Params" });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Params): Params {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated cosmos.bank.v1beta1.SendEnabled send_enabled = 1 [deprecated = true] */ 1:
    ...
    internalBinaryWrite(message: Params, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated cosmos.bank.v1beta1.SendEnabled send_enabled = 1 [deprecated = true]; */
...
class Input$Type extends MessageType<Input> {
    constructor() {
        super("cosmos.bank.v1beta1.Input", [
            ...
            { no: 2, name: "coins", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins", "amino.encoding": "legacy_coins", "amino.dont_omitempty": true } }
...
class Supply$Type extends MessageType<Supply> {
    constructor() {
        super("cosmos.bank.v1beta1.Supply", [
            { no: 1, name: "total", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins", "amino.encoding": "legacy_coins", "amino.dont_omitempty": true } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": true, "cosmos_proto.implements_interface": ["cosmos.bank.v1beta1.SupplyI"] });
    }
...
class Metadata$Type extends MessageType<Metadata> {
    constructor() {
        super("cosmos.bank.v1beta1.Metadata", [
            ...
            { no: 2, name: "denom_units", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DenomUnit },
