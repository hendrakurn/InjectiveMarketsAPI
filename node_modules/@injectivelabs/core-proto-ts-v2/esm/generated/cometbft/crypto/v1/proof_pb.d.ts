...
// @generated from protobuf file "cometbft/crypto/v1/proof.proto" (package "cometbft.crypto.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message cometbft.crypto.v1.Proof
 */
 ...
 *
 * @generated from protobuf message cometbft.crypto.v1.ValueOp
 */
export interface ValueOp {
     ...
     *
     * @generated from protobuf field: cometbft.crypto.v1.Proof proof = 2
     */
    proof?: Proof;
}
/**
 ...
 *
 * @generated from protobuf message cometbft.crypto.v1.DominoOp
 */
 ...
 *
 * @generated from protobuf message cometbft.crypto.v1.ProofOp
 */
 ...
 *
 * @generated from protobuf message cometbft.crypto.v1.ProofOps
 */
export interface ProofOps {
    /**
     * @generated from protobuf field: repeated cometbft.crypto.v1.ProofOp ops = 1
     */
    ops: ProofOp[];
}
...
class Proof$Type extends MessageType<Proof> {
    constructor() {
        super("cometbft.crypto.v1.Proof", [
...
/**
 * @generated MessageType for protobuf message cometbft.crypto.v1.Proof
 */
export const Proof = new Proof$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ValueOp$Type extends MessageType<ValueOp> {
    constructor() {
        super("cometbft.crypto.v1.ValueOp", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bytes key */ 1:
                    ...
                    break;
                case /* cometbft.crypto.v1.Proof proof */ 2:
    ...
    internalBinaryWrite(message: ValueOp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* cometbft.crypto.v1.Proof proof = 2; */
        if (message.proof)
...
/**
 * @generated MessageType for protobuf message cometbft.crypto.v1.ValueOp
 */
export const ValueOp = new ValueOp$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DominoOp$Type extends MessageType<DominoOp> {
    constructor() {
        super("cometbft.crypto.v1.DominoOp", [
...
/**
 * @generated MessageType for protobuf message cometbft.crypto.v1.DominoOp
 */
export const DominoOp = new DominoOp$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ProofOp$Type extends MessageType<ProofOp> {
    constructor() {
        super("cometbft.crypto.v1.ProofOp", [
...
/**
 * @generated MessageType for protobuf message cometbft.crypto.v1.ProofOp
 */
export const ProofOp = new ProofOp$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ProofOps$Type extends MessageType<ProofOps> {
    constructor() {
        super("cometbft.crypto.v1.ProofOps", [
            { no: 1, name: "ops", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ProofOp, options: { "gogoproto.nullable": false } }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ProofOps): ProofOps {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated cometbft.crypto.v1.ProofOp ops */ 1:
    ...
    internalBinaryWrite(message: ProofOps, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated cometbft.crypto.v1.ProofOp ops = 1; */
...
/**
 * @generated MessageType for protobuf message cometbft.crypto.v1.ProofOps
 */
