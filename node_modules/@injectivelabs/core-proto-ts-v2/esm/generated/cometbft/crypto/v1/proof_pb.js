    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        2:
          ...
          break;
        case /* bytes leaf_hash */
        3:
          message.leafHash = reader.bytes();
          break;
        case /* repeated bytes aunts */
        4:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          ...
          break;
        case /* cometbft.crypto.v1.Proof proof */
        2:
...
const ValueOp = new ValueOp$Type();
...
const DominoOp = new DominoOp$Type();
...
const ProofOp = new ProofOp$Type();
class ProofOps$Type extends MessageType {
  constructor() {
    super("cometbft.crypto.v1.ProofOps", [
      { no: 1, name: "ops", kind: "message", repeat: 2, T: () => ProofOp, options: { "gogoproto.nullable": false } }
    ]);
  }
  create(value) {
    const message = globalThis.Object.create(this.messagePrototype);
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* repeated cometbft.crypto.v1.ProofOp ops */
        1:
...
const ProofOps = new ProofOps$Type();
export {
  DominoOp,
  Proof,
  ProofOp,
