...
// @generated from protobuf file "cometbft/types/v1/types.proto" (package "cometbft.types.v1", syntax proto3)
// tslint:disable
...
import { ValidatorSet } from "./validator_pb";
import { BlockIDFlag } from "./validator_pb";
import { Timestamp } from "../../../google/protobuf/timestamp_pb";
import { Consensus } from "../../version/v1/types_pb";
import { Proof } from "../../crypto/v1/proof_pb";
/**
 ...
 * Part of the block.
 *
 * @generated from protobuf message cometbft.types.v1.Part
 */
export interface Part {
    ...
    bytes: Uint8Array;
    /**
     * @generated from protobuf field: cometbft.crypto.v1.Proof proof = 3
     */
    proof?: Proof;
}
/**
 ...
 *
 * @generated from protobuf message cometbft.types.v1.ExtendedCommit
 */
export interface ExtendedCommit {
    ...
    blockId?: BlockID;
    /**
     * @generated from protobuf field: repeated cometbft.types.v1.ExtendedCommitSig extended_signatures = 4
     */
 ...
 *
 * @generated from protobuf message cometbft.types.v1.ExtendedCommitSig
 */
export interface ExtendedCommitSig {
     ...
     * Vote extension data
     *
     * @generated from protobuf field: bytes extension = 5
     */
    extension: Uint8Array;
    /**
     * Vote extension signature
     *
     * @generated from protobuf field: bytes extension_signature = 6
     */
    extensionSignature: Uint8Array;
}
/**
 * Block proposal.
 *
 * @generated from protobuf message cometbft.types.v1.Proposal
 */
export interface Proposal {
    ...
    polRound: number;
    /**
     * @generated from protobuf field: cometbft.types.v1.BlockID block_id = 5
     */
    blockId?: BlockID;
    /**
 ...
 *
 * @generated from protobuf message cometbft.types.v1.BlockMeta
 */
export interface BlockMeta {
    /**
     * @generated from protobuf field: cometbft.types.v1.BlockID block_id = 1
     */
    blockId?: BlockID;
    /**
    ...
    blockSize: bigint;
    /**
     * @generated from protobuf field: cometbft.types.v1.Header header = 3
     */
    header?: Header;
    /**
 ...
 *
 * @generated from protobuf message cometbft.types.v1.TxProof
 */
...
class PartSetHeader$Type extends MessageType<PartSetHeader> {
    constructor() {
        super("cometbft.types.v1.PartSetHeader", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bytes bytes */ 2:
                    ...
                    break;
                case /* cometbft.crypto.v1.Proof proof */ 3:
...
/**
 * @generated MessageType for protobuf message cometbft.types.v1.Part
 */
export const Part = new Part$Type();
// @generated message type with reflection information, may provide speed optimized methods
class BlockID$Type extends MessageType<BlockID> {
    constructor() {
        super("cometbft.types.v1.BlockID", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bytes hash */ 1:
                    message.hash = reader.bytes();
                    break;
                case /* cometbft.types.v1.PartSetHeader part_set_header */ 2:
    ...
    internalBinaryWrite(message: BlockID, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* cometbft.types.v1.PartSetHeader part_set_header = 2; */
...
class Header$Type extends MessageType<Header> {
    constructor() {
        super("cometbft.types.v1.Header", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Header): Header {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* cometbft.version.v1.Consensus version */ 1:
                ...
                case /* google.protobuf.Timestamp time */ 4:
                    ...
                    break;
                case /* cometbft.types.v1.BlockID last_block_id */ 5:
    ...
    internalBinaryWrite(message: Header, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* cometbft.version.v1.Consensus version = 1; */
        if (message.version)
        ...
        /* cometbft.types.v1.BlockID last_block_id = 5; */
...
class Vote$Type extends MessageType<Vote> {
    constructor() {
        super("cometbft.types.v1.Vote", [
            { no: 1, name: "type", kind: "enum", T: () => ["cometbft.types.v1.SignedMsgType", SignedMsgType, "SIGNED_MSG_TYPE_"] },
    ...
    create(value?: PartialMessage<Vote>): Vote {
        ...
        message.extension = new Uint8Array(0);
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Vote): Vote {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* cometbft.types.v1.SignedMsgType type */ 1:
                ...
                case /* int32 round */ 3:
                    ...
                    break;
                case /* cometbft.types.v1.BlockID block_id */ 4:
                ...
                case /* bytes signature */ 8:
                    ...
                    break;
                case /* bytes extension */ 9:
                    message.extension = reader.bytes();
                    break;
                case /* bytes extension_signature */ 10:
    ...
    internalBinaryWrite(message: Vote, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* cometbft.types.v1.SignedMsgType type = 1; */
        if (message.type !== 0)
        ...
        /* cometbft.types.v1.BlockID block_id = 4; */
        if (message.blockId)
        ...
        if (message.extension.length)
            writer.tag(9, WireType.LengthDelimited).bytes(message.extension);
        /* bytes extension_signature = 10; */
        if (message.extensionSignature.length)
            writer.tag(10, WireType.LengthDelimited).bytes(message.extensionSignature);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class Commit$Type extends MessageType<Commit> {
    constructor() {
        super("cometbft.types.v1.Commit", [
            ...
            { no: 4, name: "signatures", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CommitSig, options: { "gogoproto.nullable": false } }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 round */ 2:
                    message.round = reader.int32();
                    break;
                case /* cometbft.types.v1.BlockID block_id */ 3:
                    message.blockId = BlockID.internalBinaryRead(reader, reader.uint32(), options, message.blockId);
                    break;
                case /* repeated cometbft.types.v1.CommitSig signatures */ 4:
...
class CommitSig$Type extends MessageType<CommitSig> {
    constructor() {
        super("cometbft.types.v1.CommitSig", [
            { no: 1, name: "block_id_flag", kind: "enum", T: () => ["cometbft.types.v1.BlockIDFlag", BlockIDFlag] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CommitSig): CommitSig {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* cometbft.types.v1.BlockIDFlag block_id_flag */ 1:
    ...
    internalBinaryWrite(message: CommitSig, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* cometbft.types.v1.BlockIDFlag block_id_flag = 1; */
...
// @generated message type with reflection information, may provide speed optimized methods
class ExtendedCommit$Type extends MessageType<ExtendedCommit> {
    constructor() {
        super("cometbft.types.v1.ExtendedCommit", [
            { no: 1, name: "height", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "round", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 3, name: "block_id", kind: "message", T: () => BlockID, options: { "gogoproto.nullable": false, "gogoproto.customname": "BlockID" } },
            { no: 4, name: "extended_signatures", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ExtendedCommitSig, options: { "gogoproto.nullable": false } }
        ]);
    }
    create(value?: PartialMessage<ExtendedCommit>): ExtendedCommit {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.height = 0n;
        message.round = 0;
        message.extendedSignatures = [];
        if (value !== undefined)
            reflectionMergePartial<ExtendedCommit>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ExtendedCommit): ExtendedCommit {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* cometbft.types.v1.BlockID block_id */ 3:
                    message.blockId = BlockID.internalBinaryRead(reader, reader.uint32(), options, message.blockId);
                    break;
                case /* repeated cometbft.types.v1.ExtendedCommitSig extended_signatures */ 4:
                    message.extendedSignatures.push(ExtendedCommitSig.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: ExtendedCommit, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 height = 1; */
        if (message.height !== 0n)
            writer.tag(1, WireType.Varint).int64(message.height);
        /* int32 round = 2; */
        ...
        if (message.blockId)
            BlockID.internalBinaryWrite(message.blockId, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* repeated cometbft.types.v1.ExtendedCommitSig extended_signatures = 4; */
        for (let i = 0; i < message.extendedSignatures.length; i++)
            ExtendedCommitSig.internalBinaryWrite(message.extendedSignatures[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message cometbft.types.v1.ExtendedCommit
 */
export const ExtendedCommit = new ExtendedCommit$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ExtendedCommitSig$Type extends MessageType<ExtendedCommitSig> {
    constructor() {
        super("cometbft.types.v1.ExtendedCommitSig", [
            { no: 1, name: "block_id_flag", kind: "enum", T: () => ["cometbft.types.v1.BlockIDFlag", BlockIDFlag] },
            { no: 2, name: "validator_address", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 3, name: "timestamp", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true } },
            { no: 4, name: "signature", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
    ...
    create(value?: PartialMessage<ExtendedCommitSig>): ExtendedCommitSig {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.blockIdFlag = 0;
        message.validatorAddress = new Uint8Array(0);
        message.signature = new Uint8Array(0);
        ...
        message.extensionSignature = new Uint8Array(0);
        if (value !== undefined)
            reflectionMergePartial<ExtendedCommitSig>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ExtendedCommitSig): ExtendedCommitSig {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* bytes signature */ 4:
                    message.signature = reader.bytes();
                    break;
                case /* bytes extension */ 5:
                    message.extension = reader.bytes();
                    break;
                case /* bytes extension_signature */ 6:
                    message.extensionSignature = reader.bytes();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: ExtendedCommitSig, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* cometbft.types.v1.BlockIDFlag block_id_flag = 1; */
        if (message.blockIdFlag !== 0)
            writer.tag(1, WireType.Varint).int32(message.blockIdFlag);
        /* bytes validator_address = 2; */
        ...
        /* bytes extension = 5; */
        if (message.extension.length)
            writer.tag(5, WireType.LengthDelimited).bytes(message.extension);
        /* bytes extension_signature = 6; */
        if (message.extensionSignature.length)
            writer.tag(6, WireType.LengthDelimited).bytes(message.extensionSignature);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message cometbft.types.v1.ExtendedCommitSig
 */
export const ExtendedCommitSig = new ExtendedCommitSig$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Proposal$Type extends MessageType<Proposal> {
    constructor() {
        super("cometbft.types.v1.Proposal", [
            { no: 1, name: "type", kind: "enum", T: () => ["cometbft.types.v1.SignedMsgType", SignedMsgType, "SIGNED_MSG_TYPE_"] },
            { no: 2, name: "height", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "round", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 pol_round */ 4:
                    ...
                    break;
                case /* cometbft.types.v1.BlockID block_id */ 5:
                    message.blockId = BlockID.internalBinaryRead(reader, reader.uint32(), options, message.blockId);
                    break;
    ...
    internalBinaryWrite(message: Proposal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* cometbft.types.v1.BlockID block_id = 5; */
        if (message.blockId)
...
/**
 * @generated MessageType for protobuf message cometbft.types.v1.Proposal
 */
export const Proposal = new Proposal$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SignedHeader$Type extends MessageType<SignedHeader> {
    constructor() {
        super("cometbft.types.v1.SignedHeader", [
...
class LightBlock$Type extends MessageType<LightBlock> {
    constructor() {
        super("cometbft.types.v1.LightBlock", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: LightBlock): LightBlock {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* cometbft.types.v1.SignedHeader signed_header */ 1:
                    message.signedHeader = SignedHeader.internalBinaryRead(reader, reader.uint32(), options, message.signedHeader);
                    break;
                case /* cometbft.types.v1.ValidatorSet validator_set */ 2:
    ...
    internalBinaryWrite(message: LightBlock, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* cometbft.types.v1.SignedHeader signed_header = 1; */
...
class BlockMeta$Type extends MessageType<BlockMeta> {
    constructor() {
        super("cometbft.types.v1.BlockMeta", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: BlockMeta): BlockMeta {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* cometbft.types.v1.BlockID block_id */ 1:
                    message.blockId = BlockID.internalBinaryRead(reader, reader.uint32(), options, message.blockId);
                    break;
                case /* int64 block_size */ 2:
                    message.blockSize = reader.int64().toBigInt();
                    break;
                case /* cometbft.types.v1.Header header */ 3:
                    message.header = Header.internalBinaryRead(reader, reader.uint32(), options, message.header);
                    break;
    ...
    internalBinaryWrite(message: BlockMeta, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* cometbft.types.v1.Header header = 3; */
        if (message.header)
...
/**
 * @generated MessageType for protobuf message cometbft.types.v1.BlockMeta
 */
export const BlockMeta = new BlockMeta$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TxProof$Type extends MessageType<TxProof> {
    constructor() {
        super("cometbft.types.v1.TxProof", [
...
/**
 * @generated MessageType for protobuf message cometbft.types.v1.TxProof
 */
