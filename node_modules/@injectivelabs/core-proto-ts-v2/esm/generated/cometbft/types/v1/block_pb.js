...
import { Commit } from "./types_pb.js";
import { EvidenceList } from "./evidence_pb.js";
import { Data } from "./types_pb.js";
import { Header } from "./types_pb.js";
class Block$Type extends MessageType {
  constructor() {
    super("cometbft.types.v1.Block", [
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        3:
          ...
          break;
        case /* cometbft.types.v1.Commit last_commit */
        4:
