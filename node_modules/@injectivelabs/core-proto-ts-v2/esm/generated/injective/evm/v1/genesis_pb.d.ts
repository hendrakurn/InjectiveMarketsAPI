...
// @generated from protobuf file "injective/evm/v1/genesis.proto" (package "injective.evm.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message injective.evm.v1.GenesisState
 */
export interface GenesisState {
    /**
     * accounts is an array containing the ethereum genesis accounts.
     *
     * @generated from protobuf field: repeated injective.evm.v1.GenesisAccount accounts = 1
     */
 ...
 *
 * @generated from protobuf message injective.evm.v1.GenesisAccount
 */
export interface GenesisAccount {
     ...
     *
     * @generated from protobuf field: repeated injective.evm.v1.State storage = 3
     */
    storage: State[];
}
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("injective.evm.v1.GenesisState", [
            { no: 1, name: "accounts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => GenesisAccount, options: { "gogoproto.nullable": false } },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GenesisState): GenesisState {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated injective.evm.v1.GenesisAccount accounts */ 1:
    ...
    internalBinaryWrite(message: GenesisState, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated injective.evm.v1.GenesisAccount accounts = 1; */
...
/**
 * @generated MessageType for protobuf message injective.evm.v1.GenesisState
 */
export const GenesisState = new GenesisState$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GenesisAccount$Type extends MessageType<GenesisAccount> {
    constructor() {
        super("injective.evm.v1.GenesisAccount", [
            { no: 1, name: "address", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "code", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "storage", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => State, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "Storage" } }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string code */ 2:
                    ...
                    break;
                case /* repeated injective.evm.v1.State storage */ 3:
    ...
    internalBinaryWrite(message: GenesisAccount, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated injective.evm.v1.State storage = 3; */
...
/**
 * @generated MessageType for protobuf message injective.evm.v1.GenesisAccount
 */
