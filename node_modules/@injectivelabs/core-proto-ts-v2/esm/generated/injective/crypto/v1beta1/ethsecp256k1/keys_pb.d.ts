...
// @generated from protobuf file "injective/crypto/v1beta1/ethsecp256k1/keys.proto" (package "injective.crypto.v1beta1.ethsecp256k1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message injective.crypto.v1beta1.ethsecp256k1.PrivKey
 */
...
class PubKey$Type extends MessageType<PubKey> {
    constructor() {
        super("injective.crypto.v1beta1.ethsecp256k1.PubKey", [
            { no: 1, name: "key", kind: "scalar", T: 12 /*ScalarType.BYTES*/ }
        ], { "gogoproto.goproto_stringer": false, "amino.name": "injective/PubKeyEthSecp256k1", "amino.message_encoding": "key_field" });
    }
...
class PrivKey$Type extends MessageType<PrivKey> {
    constructor() {
        super("injective.crypto.v1beta1.ethsecp256k1.PrivKey", [
            { no: 1, name: "key", kind: "scalar", T: 12 /*ScalarType.BYTES*/ }
        ], { "amino.name": "injective/PrivKeyEthSecp256k1", "amino.message_encoding": "key_field" });
    }
...
/**
 * @generated MessageType for protobuf message injective.crypto.v1beta1.ethsecp256k1.PrivKey
 */
