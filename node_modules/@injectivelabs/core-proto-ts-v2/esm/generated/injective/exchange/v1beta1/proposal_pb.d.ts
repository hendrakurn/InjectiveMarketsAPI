...
// @generated from protobuf file "injective/exchange/v1beta1/proposal.proto" (package "injective.exchange.v1beta1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message injective.exchange.v1beta1.BatchExchangeModificationProposal
 */
export interface BatchExchangeModificationProposal {
    ...
    description: string;
    /**
     * @generated from protobuf field: repeated injective.exchange.v1beta1.SpotMarketParamUpdateProposal spot_market_param_update_proposals = 3
     */
    spotMarketParamUpdateProposals: SpotMarketParamUpdateProposal[];
    /**
     * @generated from protobuf field: repeated injective.exchange.v1beta1.DerivativeMarketParamUpdateProposal derivative_market_param_update_proposals = 4
     */
    derivativeMarketParamUpdateProposals: DerivativeMarketParamUpdateProposal[];
    /**
     * @generated from protobuf field: repeated injective.exchange.v1beta1.SpotMarketLaunchProposal spot_market_launch_proposals = 5
     */
    spotMarketLaunchProposals: SpotMarketLaunchProposal[];
    /**
     * @generated from protobuf field: repeated injective.exchange.v1beta1.PerpetualMarketLaunchProposal perpetual_market_launch_proposals = 6
     */
    perpetualMarketLaunchProposals: PerpetualMarketLaunchProposal[];
    /**
     * @generated from protobuf field: repeated injective.exchange.v1beta1.ExpiryFuturesMarketLaunchProposal expiry_futures_market_launch_proposals = 7
     */
    expiryFuturesMarketLaunchProposals: ExpiryFuturesMarketLaunchProposal[];
    /**
     * @generated from protobuf field: injective.exchange.v1beta1.TradingRewardCampaignUpdateProposal trading_reward_campaign_update_proposal = 8
     */
    tradingRewardCampaignUpdateProposal?: TradingRewardCampaignUpdateProposal;
    /**
     * @generated from protobuf field: repeated injective.exchange.v1beta1.BinaryOptionsMarketLaunchProposal binary_options_market_launch_proposals = 9
     */
    binaryOptionsMarketLaunchProposals: BinaryOptionsMarketLaunchProposal[];
    /**
     * @generated from protobuf field: repeated injective.exchange.v1beta1.BinaryOptionsMarketParamUpdateProposal binary_options_param_update_proposals = 10
     */
    binaryOptionsParamUpdateProposals: BinaryOptionsMarketParamUpdateProposal[];
    /**
     * @generated from protobuf field: injective.exchange.v1beta1.UpdateDenomDecimalsProposal denom_decimals_update_proposal = 11
     */
    denomDecimalsUpdateProposal?: UpdateDenomDecimalsProposal;
    /**
     * @generated from protobuf field: injective.exchange.v1beta1.FeeDiscountProposal fee_discount_proposal = 12
     */
    feeDiscountProposal?: FeeDiscountProposal;
    /**
     * @generated from protobuf field: repeated injective.exchange.v1beta1.MarketForcedSettlementProposal market_forced_settlement_proposals = 13
     */
    marketForcedSettlementProposals: MarketForcedSettlementProposal[];
    /**
     * @generated from protobuf field: injective.exchange.v1beta1.DenomMinNotionalProposal denom_min_notional_proposal = 14
     */
...
/**
 * @generated from protobuf message injective.exchange.v1beta1.BinaryOptionsMarketLaunchProposal
 */
...
/**
 * @generated from protobuf message injective.exchange.v1beta1.MarketForcedSettlementProposal
 */
...
/**
 * @generated from protobuf message injective.exchange.v1beta1.UpdateDenomDecimalsProposal
 */
export interface UpdateDenomDecimalsProposal {
    ...
    description: string;
    /**
     * @generated from protobuf field: repeated injective.exchange.v1beta1.DenomDecimals denom_decimals = 3
     */
    denomDecimals: DenomDecimals[];
}
/**
 * @generated from protobuf message injective.exchange.v1beta1.BinaryOptionsMarketParamUpdateProposal
 */
export interface BinaryOptionsMarketParamUpdateProposal {
    ...
    status: MarketStatus;
    /**
     * @generated from protobuf field: injective.exchange.v1beta1.ProviderOracleParams oracle_params = 14
     */
...
/**
 * @generated from protobuf message injective.exchange.v1beta1.ProviderOracleParams
 */
...
/**
 * @generated from protobuf message injective.exchange.v1beta1.RewardPointUpdate
 */
...
/**
 * @generated from protobuf message injective.exchange.v1beta1.TradingRewardPendingPointsUpdateProposal
 */
export interface TradingRewardPendingPointsUpdateProposal {
    ...
    /**
     * @generated from protobuf field: repeated injective.exchange.v1beta1.RewardPointUpdate reward_point_updates = 4
     */
...
/**
 * @generated from protobuf message injective.exchange.v1beta1.BatchCommunityPoolSpendProposal
 */
 ...
 *
 * @generated from protobuf message injective.exchange.v1beta1.AtomicMarketOrderFeeMultiplierScheduleProposal
 */
export interface AtomicMarketOrderFeeMultiplierScheduleProposal {
    ...
    description: string;
    /**
     * @generated from protobuf field: repeated injective.exchange.v1beta1.MarketFeeMultiplier market_fee_multipliers = 3
     */
    marketFeeMultipliers: MarketFeeMultiplier[];
}
/**
 * @generated from protobuf message injective.exchange.v1beta1.DenomMinNotionalProposal
 */
export interface DenomMinNotionalProposal {
    ...
    description: string;
    /**
     * @generated from protobuf field: repeated injective.exchange.v1beta1.DenomMinNotional denom_min_notionals = 3
     */
...
class SpotMarketParamUpdateProposal$Type extends MessageType<SpotMarketParamUpdateProposal> {
    constructor() {
        super("injective.exchange.v1beta1.SpotMarketParamUpdateProposal", [
            ...
            { no: 9, name: "status", kind: "enum", T: () => ["injective.exchange.v1beta1.MarketStatus", MarketStatus] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string min_quantity_tick_size */ 8:
                    ...
                    break;
                case /* injective.exchange.v1beta1.MarketStatus status */ 9:
                ...
                case /* string min_notional */ 11:
                    ...
                    break;
                case /* injective.exchange.v1beta1.AdminInfo admin_info */ 12:
    ...
    internalBinaryWrite(message: SpotMarketParamUpdateProposal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* injective.exchange.v1beta1.AdminInfo admin_info = 12; */
...
class ExchangeEnableProposal$Type extends MessageType<ExchangeEnableProposal> {
    constructor() {
        super("injective.exchange.v1beta1.ExchangeEnableProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "exchangeType", kind: "enum", T: () => ["injective.exchange.v1beta1.ExchangeType", ExchangeType] }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string description */ 2:
                    message.description = reader.string();
                    break;
                case /* injective.exchange.v1beta1.ExchangeType exchangeType */ 3:
...
class BatchExchangeModificationProposal$Type extends MessageType<BatchExchangeModificationProposal> {
    constructor() {
        super("injective.exchange.v1beta1.BatchExchangeModificationProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string description */ 2:
                    message.description = reader.string();
                    break;
                case /* repeated injective.exchange.v1beta1.SpotMarketParamUpdateProposal spot_market_param_update_proposals */ 3:
                    ...
                    break;
                case /* repeated injective.exchange.v1beta1.DerivativeMarketParamUpdateProposal derivative_market_param_update_proposals */ 4:
                    ...
                    break;
                case /* repeated injective.exchange.v1beta1.SpotMarketLaunchProposal spot_market_launch_proposals */ 5:
                    message.spotMarketLaunchProposals.push(SpotMarketLaunchProposal.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated injective.exchange.v1beta1.PerpetualMarketLaunchProposal perpetual_market_launch_proposals */ 6:
                    ...
                    break;
                case /* repeated injective.exchange.v1beta1.ExpiryFuturesMarketLaunchProposal expiry_futures_market_launch_proposals */ 7:
                    ...
                    break;
                case /* injective.exchange.v1beta1.TradingRewardCampaignUpdateProposal trading_reward_campaign_update_proposal */ 8:
                    ...
                    break;
                case /* repeated injective.exchange.v1beta1.BinaryOptionsMarketLaunchProposal binary_options_market_launch_proposals */ 9:
                    ...
                    break;
                case /* repeated injective.exchange.v1beta1.BinaryOptionsMarketParamUpdateProposal binary_options_param_update_proposals */ 10:
                    ...
                    break;
                case /* injective.exchange.v1beta1.UpdateDenomDecimalsProposal denom_decimals_update_proposal */ 11:
                    message.denomDecimalsUpdateProposal = UpdateDenomDecimalsProposal.internalBinaryRead(reader, reader.uint32(), options, message.denomDecimalsUpdateProposal);
                    break;
                case /* injective.exchange.v1beta1.FeeDiscountProposal fee_discount_proposal */ 12:
                    ...
                    break;
                case /* repeated injective.exchange.v1beta1.MarketForcedSettlementProposal market_forced_settlement_proposals */ 13:
                    ...
                    break;
                case /* injective.exchange.v1beta1.DenomMinNotionalProposal denom_min_notional_proposal */ 14:
    ...
    internalBinaryWrite(message: BatchExchangeModificationProposal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.denomDecimalsUpdateProposal)
            UpdateDenomDecimalsProposal.internalBinaryWrite(message.denomDecimalsUpdateProposal, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
        /* injective.exchange.v1beta1.FeeDiscountProposal fee_discount_proposal = 12; */
        ...
        /* repeated injective.exchange.v1beta1.MarketForcedSettlementProposal market_forced_settlement_proposals = 13; */
        ...
        /* injective.exchange.v1beta1.DenomMinNotionalProposal denom_min_notional_proposal = 14; */
...
/**
 * @generated MessageType for protobuf message injective.exchange.v1beta1.BatchExchangeModificationProposal
 */
...
class SpotMarketLaunchProposal$Type extends MessageType<SpotMarketLaunchProposal> {
    constructor() {
        super("injective.exchange.v1beta1.SpotMarketLaunchProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string min_notional */ 10:
                    message.minNotional = reader.string();
                    break;
                case /* injective.exchange.v1beta1.AdminInfo admin_info */ 11:
                    message.adminInfo = AdminInfo.internalBinaryRead(reader, reader.uint32(), options, message.adminInfo);
                    break;
    ...
    internalBinaryWrite(message: SpotMarketLaunchProposal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* injective.exchange.v1beta1.AdminInfo admin_info = 11; */
        if (message.adminInfo)
...
class PerpetualMarketLaunchProposal$Type extends MessageType<PerpetualMarketLaunchProposal> {
    constructor() {
        super("injective.exchange.v1beta1.PerpetualMarketLaunchProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "ticker", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string min_notional */ 15:
                    message.minNotional = reader.string();
                    break;
                case /* injective.exchange.v1beta1.AdminInfo admin_info */ 16:
                    message.adminInfo = AdminInfo.internalBinaryRead(reader, reader.uint32(), options, message.adminInfo);
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: PerpetualMarketLaunchProposal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* injective.exchange.v1beta1.AdminInfo admin_info = 16; */
        if (message.adminInfo)
...
class BinaryOptionsMarketLaunchProposal$Type extends MessageType<BinaryOptionsMarketLaunchProposal> {
    constructor() {
        super("injective.exchange.v1beta1.BinaryOptionsMarketLaunchProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "ticker", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message injective.exchange.v1beta1.BinaryOptionsMarketLaunchProposal
 */
...
class ExpiryFuturesMarketLaunchProposal$Type extends MessageType<ExpiryFuturesMarketLaunchProposal> {
    constructor() {
        super("injective.exchange.v1beta1.ExpiryFuturesMarketLaunchProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "ticker", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "quote_denom", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string min_notional */ 16:
                    message.minNotional = reader.string();
                    break;
                case /* injective.exchange.v1beta1.AdminInfo admin_info */ 17:
                    message.adminInfo = AdminInfo.internalBinaryRead(reader, reader.uint32(), options, message.adminInfo);
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: ExpiryFuturesMarketLaunchProposal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.minNotional !== "")
            writer.tag(16, WireType.LengthDelimited).string(message.minNotional);
        /* injective.exchange.v1beta1.AdminInfo admin_info = 17; */
        if (message.adminInfo)
...
class DerivativeMarketParamUpdateProposal$Type extends MessageType<DerivativeMarketParamUpdateProposal> {
    constructor() {
        super("injective.exchange.v1beta1.DerivativeMarketParamUpdateProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "market_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            ...
            { no: 13, name: "status", kind: "enum", T: () => ["injective.exchange.v1beta1.MarketStatus", MarketStatus] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string HourlyFundingRateCap */ 12:
                    ...
                    break;
                case /* injective.exchange.v1beta1.MarketStatus status */ 13:
                    message.status = reader.int32();
                    break;
                case /* injective.exchange.v1beta1.OracleParams oracle_params */ 14:
...
class AdminInfo$Type extends MessageType<AdminInfo> {
    constructor() {
        super("injective.exchange.v1beta1.AdminInfo", [
...
class MarketForcedSettlementProposal$Type extends MessageType<MarketForcedSettlementProposal> {
    constructor() {
        super("injective.exchange.v1beta1.MarketForcedSettlementProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "market_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message injective.exchange.v1beta1.MarketForcedSettlementProposal
 */
export const MarketForcedSettlementProposal = new MarketForcedSettlementProposal$Type();
// @generated message type with reflection information, may provide speed optimized methods
class UpdateDenomDecimalsProposal$Type extends MessageType<UpdateDenomDecimalsProposal> {
    constructor() {
        super("injective.exchange.v1beta1.UpdateDenomDecimalsProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "denom_decimals", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DenomDecimals }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false, "cosmos_proto.implements_interface": ["cosmos.gov.v1beta1.Content"], "amino.name": "exchange/UpdateDenomDecimalsProposal" });
    }
    create(value?: PartialMessage<UpdateDenomDecimalsProposal>): UpdateDenomDecimalsProposal {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.title = "";
        message.description = "";
        message.denomDecimals = [];
        if (value !== undefined)
            reflectionMergePartial<UpdateDenomDecimalsProposal>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UpdateDenomDecimalsProposal): UpdateDenomDecimalsProposal {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* string description */ 2:
                    message.description = reader.string();
                    break;
                case /* repeated injective.exchange.v1beta1.DenomDecimals denom_decimals */ 3:
    ...
    internalBinaryWrite(message: UpdateDenomDecimalsProposal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string title = 1; */
        if (message.title !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.title);
        /* string description = 2; */
...
/**
 * @generated MessageType for protobuf message injective.exchange.v1beta1.UpdateDenomDecimalsProposal
 */
export const UpdateDenomDecimalsProposal = new UpdateDenomDecimalsProposal$Type();
// @generated message type with reflection information, may provide speed optimized methods
class BinaryOptionsMarketParamUpdateProposal$Type extends MessageType<BinaryOptionsMarketParamUpdateProposal> {
    constructor() {
        super("injective.exchange.v1beta1.BinaryOptionsMarketParamUpdateProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "market_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "maker_fee_rate", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": true, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* injective.exchange.v1beta1.MarketStatus status */ 13:
                    message.status = reader.int32();
                    break;
                case /* injective.exchange.v1beta1.ProviderOracleParams oracle_params */ 14:
...
/**
 * @generated MessageType for protobuf message injective.exchange.v1beta1.BinaryOptionsMarketParamUpdateProposal
 */
...
class ProviderOracleParams$Type extends MessageType<ProviderOracleParams> {
    constructor() {
        super("injective.exchange.v1beta1.ProviderOracleParams", [
...
/**
 * @generated MessageType for protobuf message injective.exchange.v1beta1.ProviderOracleParams
 */
export const ProviderOracleParams = new ProviderOracleParams$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OracleParams$Type extends MessageType<OracleParams> {
    constructor() {
        super("injective.exchange.v1beta1.OracleParams", [
...
class TradingRewardCampaignLaunchProposal$Type extends MessageType<TradingRewardCampaignLaunchProposal> {
    constructor() {
        super("injective.exchange.v1beta1.TradingRewardCampaignLaunchProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string description */ 2:
                    message.description = reader.string();
                    break;
                case /* injective.exchange.v1beta1.TradingRewardCampaignInfo campaign_info */ 3:
                    message.campaignInfo = TradingRewardCampaignInfo.internalBinaryRead(reader, reader.uint32(), options, message.campaignInfo);
                    break;
                case /* repeated injective.exchange.v1beta1.CampaignRewardPool campaign_reward_pools */ 4:
...
class TradingRewardCampaignUpdateProposal$Type extends MessageType<TradingRewardCampaignUpdateProposal> {
    constructor() {
        super("injective.exchange.v1beta1.TradingRewardCampaignUpdateProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "campaign_info", kind: "message", T: () => TradingRewardCampaignInfo },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* injective.exchange.v1beta1.TradingRewardCampaignInfo campaign_info */ 3:
                    message.campaignInfo = TradingRewardCampaignInfo.internalBinaryRead(reader, reader.uint32(), options, message.campaignInfo);
                    break;
                case /* repeated injective.exchange.v1beta1.CampaignRewardPool campaign_reward_pools_additions */ 4:
                    message.campaignRewardPoolsAdditions.push(CampaignRewardPool.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated injective.exchange.v1beta1.CampaignRewardPool campaign_reward_pools_updates */ 5:
...
class RewardPointUpdate$Type extends MessageType<RewardPointUpdate> {
    constructor() {
        super("injective.exchange.v1beta1.RewardPointUpdate", [
...
/**
 * @generated MessageType for protobuf message injective.exchange.v1beta1.RewardPointUpdate
 */
...
class TradingRewardPendingPointsUpdateProposal$Type extends MessageType<TradingRewardPendingPointsUpdateProposal> {
    constructor() {
        super("injective.exchange.v1beta1.TradingRewardPendingPointsUpdateProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 pending_pool_timestamp */ 3:
                    ...
                    break;
                case /* repeated injective.exchange.v1beta1.RewardPointUpdate reward_point_updates */ 4:
...
/**
 * @generated MessageType for protobuf message injective.exchange.v1beta1.TradingRewardPendingPointsUpdateProposal
 */
...
class FeeDiscountProposal$Type extends MessageType<FeeDiscountProposal> {
    constructor() {
        super("injective.exchange.v1beta1.FeeDiscountProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string description */ 2:
                    message.description = reader.string();
                    break;
                case /* injective.exchange.v1beta1.FeeDiscountSchedule schedule */ 3:
...
class BatchCommunityPoolSpendProposal$Type extends MessageType<BatchCommunityPoolSpendProposal> {
    constructor() {
        super("injective.exchange.v1beta1.BatchCommunityPoolSpendProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message injective.exchange.v1beta1.BatchCommunityPoolSpendProposal
 */
...
class AtomicMarketOrderFeeMultiplierScheduleProposal$Type extends MessageType<AtomicMarketOrderFeeMultiplierScheduleProposal> {
    constructor() {
        super("injective.exchange.v1beta1.AtomicMarketOrderFeeMultiplierScheduleProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string description */ 2:
                    message.description = reader.string();
                    break;
                case /* repeated injective.exchange.v1beta1.MarketFeeMultiplier market_fee_multipliers */ 3:
...
/**
 * @generated MessageType for protobuf message injective.exchange.v1beta1.AtomicMarketOrderFeeMultiplierScheduleProposal
 */
...
class DenomMinNotionalProposal$Type extends MessageType<DenomMinNotionalProposal> {
    constructor() {
        super("injective.exchange.v1beta1.DenomMinNotionalProposal", [
            { no: 1, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string description */ 2:
                    message.description = reader.string();
                    break;
                case /* repeated injective.exchange.v1beta1.DenomMinNotional denom_min_notionals */ 3:
    ...
    internalBinaryWrite(message: DenomMinNotionalProposal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.description !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.description);
        /* repeated injective.exchange.v1beta1.DenomMinNotional denom_min_notionals = 3; */
...
/**
 * @generated MessageType for protobuf message injective.exchange.v1beta1.DenomMinNotionalProposal
 */
