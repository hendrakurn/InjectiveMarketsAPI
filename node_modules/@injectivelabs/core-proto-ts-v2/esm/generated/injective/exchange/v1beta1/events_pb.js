...
import { DerivativeMarketOrder } from "./exchange_pb.js";
...
import { DerivativeLimitOrder } from "./exchange_pb.js";
import { SpotLimitOrder } from "./exchange_pb.js";
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        2:
          ...
          break;
        case /* injective.exchange.v1beta1.ExecutionType executionType */
        3:
          message.executionType = reader.int32();
          break;
        case /* repeated injective.exchange.v1beta1.TradeLog trades */
        4:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        5:
          message.executionType = reader.int32();
          break;
        case /* repeated injective.exchange.v1beta1.DerivativeTradeLog trades */
        6:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          message.marketId = reader.string();
          break;
        case /* repeated injective.exchange.v1beta1.SubaccountPosition positions */
        2:
...
class EventBinaryOptionsMarketUpdate$Type extends MessageType {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* injective.exchange.v1beta1.BinaryOptionsMarket market */
        1:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          message.marketId = reader.string();
          break;
        case /* repeated injective.exchange.v1beta1.SpotLimitOrder buy_orders */
        2:
          message.buyOrders.push(SpotLimitOrder.internalBinaryRead(reader, reader.uint32(), options));
          break;
        case /* repeated injective.exchange.v1beta1.SpotLimitOrder sell_orders */
        3:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          message.marketId = reader.string();
          break;
        case /* repeated injective.exchange.v1beta1.DerivativeLimitOrder buy_orders */
        2:
          message.buyOrders.push(DerivativeLimitOrder.internalBinaryRead(reader, reader.uint32(), options));
          break;
        case /* repeated injective.exchange.v1beta1.DerivativeLimitOrder sell_orders */
        3:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          ...
          break;
        case /* injective.exchange.v1beta1.PerpetualMarketInfo perpetual_market_info */
        2:
          ...
          break;
        case /* injective.exchange.v1beta1.PerpetualMarketFunding funding */
        3:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          message.market = DerivativeMarket.internalBinaryRead(reader, reader.uint32(), options, message.market);
          break;
        case /* injective.exchange.v1beta1.ExpiryFuturesMarketInfo expiry_futures_market_info */
        3:
...
class EventBatchDepositUpdate$Type extends MessageType {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* repeated injective.exchange.v1beta1.DepositUpdate deposit_updates */
        1:
...
class DerivativeMarketOrderCancel$Type extends MessageType {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* injective.exchange.v1beta1.DerivativeMarketOrder market_order */
        1:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        2:
          ...
          break;
        case /* injective.exchange.v1beta1.DerivativeLimitOrder limit_order */
        3:
          message.limitOrder = DerivativeLimitOrder.internalBinaryRead(reader, reader.uint32(), options, message.limitOrder);
          break;
        case /* injective.exchange.v1beta1.DerivativeMarketOrderCancel market_order_cancel */
        4:
...
class EventTradingRewardDistribution$Type extends MessageType {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* repeated injective.exchange.v1beta1.AccountRewards account_rewards */
        1:
...
class EventOrderbookUpdate$Type extends MessageType {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* repeated injective.exchange.v1beta1.OrderbookUpdate spot_updates */
        1:
          message.spotUpdates.push(OrderbookUpdate.internalBinaryRead(reader, reader.uint32(), options));
          break;
        case /* repeated injective.exchange.v1beta1.OrderbookUpdate derivative_updates */
        2:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          ...
          break;
        case /* injective.exchange.v1beta1.Orderbook orderbook */
        2:
