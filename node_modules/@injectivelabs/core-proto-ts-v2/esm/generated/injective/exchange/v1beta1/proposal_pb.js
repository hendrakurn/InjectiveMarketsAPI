...
import { MarketFeeMultiplier } from "./exchange_pb.js";
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        11:
          ...
          break;
        case /* injective.exchange.v1beta1.AdminInfo admin_info */
        12:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        2:
          message.description = reader.string();
          break;
        case /* injective.exchange.v1beta1.ExchangeType exchangeType */
        3:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        2:
          message.description = reader.string();
          break;
        case /* repeated injective.exchange.v1beta1.SpotMarketParamUpdateProposal spot_market_param_update_proposals */
        3:
          ...
          break;
        case /* repeated injective.exchange.v1beta1.DerivativeMarketParamUpdateProposal derivative_market_param_update_proposals */
        4:
          ...
          break;
        case /* repeated injective.exchange.v1beta1.SpotMarketLaunchProposal spot_market_launch_proposals */
        5:
          message.spotMarketLaunchProposals.push(SpotMarketLaunchProposal.internalBinaryRead(reader, reader.uint32(), options));
          break;
        case /* repeated injective.exchange.v1beta1.PerpetualMarketLaunchProposal perpetual_market_launch_proposals */
        6:
          ...
          break;
        case /* repeated injective.exchange.v1beta1.ExpiryFuturesMarketLaunchProposal expiry_futures_market_launch_proposals */
        7:
          ...
          break;
        case /* injective.exchange.v1beta1.TradingRewardCampaignUpdateProposal trading_reward_campaign_update_proposal */
        8:
          ...
          break;
        case /* repeated injective.exchange.v1beta1.BinaryOptionsMarketLaunchProposal binary_options_market_launch_proposals */
        9:
          ...
          break;
        case /* repeated injective.exchange.v1beta1.BinaryOptionsMarketParamUpdateProposal binary_options_param_update_proposals */
        10:
          ...
          break;
        case /* injective.exchange.v1beta1.UpdateDenomDecimalsProposal denom_decimals_update_proposal */
        11:
          ...
          break;
        case /* injective.exchange.v1beta1.FeeDiscountProposal fee_discount_proposal */
        12:
          ...
          break;
        case /* repeated injective.exchange.v1beta1.MarketForcedSettlementProposal market_forced_settlement_proposals */
        13:
          ...
          break;
        case /* injective.exchange.v1beta1.DenomMinNotionalProposal denom_min_notional_proposal */
        14:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        13:
          message.status = reader.int32();
          break;
        case /* injective.exchange.v1beta1.OracleParams oracle_params */
        14:
...
class UpdateDenomDecimalsProposal$Type extends MessageType {
  constructor() {
...
const UpdateDenomDecimalsProposal = new UpdateDenomDecimalsProposal$Type();
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        13:
          message.status = reader.int32();
          break;
        case /* injective.exchange.v1beta1.ProviderOracleParams oracle_params */
        14:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        2:
          message.description = reader.string();
          break;
        case /* injective.exchange.v1beta1.TradingRewardCampaignInfo campaign_info */
        3:
          message.campaignInfo = TradingRewardCampaignInfo.internalBinaryRead(reader, reader.uint32(), options, message.campaignInfo);
          break;
        case /* repeated injective.exchange.v1beta1.CampaignRewardPool campaign_reward_pools */
        4:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        3:
          message.campaignInfo = TradingRewardCampaignInfo.internalBinaryRead(reader, reader.uint32(), options, message.campaignInfo);
          break;
        case /* repeated injective.exchange.v1beta1.CampaignRewardPool campaign_reward_pools_additions */
        4:
          message.campaignRewardPoolsAdditions.push(CampaignRewardPool.internalBinaryRead(reader, reader.uint32(), options));
          break;
        case /* repeated injective.exchange.v1beta1.CampaignRewardPool campaign_reward_pools_updates */
        5:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        3:
          ...
          break;
        case /* repeated injective.exchange.v1beta1.RewardPointUpdate reward_point_updates */
        4:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        2:
          message.description = reader.string();
          break;
        case /* injective.exchange.v1beta1.FeeDiscountSchedule schedule */
        3:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        2:
          message.description = reader.string();
          break;
        case /* repeated injective.exchange.v1beta1.MarketFeeMultiplier market_fee_multipliers */
        3:
