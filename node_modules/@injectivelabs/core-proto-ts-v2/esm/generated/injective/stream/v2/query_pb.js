...
import { PositionDelta } from "../../exchange/v2/exchange_pb.js";
import { DerivativeLimitOrder } from "../../exchange/v2/order_pb.js";
import { SpotLimitOrder } from "../../exchange/v2/order_pb.js";
import { Deposit } from "../../exchange/v2/exchange_pb.js";
import { Coin } from "../../../cosmos/base/v1beta1/coin_pb.js";
import { Level } from "../../exchange/v2/exchange_pb.js";
...
class StreamRequest$Type extends MessageType {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* injective.stream.v2.BankBalancesFilter bank_balances_filter */
        1:
          message.bankBalancesFilter = BankBalancesFilter.internalBinaryRead(reader, reader.uint32(), options, message.bankBalancesFilter);
          break;
        case /* injective.stream.v2.SubaccountDepositsFilter subaccount_deposits_filter */
        2:
          ...
          break;
        case /* injective.stream.v2.TradesFilter spot_trades_filter */
        3:
          message.spotTradesFilter = TradesFilter.internalBinaryRead(reader, reader.uint32(), options, message.spotTradesFilter);
          break;
        case /* injective.stream.v2.TradesFilter derivative_trades_filter */
        4:
          ...
          break;
        case /* injective.stream.v2.OrdersFilter spot_orders_filter */
        5:
          message.spotOrdersFilter = OrdersFilter.internalBinaryRead(reader, reader.uint32(), options, message.spotOrdersFilter);
          break;
        case /* injective.stream.v2.OrdersFilter derivative_orders_filter */
        6:
          ...
          break;
        case /* injective.stream.v2.OrderbookFilter spot_orderbooks_filter */
        7:
          ...
          break;
        case /* injective.stream.v2.OrderbookFilter derivative_orderbooks_filter */
        8:
        ...
        11:
          ...
          break;
        case /* injective.stream.v2.ConditionalOrderTriggerFailuresFilter conditional_order_trigger_failures_filter */
        12:
...
class StreamResponse$Type extends MessageType {
  constructor() {
    super("injective.stream.v2.StreamResponse", [
      ...
      { no: 14, name: "order_failures", kind: "message", repeat: 2, T: () => OrderFailureUpdate },
      { no: 15, name: "conditional_order_trigger_failures", kind: "message", repeat: 2, T: () => ConditionalOrderTriggerFailureUpdate }
    ]);
  }
  create(value) {
    const message = globalThis.Object.create(this.messagePrototype);
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        13:
          ...
          break;
        case /* repeated injective.stream.v2.OrderFailureUpdate order_failures */
        14:
          message.orderFailures.push(OrderFailureUpdate.internalBinaryRead(reader, reader.uint32(), options));
          break;
        case /* repeated injective.stream.v2.ConditionalOrderTriggerFailureUpdate conditional_order_trigger_failures */
        15:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          ...
          break;
        case /* injective.stream.v2.Orderbook orderbook */
        2:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          ...
          break;
        case /* repeated injective.stream.v2.SubaccountDeposit deposits */
        2:
...
class SpotOrderUpdate$Type extends MessageType {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* injective.stream.v2.OrderUpdateStatus status */
        1:
        ...
        3:
          ...
          break;
        case /* injective.stream.v2.SpotOrder order */
        4:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        3:
          message.cid = reader.string();
          break;
        case /* injective.stream.v2.DerivativeOrder order */
        4:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          message.marketId = reader.string();
          break;
        case /* injective.exchange.v2.DerivativeLimitOrder order */
        2:
...
class OrderFailureUpdate$Type extends MessageType {
  constructor() {
...
const OrderFailureUpdate = new OrderFailureUpdate$Type();
class ConditionalOrderTriggerFailureUpdate$Type extends MessageType {
  constructor() {
...
const ConditionalOrderTriggerFailureUpdate = new ConditionalOrderTriggerFailureUpdate$Type();
...
class OrderFailuresFilter$Type extends MessageType {
  constructor() {
...
const OrderFailuresFilter = new OrderFailuresFilter$Type();
class ConditionalOrderTriggerFailuresFilter$Type extends MessageType {
  constructor() {
...
const ConditionalOrderTriggerFailuresFilter = new ConditionalOrderTriggerFailuresFilter$Type();
const Stream = new ServiceType("injective.stream.v2.Stream", [
