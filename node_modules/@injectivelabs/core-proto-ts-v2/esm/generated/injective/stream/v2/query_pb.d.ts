...
// @generated from protobuf file "injective/stream/v2/query.proto" (package "injective.stream.v2", syntax proto3)
// tslint:disable
...
import { PositionDelta } from "../../exchange/v2/exchange_pb";
import { DerivativeLimitOrder } from "../../exchange/v2/order_pb";
import { SpotLimitOrder } from "../../exchange/v2/order_pb";
import { Deposit } from "../../exchange/v2/exchange_pb";
import { Coin } from "../../../cosmos/base/v1beta1/coin_pb";
import { Level } from "../../exchange/v2/exchange_pb";
/**
 * @generated from protobuf message injective.stream.v2.StreamRequest
 */
export interface StreamRequest {
    /**
     * filter for bank balances events
     *
     * @generated from protobuf field: injective.stream.v2.BankBalancesFilter bank_balances_filter = 1
     */
    bankBalancesFilter?: BankBalancesFilter;
    /**
     * filter for subaccount deposits events
     *
     * @generated from protobuf field: injective.stream.v2.SubaccountDepositsFilter subaccount_deposits_filter = 2
     */
    subaccountDepositsFilter?: SubaccountDepositsFilter;
    /**
     * filter for spot trades events
     *
     * @generated from protobuf field: injective.stream.v2.TradesFilter spot_trades_filter = 3
     */
    spotTradesFilter?: TradesFilter;
    /**
     * filter for derivative trades events
     *
     * @generated from protobuf field: injective.stream.v2.TradesFilter derivative_trades_filter = 4
     */
    derivativeTradesFilter?: TradesFilter;
    /**
     * filter for spot orders events
     *
     * @generated from protobuf field: injective.stream.v2.OrdersFilter spot_orders_filter = 5
     */
    spotOrdersFilter?: OrdersFilter;
    /**
     * filter for derivative orders events
     *
     * @generated from protobuf field: injective.stream.v2.OrdersFilter derivative_orders_filter = 6
     */
    derivativeOrdersFilter?: OrdersFilter;
    /**
     * filter for spot orderbooks events
     *
     * @generated from protobuf field: injective.stream.v2.OrderbookFilter spot_orderbooks_filter = 7
     */
    spotOrderbooksFilter?: OrderbookFilter;
    /**
     * filter for derivative orderbooks events
     *
     * @generated from protobuf field: injective.stream.v2.OrderbookFilter derivative_orderbooks_filter = 8
     */
    derivativeOrderbooksFilter?: OrderbookFilter;
    /**
     * filter for positions events
     *
     * @generated from protobuf field: injective.stream.v2.PositionsFilter positions_filter = 9
     */
    positionsFilter?: PositionsFilter;
    /**
     * filter for oracle prices events
     *
     * @generated from protobuf field: injective.stream.v2.OraclePriceFilter oracle_price_filter = 10
     */
    oraclePriceFilter?: OraclePriceFilter;
    /**
     * filter for order failures events
     *
     * @generated from protobuf field: injective.stream.v2.OrderFailuresFilter order_failures_filter = 11
     */
    orderFailuresFilter?: OrderFailuresFilter;
    /**
     * filter for conditional order trigger failures events
     *
     * @generated from protobuf field: injective.stream.v2.ConditionalOrderTriggerFailuresFilter conditional_order_trigger_failures_filter = 12
     */
    conditionalOrderTriggerFailuresFilter?: ConditionalOrderTriggerFailuresFilter;
}
/**
 * @generated from protobuf message injective.stream.v2.StreamResponse
 */
export interface StreamResponse {
     ...
     *
     * @generated from protobuf field: repeated injective.stream.v2.BankBalance bank_balances = 3
     */
    bankBalances: BankBalance[];
    /**
     * list of subaccount deposits updates
     *
     * @generated from protobuf field: repeated injective.stream.v2.SubaccountDeposits subaccount_deposits = 4
     */
    subaccountDeposits: SubaccountDeposits[];
    /**
     * list of spot trades updates
     *
     * @generated from protobuf field: repeated injective.stream.v2.SpotTrade spot_trades = 5
     */
    spotTrades: SpotTrade[];
    /**
     * list of derivative trades updates
     *
     * @generated from protobuf field: repeated injective.stream.v2.DerivativeTrade derivative_trades = 6
     */
    derivativeTrades: DerivativeTrade[];
    /**
     * list of spot orders updates
     *
     * @generated from protobuf field: repeated injective.stream.v2.SpotOrderUpdate spot_orders = 7
     */
    spotOrders: SpotOrderUpdate[];
    /**
     * list of derivative orders updates
     *
     * @generated from protobuf field: repeated injective.stream.v2.DerivativeOrderUpdate derivative_orders = 8
     */
    derivativeOrders: DerivativeOrderUpdate[];
    /**
     * list of spot orderbook updates
     *
     * @generated from protobuf field: repeated injective.stream.v2.OrderbookUpdate spot_orderbook_updates = 9
     */
    spotOrderbookUpdates: OrderbookUpdate[];
    /**
     * list of derivative orderbook updates
     *
     * @generated from protobuf field: repeated injective.stream.v2.OrderbookUpdate derivative_orderbook_updates = 10
     */
    derivativeOrderbookUpdates: OrderbookUpdate[];
    /**
     * list of positions updates
     *
     * @generated from protobuf field: repeated injective.stream.v2.Position positions = 11
     */
    positions: Position[];
    /**
     * list of oracle prices updates
     *
     * @generated from protobuf field: repeated injective.stream.v2.OraclePrice oracle_prices = 12
     */
    oraclePrices: OraclePrice[];
    /**
     * the current gas price when the block was processed (in chain format)
     *
     * @generated from protobuf field: string gas_price = 13
     */
    gasPrice: string;
    /**
     * list of order failures updates
     *
     * @generated from protobuf field: repeated injective.stream.v2.OrderFailureUpdate order_failures = 14
     */
    orderFailures: OrderFailureUpdate[];
    /**
     * list of conditional order trigger failures updates
     *
     * @generated from protobuf field: repeated injective.stream.v2.ConditionalOrderTriggerFailureUpdate conditional_order_trigger_failures = 15
     */
    conditionalOrderTriggerFailures: ConditionalOrderTriggerFailureUpdate[];
}
/**
 * @generated from protobuf message injective.stream.v2.OrderbookUpdate
 */
export interface OrderbookUpdate {
     ...
     *
     * @generated from protobuf field: injective.stream.v2.Orderbook orderbook = 2
     */
    orderbook?: Orderbook;
}
/**
 * @generated from protobuf message injective.stream.v2.Orderbook
 */
...
/**
 * @generated from protobuf message injective.stream.v2.BankBalance
 */
...
/**
 * @generated from protobuf message injective.stream.v2.SubaccountDeposits
 */
export interface SubaccountDeposits {
     ...
     *
     * @generated from protobuf field: repeated injective.stream.v2.SubaccountDeposit deposits = 2
     */
    deposits: SubaccountDeposit[];
}
/**
 * @generated from protobuf message injective.stream.v2.SubaccountDeposit
 */
...
/**
 * @generated from protobuf message injective.stream.v2.SpotOrderUpdate
 */
export interface SpotOrderUpdate {
    /**
     * the status of the order
     *
     * @generated from protobuf field: injective.stream.v2.OrderUpdateStatus status = 1
     */
     ...
     * the order details
     *
     * @generated from protobuf field: injective.stream.v2.SpotOrder order = 4
     */
    order?: SpotOrder;
}
/**
 * @generated from protobuf message injective.stream.v2.SpotOrder
 */
...
/**
 * @generated from protobuf message injective.stream.v2.DerivativeOrderUpdate
 */
export interface DerivativeOrderUpdate {
     ...
     * the order details
     *
     * @generated from protobuf field: injective.stream.v2.DerivativeOrder order = 4
     */
    order?: DerivativeOrder;
}
/**
 * @generated from protobuf message injective.stream.v2.DerivativeOrder
 */
export interface DerivativeOrder {
     ...
     * the order details
     *
     * @generated from protobuf field: injective.exchange.v2.DerivativeLimitOrder order = 2
     */
...
/**
 * @generated from protobuf message injective.stream.v2.Position
 */
...
/**
 * @generated from protobuf message injective.stream.v2.OraclePrice
 */
...
/**
 * @generated from protobuf message injective.stream.v2.SpotTrade
 */
...
/**
 * @generated from protobuf message injective.stream.v2.DerivativeTrade
 */
export interface DerivativeTrade {
     ...
     *
     * @generated from protobuf field: injective.exchange.v2.PositionDelta position_delta = 5
     */
...
/**
 * @generated from protobuf message injective.stream.v2.OrderFailureUpdate
 */
export interface OrderFailureUpdate {
    /**
     * the account address
     *
     * @generated from protobuf field: string account = 1
     ...
     * the error code
     *
     * @generated from protobuf field: uint32 error_code = 4
     */
    errorCode: number;
}
/**
 * @generated from protobuf message injective.stream.v2.ConditionalOrderTriggerFailureUpdate
 */
export interface ConditionalOrderTriggerFailureUpdate {
    /**
     * the market ID
     *
     * @generated from protobuf field: string market_id = 1
     ...
     * the error code
     *
     * @generated from protobuf field: string error_description = 6
     */
    errorDescription: string;
}
/**
 * @generated from protobuf message injective.stream.v2.TradesFilter
 */
...
/**
 * @generated from protobuf message injective.stream.v2.PositionsFilter
 */
...
/**
 * @generated from protobuf message injective.stream.v2.OrdersFilter
 */
...
/**
 * @generated from protobuf message injective.stream.v2.OrderbookFilter
 */
...
/**
 * @generated from protobuf message injective.stream.v2.BankBalancesFilter
 */
...
/**
 * @generated from protobuf message injective.stream.v2.SubaccountDepositsFilter
 */
...
/**
 * @generated from protobuf message injective.stream.v2.OraclePriceFilter
 */
...
/**
 * @generated from protobuf message injective.stream.v2.OrderFailuresFilter
 */
export interface OrderFailuresFilter {
    /**
     * list of account addresses to filter by
     *
     * @generated from protobuf field: repeated string accounts = 1
...
/**
 * @generated from protobuf message injective.stream.v2.ConditionalOrderTriggerFailuresFilter
 */
export interface ConditionalOrderTriggerFailuresFilter {
    /**
     * list of subaccount IDs to filter by
     *
     * @generated from protobuf field: repeated string subaccount_ids = 1
...
/**
 * @generated from protobuf enum injective.stream.v2.OrderUpdateStatus
 */
...
class StreamRequest$Type extends MessageType<StreamRequest> {
    constructor() {
        super("injective.stream.v2.StreamRequest", [
            ...
            { no: 11, name: "order_failures_filter", kind: "message", T: () => OrderFailuresFilter, options: { "gogoproto.nullable": true } },
            { no: 12, name: "conditional_order_trigger_failures_filter", kind: "message", T: () => ConditionalOrderTriggerFailuresFilter, options: { "gogoproto.nullable": true } }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StreamRequest): StreamRequest {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* injective.stream.v2.BankBalancesFilter bank_balances_filter */ 1:
                    message.bankBalancesFilter = BankBalancesFilter.internalBinaryRead(reader, reader.uint32(), options, message.bankBalancesFilter);
                    break;
                case /* injective.stream.v2.SubaccountDepositsFilter subaccount_deposits_filter */ 2:
                    ...
                    break;
                case /* injective.stream.v2.TradesFilter spot_trades_filter */ 3:
                    message.spotTradesFilter = TradesFilter.internalBinaryRead(reader, reader.uint32(), options, message.spotTradesFilter);
                    break;
                case /* injective.stream.v2.TradesFilter derivative_trades_filter */ 4:
                    ...
                    break;
                case /* injective.stream.v2.OrdersFilter spot_orders_filter */ 5:
                    message.spotOrdersFilter = OrdersFilter.internalBinaryRead(reader, reader.uint32(), options, message.spotOrdersFilter);
                    break;
                case /* injective.stream.v2.OrdersFilter derivative_orders_filter */ 6:
                    ...
                    break;
                case /* injective.stream.v2.OrderbookFilter spot_orderbooks_filter */ 7:
                    ...
                    break;
                case /* injective.stream.v2.OrderbookFilter derivative_orderbooks_filter */ 8:
                    ...
                    break;
                case /* injective.stream.v2.PositionsFilter positions_filter */ 9:
                    message.positionsFilter = PositionsFilter.internalBinaryRead(reader, reader.uint32(), options, message.positionsFilter);
                    break;
                case /* injective.stream.v2.OraclePriceFilter oracle_price_filter */ 10:
                    message.oraclePriceFilter = OraclePriceFilter.internalBinaryRead(reader, reader.uint32(), options, message.oraclePriceFilter);
                    break;
                case /* injective.stream.v2.OrderFailuresFilter order_failures_filter */ 11:
                    message.orderFailuresFilter = OrderFailuresFilter.internalBinaryRead(reader, reader.uint32(), options, message.orderFailuresFilter);
                    break;
                case /* injective.stream.v2.ConditionalOrderTriggerFailuresFilter conditional_order_trigger_failures_filter */ 12:
                    message.conditionalOrderTriggerFailuresFilter = ConditionalOrderTriggerFailuresFilter.internalBinaryRead(reader, reader.uint32(), options, message.conditionalOrderTriggerFailuresFilter);
                    break;
                default:
    ...
    internalBinaryWrite(message: StreamRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* injective.stream.v2.BankBalancesFilter bank_balances_filter = 1; */
        ...
        /* injective.stream.v2.SubaccountDepositsFilter subaccount_deposits_filter = 2; */
        ...
        /* injective.stream.v2.TradesFilter spot_trades_filter = 3; */
        ...
        /* injective.stream.v2.TradesFilter derivative_trades_filter = 4; */
        ...
        /* injective.stream.v2.OrdersFilter spot_orders_filter = 5; */
        ...
        /* injective.stream.v2.OrdersFilter derivative_orders_filter = 6; */
        ...
        /* injective.stream.v2.OrderbookFilter spot_orderbooks_filter = 7; */
        ...
        /* injective.stream.v2.OrderbookFilter derivative_orderbooks_filter = 8; */
        ...
        /* injective.stream.v2.PositionsFilter positions_filter = 9; */
        ...
        /* injective.stream.v2.OraclePriceFilter oracle_price_filter = 10; */
        ...
        /* injective.stream.v2.OrderFailuresFilter order_failures_filter = 11; */
        if (message.orderFailuresFilter)
            OrderFailuresFilter.internalBinaryWrite(message.orderFailuresFilter, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
        /* injective.stream.v2.ConditionalOrderTriggerFailuresFilter conditional_order_trigger_failures_filter = 12; */
        if (message.conditionalOrderTriggerFailuresFilter)
            ConditionalOrderTriggerFailuresFilter.internalBinaryWrite(message.conditionalOrderTriggerFailuresFilter, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.StreamRequest
 */
export const StreamRequest = new StreamRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class StreamResponse$Type extends MessageType<StreamResponse> {
    constructor() {
        super("injective.stream.v2.StreamResponse", [
            ...
            { no: 14, name: "order_failures", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => OrderFailureUpdate },
            { no: 15, name: "conditional_order_trigger_failures", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ConditionalOrderTriggerFailureUpdate }
        ]);
    }
    create(value?: PartialMessage<StreamResponse>): StreamResponse {
        ...
        message.gasPrice = "";
        message.orderFailures = [];
        message.conditionalOrderTriggerFailures = [];
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 block_time */ 2:
                    ...
                    break;
                case /* repeated injective.stream.v2.BankBalance bank_balances */ 3:
                    message.bankBalances.push(BankBalance.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated injective.stream.v2.SubaccountDeposits subaccount_deposits */ 4:
                    message.subaccountDeposits.push(SubaccountDeposits.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated injective.stream.v2.SpotTrade spot_trades */ 5:
                    message.spotTrades.push(SpotTrade.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated injective.stream.v2.DerivativeTrade derivative_trades */ 6:
                    message.derivativeTrades.push(DerivativeTrade.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated injective.stream.v2.SpotOrderUpdate spot_orders */ 7:
                    message.spotOrders.push(SpotOrderUpdate.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated injective.stream.v2.DerivativeOrderUpdate derivative_orders */ 8:
                    message.derivativeOrders.push(DerivativeOrderUpdate.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated injective.stream.v2.OrderbookUpdate spot_orderbook_updates */ 9:
                    message.spotOrderbookUpdates.push(OrderbookUpdate.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated injective.stream.v2.OrderbookUpdate derivative_orderbook_updates */ 10:
                    message.derivativeOrderbookUpdates.push(OrderbookUpdate.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated injective.stream.v2.Position positions */ 11:
                    message.positions.push(Position.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated injective.stream.v2.OraclePrice oracle_prices */ 12:
                    message.oraclePrices.push(OraclePrice.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* string gas_price */ 13:
                    message.gasPrice = reader.string();
                    break;
                case /* repeated injective.stream.v2.OrderFailureUpdate order_failures */ 14:
                    message.orderFailures.push(OrderFailureUpdate.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated injective.stream.v2.ConditionalOrderTriggerFailureUpdate conditional_order_trigger_failures */ 15:
                    message.conditionalOrderTriggerFailures.push(ConditionalOrderTriggerFailureUpdate.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: StreamResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated injective.stream.v2.BankBalance bank_balances = 3; */
        ...
        /* repeated injective.stream.v2.SubaccountDeposits subaccount_deposits = 4; */
        ...
        /* repeated injective.stream.v2.SpotTrade spot_trades = 5; */
        ...
        /* repeated injective.stream.v2.DerivativeTrade derivative_trades = 6; */
        ...
        /* repeated injective.stream.v2.SpotOrderUpdate spot_orders = 7; */
        ...
        /* repeated injective.stream.v2.DerivativeOrderUpdate derivative_orders = 8; */
        ...
        /* repeated injective.stream.v2.OrderbookUpdate spot_orderbook_updates = 9; */
        ...
        /* repeated injective.stream.v2.OrderbookUpdate derivative_orderbook_updates = 10; */
        ...
        /* string gas_price = 13; */
        if (message.gasPrice !== "")
            writer.tag(13, WireType.LengthDelimited).string(message.gasPrice);
        /* repeated injective.stream.v2.OrderFailureUpdate order_failures = 14; */
        for (let i = 0; i < message.orderFailures.length; i++)
            OrderFailureUpdate.internalBinaryWrite(message.orderFailures[i], writer.tag(14, WireType.LengthDelimited).fork(), options).join();
        /* repeated injective.stream.v2.ConditionalOrderTriggerFailureUpdate conditional_order_trigger_failures = 15; */
        for (let i = 0; i < message.conditionalOrderTriggerFailures.length; i++)
            ConditionalOrderTriggerFailureUpdate.internalBinaryWrite(message.conditionalOrderTriggerFailures[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.StreamResponse
 */
export const StreamResponse = new StreamResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OrderbookUpdate$Type extends MessageType<OrderbookUpdate> {
    constructor() {
        super("injective.stream.v2.OrderbookUpdate", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 seq */ 1:
                    ...
                    break;
                case /* injective.stream.v2.Orderbook orderbook */ 2:
    ...
    internalBinaryWrite(message: OrderbookUpdate, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* injective.stream.v2.Orderbook orderbook = 2; */
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.OrderbookUpdate
 */
export const OrderbookUpdate = new OrderbookUpdate$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Orderbook$Type extends MessageType<Orderbook> {
    constructor() {
        super("injective.stream.v2.Orderbook", [
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.Orderbook
 */
export const Orderbook = new Orderbook$Type();
// @generated message type with reflection information, may provide speed optimized methods
class BankBalance$Type extends MessageType<BankBalance> {
    constructor() {
        super("injective.stream.v2.BankBalance", [
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.BankBalance
 */
export const BankBalance = new BankBalance$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SubaccountDeposits$Type extends MessageType<SubaccountDeposits> {
    constructor() {
        super("injective.stream.v2.SubaccountDeposits", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string subaccount_id */ 1:
                    ...
                    break;
                case /* repeated injective.stream.v2.SubaccountDeposit deposits */ 2:
    ...
    internalBinaryWrite(message: SubaccountDeposits, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated injective.stream.v2.SubaccountDeposit deposits = 2; */
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.SubaccountDeposits
 */
...
class SubaccountDeposit$Type extends MessageType<SubaccountDeposit> {
    constructor() {
        super("injective.stream.v2.SubaccountDeposit", [
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.SubaccountDeposit
 */
export const SubaccountDeposit = new SubaccountDeposit$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SpotOrderUpdate$Type extends MessageType<SpotOrderUpdate> {
    constructor() {
        super("injective.stream.v2.SpotOrderUpdate", [
            { no: 1, name: "status", kind: "enum", T: () => ["injective.stream.v2.OrderUpdateStatus", OrderUpdateStatus] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SpotOrderUpdate): SpotOrderUpdate {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* injective.stream.v2.OrderUpdateStatus status */ 1:
                ...
                case /* string cid */ 3:
                    ...
                    break;
                case /* injective.stream.v2.SpotOrder order */ 4:
    ...
    internalBinaryWrite(message: SpotOrderUpdate, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* injective.stream.v2.OrderUpdateStatus status = 1; */
        if (message.status !== 0)
        ...
        /* injective.stream.v2.SpotOrder order = 4; */
        if (message.order)
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.SpotOrderUpdate
 */
export const SpotOrderUpdate = new SpotOrderUpdate$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SpotOrder$Type extends MessageType<SpotOrder> {
    constructor() {
        super("injective.stream.v2.SpotOrder", [
            { no: 1, name: "market_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.SpotOrder
 */
export const SpotOrder = new SpotOrder$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DerivativeOrderUpdate$Type extends MessageType<DerivativeOrderUpdate> {
    constructor() {
        super("injective.stream.v2.DerivativeOrderUpdate", [
            { no: 1, name: "status", kind: "enum", T: () => ["injective.stream.v2.OrderUpdateStatus", OrderUpdateStatus] },
            { no: 2, name: "order_hash", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "cid", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string cid */ 3:
                    message.cid = reader.string();
                    break;
                case /* injective.stream.v2.DerivativeOrder order */ 4:
    ...
    internalBinaryWrite(message: DerivativeOrderUpdate, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.cid !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.cid);
        /* injective.stream.v2.DerivativeOrder order = 4; */
        if (message.order)
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.DerivativeOrderUpdate
 */
...
class DerivativeOrder$Type extends MessageType<DerivativeOrder> {
    constructor() {
        super("injective.stream.v2.DerivativeOrder", [
            { no: 1, name: "market_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string market_id */ 1:
                    message.marketId = reader.string();
                    break;
                case /* injective.exchange.v2.DerivativeLimitOrder order */ 2:
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.DerivativeOrder
 */
export const DerivativeOrder = new DerivativeOrder$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Position$Type extends MessageType<Position> {
    constructor() {
        super("injective.stream.v2.Position", [
            { no: 1, name: "market_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.Position
 */
export const Position = new Position$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OraclePrice$Type extends MessageType<OraclePrice> {
    constructor() {
        super("injective.stream.v2.OraclePrice", [
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.OraclePrice
 */
export const OraclePrice = new OraclePrice$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SpotTrade$Type extends MessageType<SpotTrade> {
    constructor() {
        super("injective.stream.v2.SpotTrade", [
            { no: 1, name: "market_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.SpotTrade
 */
export const SpotTrade = new SpotTrade$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DerivativeTrade$Type extends MessageType<DerivativeTrade> {
    constructor() {
        super("injective.stream.v2.DerivativeTrade", [
            { no: 1, name: "market_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "is_buy", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 3, name: "executionType", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string subaccount_id */ 4:
                    message.subaccountId = reader.string();
                    break;
                case /* injective.exchange.v2.PositionDelta position_delta */ 5:
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.DerivativeTrade
 */
export const DerivativeTrade = new DerivativeTrade$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OrderFailureUpdate$Type extends MessageType<OrderFailureUpdate> {
    constructor() {
        super("injective.stream.v2.OrderFailureUpdate", [
            { no: 1, name: "account", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "order_hash", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "cid", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
    ...
    create(value?: PartialMessage<OrderFailureUpdate>): OrderFailureUpdate {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.account = "";
        message.orderHash = "";
        message.cid = "";
        message.errorCode = 0;
        if (value !== undefined)
            reflectionMergePartial<OrderFailureUpdate>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: OrderFailureUpdate): OrderFailureUpdate {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: OrderFailureUpdate, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string account = 1; */
        if (message.account !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.account);
        /* string order_hash = 2; */
        ...
        if (message.errorCode !== 0)
            writer.tag(4, WireType.Varint).uint32(message.errorCode);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.OrderFailureUpdate
 */
export const OrderFailureUpdate = new OrderFailureUpdate$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ConditionalOrderTriggerFailureUpdate$Type extends MessageType<ConditionalOrderTriggerFailureUpdate> {
    constructor() {
        super("injective.stream.v2.ConditionalOrderTriggerFailureUpdate", [
            { no: 1, name: "market_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "subaccount_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
    ...
    create(value?: PartialMessage<ConditionalOrderTriggerFailureUpdate>): ConditionalOrderTriggerFailureUpdate {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.marketId = "";
        message.subaccountId = "";
        message.markPrice = "";
        ...
        if (value !== undefined)
            reflectionMergePartial<ConditionalOrderTriggerFailureUpdate>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ConditionalOrderTriggerFailureUpdate): ConditionalOrderTriggerFailureUpdate {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* string cid */ 5:
                    message.cid = reader.string();
                    break;
                case /* string error_description */ 6:
    ...
    internalBinaryWrite(message: ConditionalOrderTriggerFailureUpdate, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string market_id = 1; */
        if (message.marketId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.marketId);
        /* string subaccount_id = 2; */
        ...
        if (message.errorDescription !== "")
            writer.tag(6, WireType.LengthDelimited).string(message.errorDescription);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.ConditionalOrderTriggerFailureUpdate
 */
export const ConditionalOrderTriggerFailureUpdate = new ConditionalOrderTriggerFailureUpdate$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TradesFilter$Type extends MessageType<TradesFilter> {
    constructor() {
        super("injective.stream.v2.TradesFilter", [
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.TradesFilter
 */
export const TradesFilter = new TradesFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PositionsFilter$Type extends MessageType<PositionsFilter> {
    constructor() {
        super("injective.stream.v2.PositionsFilter", [
            { no: 1, name: "subaccount_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "market_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.PositionsFilter
 */
export const PositionsFilter = new PositionsFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OrdersFilter$Type extends MessageType<OrdersFilter> {
    constructor() {
        super("injective.stream.v2.OrdersFilter", [
            { no: 1, name: "subaccount_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "market_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.OrdersFilter
 */
export const OrdersFilter = new OrdersFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OrderbookFilter$Type extends MessageType<OrderbookFilter> {
    constructor() {
        super("injective.stream.v2.OrderbookFilter", [
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.OrderbookFilter
 */
...
class BankBalancesFilter$Type extends MessageType<BankBalancesFilter> {
    constructor() {
        super("injective.stream.v2.BankBalancesFilter", [
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.BankBalancesFilter
 */
...
class SubaccountDepositsFilter$Type extends MessageType<SubaccountDepositsFilter> {
    constructor() {
        super("injective.stream.v2.SubaccountDepositsFilter", [
            { no: 1, name: "subaccount_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.SubaccountDepositsFilter
 */
...
class OraclePriceFilter$Type extends MessageType<OraclePriceFilter> {
    constructor() {
        super("injective.stream.v2.OraclePriceFilter", [
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.OraclePriceFilter
 */
export const OraclePriceFilter = new OraclePriceFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OrderFailuresFilter$Type extends MessageType<OrderFailuresFilter> {
    constructor() {
        super("injective.stream.v2.OrderFailuresFilter", [
            { no: 1, name: "accounts", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<OrderFailuresFilter>): OrderFailuresFilter {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.accounts = [];
        if (value !== undefined)
            reflectionMergePartial<OrderFailuresFilter>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: OrderFailuresFilter): OrderFailuresFilter {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: OrderFailuresFilter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated string accounts = 1; */
        for (let i = 0; i < message.accounts.length; i++)
            writer.tag(1, WireType.LengthDelimited).string(message.accounts[i]);
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.OrderFailuresFilter
 */
export const OrderFailuresFilter = new OrderFailuresFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ConditionalOrderTriggerFailuresFilter$Type extends MessageType<ConditionalOrderTriggerFailuresFilter> {
    constructor() {
        super("injective.stream.v2.ConditionalOrderTriggerFailuresFilter", [
            { no: 1, name: "subaccount_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "market_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<ConditionalOrderTriggerFailuresFilter>): ConditionalOrderTriggerFailuresFilter {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.subaccountIds = [];
        message.marketIds = [];
        if (value !== undefined)
            reflectionMergePartial<ConditionalOrderTriggerFailuresFilter>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ConditionalOrderTriggerFailuresFilter): ConditionalOrderTriggerFailuresFilter {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ConditionalOrderTriggerFailuresFilter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated string subaccount_ids = 1; */
        for (let i = 0; i < message.subaccountIds.length; i++)
            writer.tag(1, WireType.LengthDelimited).string(message.subaccountIds[i]);
        /* repeated string market_ids = 2; */
...
/**
 * @generated MessageType for protobuf message injective.stream.v2.ConditionalOrderTriggerFailuresFilter
 */
export const ConditionalOrderTriggerFailuresFilter = new ConditionalOrderTriggerFailuresFilter$Type();
/**
 * @generated ServiceType for protobuf service injective.stream.v2.Stream
 */
export const Stream = new ServiceType("injective.stream.v2.Stream", [
    { name: "StreamV2", serverStreaming: true, options: {}, I: StreamRequest, O: StreamResponse }
]);
