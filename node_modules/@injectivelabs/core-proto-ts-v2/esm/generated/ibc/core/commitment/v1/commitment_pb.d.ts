...
export interface MerkleProof {
    /**
     * @generated from protobuf field: repeated cosmos.ics23.v1.CommitmentProof proofs = 1
     */
...
class MerklePath$Type extends MessageType<MerklePath> {
    constructor() {
        super("ibc.core.commitment.v1.MerklePath", [
            { no: 1, name: "key_path", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
class MerkleProof$Type extends MessageType<MerkleProof> {
    constructor() {
        super("ibc.core.commitment.v1.MerkleProof", [
            { no: 1, name: "proofs", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CommitmentProof }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MerkleProof): MerkleProof {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated cosmos.ics23.v1.CommitmentProof proofs */ 1:
