...
class ConnectionEnd$Type extends MessageType<ConnectionEnd> {
    constructor() {
        super("ibc.core.connection.v1.ConnectionEnd", [
            ...
            { no: 2, name: "versions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Version },
...
class IdentifiedConnection$Type extends MessageType<IdentifiedConnection> {
    constructor() {
        super("ibc.core.connection.v1.IdentifiedConnection", [
            ...
            { no: 3, name: "versions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Version },
            ...
            { no: 6, name: "delay_period", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ], { "gogoproto.goproto_getters": false });
    }
...
class Params$Type extends MessageType<Params> {
    constructor() {
        super("ibc.core.connection.v1.Params", [
            { no: 1, name: "max_expected_time_per_block", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<Params>): Params {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.maxExpectedTimePerBlock = 0n;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 max_expected_time_per_block */ 1:
                    message.maxExpectedTimePerBlock = reader.uint64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
