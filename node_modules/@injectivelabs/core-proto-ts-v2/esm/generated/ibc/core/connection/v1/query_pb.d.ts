...
import { IdentifiedClientState } from "../../client/v1/client_pb";
import { PageResponse } from "../../../../cosmos/base/query/v1beta1/pagination_pb";
import { IdentifiedConnection } from "./connection_pb";
import { PageRequest } from "../../../../cosmos/base/query/v1beta1/pagination_pb";
import { Height } from "../../client/v1/client_pb";
import { ConnectionEnd } from "./connection_pb";
/**
 ...
 *
 * @generated from protobuf message ibc.core.connection.v1.QueryConnectionParamsRequest
 */
 ...
 *
 * @generated from protobuf message ibc.core.connection.v1.QueryConnectionParamsResponse
 */
export interface QueryConnectionParamsResponse {
    /**
     * params defines the parameters of the module.
     *
     * @generated from protobuf field: ibc.core.connection.v1.Params params = 1
     */
    params?: Params;
}
...
class QueryConnectionsResponse$Type extends MessageType<QueryConnectionsResponse> {
    constructor() {
        super("ibc.core.connection.v1.QueryConnectionsResponse", [
            { no: 1, name: "connections", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => IdentifiedConnection },
...
class QueryConnectionConsensusStateRequest$Type extends MessageType<QueryConnectionConsensusStateRequest> {
    constructor() {
        super("ibc.core.connection.v1.QueryConnectionConsensusStateRequest", [
            { no: 1, name: "connection_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "revision_number", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "revision_height", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<QueryConnectionConsensusStateRequest>): QueryConnectionConsensusStateRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.connectionId = "";
        message.revisionNumber = 0n;
        message.revisionHeight = 0n;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 revision_number */ 2:
                    message.revisionNumber = reader.uint64().toBigInt();
                    break;
                case /* uint64 revision_height */ 3:
                    message.revisionHeight = reader.uint64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
// @generated message type with reflection information, may provide speed optimized methods
class QueryConnectionParamsRequest$Type extends MessageType<QueryConnectionParamsRequest> {
    constructor() {
        super("ibc.core.connection.v1.QueryConnectionParamsRequest", []);
    }
    create(value?: PartialMessage<QueryConnectionParamsRequest>): QueryConnectionParamsRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<QueryConnectionParamsRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryConnectionParamsRequest): QueryConnectionParamsRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: QueryConnectionParamsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message ibc.core.connection.v1.QueryConnectionParamsRequest
 */
export const QueryConnectionParamsRequest = new QueryConnectionParamsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class QueryConnectionParamsResponse$Type extends MessageType<QueryConnectionParamsResponse> {
    constructor() {
        super("ibc.core.connection.v1.QueryConnectionParamsResponse", [
            { no: 1, name: "params", kind: "message", T: () => Params }
        ]);
    }
    create(value?: PartialMessage<QueryConnectionParamsResponse>): QueryConnectionParamsResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<QueryConnectionParamsResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryConnectionParamsResponse): QueryConnectionParamsResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* ibc.core.connection.v1.Params params */ 1:
    ...
    internalBinaryWrite(message: QueryConnectionParamsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* ibc.core.connection.v1.Params params = 1; */
        if (message.params)
...
/**
 * @generated MessageType for protobuf message ibc.core.connection.v1.QueryConnectionParamsResponse
 */
export const QueryConnectionParamsResponse = new QueryConnectionParamsResponse$Type();
/**
...
export const Query = new ServiceType("ibc.core.connection.v1.Query", [
    ...
    { name: "ConnectionParams", options: { "google.api.http": { get: "/ibc/core/connection/v1/params" } }, I: QueryConnectionParamsRequest, O: QueryConnectionParamsResponse }
]);
