...
import { Params } from "./channel_pb";
import { PacketState } from "./channel_pb";
import { IdentifiedChannel } from "./channel_pb";
/**
...
export interface GenesisState {
    ...
    /**
     * @generated from protobuf field: ibc.core.channel.v1.Params params = 9
     */
    params?: Params;
}
/**
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("ibc.core.channel.v1.GenesisState", [
            { no: 1, name: "channels", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => IdentifiedChannel, options: { "gogoproto.nullable": false, "gogoproto.casttype": "IdentifiedChannel" } },
            { no: 2, name: "acknowledgements", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PacketState, options: { "gogoproto.nullable": false } },
            { no: 3, name: "commitments", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PacketState, options: { "gogoproto.nullable": false } },
            { no: 4, name: "receipts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PacketState, options: { "gogoproto.nullable": false } },
            { no: 5, name: "send_sequences", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PacketSequence, options: { "gogoproto.nullable": false } },
            { no: 6, name: "recv_sequences", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PacketSequence, options: { "gogoproto.nullable": false } },
            { no: 7, name: "ack_sequences", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PacketSequence, options: { "gogoproto.nullable": false } },
            { no: 8, name: "next_channel_sequence", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 9, name: "params", kind: "message", T: () => Params, options: { "gogoproto.nullable": false } }
        ]);
    }
    create(value?: PartialMessage<GenesisState>): GenesisState {
        ...
        message.nextChannelSequence = 0n;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 next_channel_sequence */ 8:
                    message.nextChannelSequence = reader.uint64().toBigInt();
                    break;
                case /* ibc.core.channel.v1.Params params */ 9:
    ...
    internalBinaryWrite(message: GenesisState, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* ibc.core.channel.v1.Params params = 9; */
        if (message.params)
            Params.internalBinaryWrite(message.params, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
