...
export interface Channel {
     ...
     *
     * @generated from protobuf field: uint64 upgrade_sequence = 6
     */
...
export interface IdentifiedChannel {
     ...
     * the value of 0 indicates the channel has never been upgraded
     *
     * @generated from protobuf field: uint64 upgrade_sequence = 8
     */
    upgradeSequence: bigint;
}
/**
 ...
 *
 * @generated from protobuf message ibc.core.channel.v1.Timeout
 */
 ...
 *
 * @generated from protobuf message ibc.core.channel.v1.Params
 */
export interface Params {
    /**
     * the relative timeout after which channel upgrades will time out.
     *
     * @generated from protobuf field: ibc.core.channel.v1.Timeout upgrade_timeout = 1
     */
...
export enum State {
     ...
     *
     * @generated from protobuf enum value: STATE_FLUSHING = 5;
     */
    FLUSHING = 5,
    /**
     * A channel has just completed flushing any in-flight packets.
     *
     * @generated from protobuf enum value: STATE_FLUSHCOMPLETE = 6;
     */
    FLUSHCOMPLETE = 6
}
/**
...
class Channel$Type extends MessageType<Channel> {
    constructor() {
        super("ibc.core.channel.v1.Channel", [
            ...
            { no: 4, name: "connection_hops", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 5, name: "version", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 6, name: "upgrade_sequence", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string version */ 5:
                    ...
                    break;
                case /* uint64 upgrade_sequence */ 6:
                    message.upgradeSequence = reader.uint64().toBigInt();
                    break;
                default:
    ...
    internalBinaryWrite(message: Channel, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.upgradeSequence !== 0n)
            writer.tag(6, WireType.Varint).uint64(message.upgradeSequence);
...
class IdentifiedChannel$Type extends MessageType<IdentifiedChannel> {
    constructor() {
        super("ibc.core.channel.v1.IdentifiedChannel", [
            ...
            { no: 8, name: "upgrade_sequence", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ], { "gogoproto.goproto_getters": false });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string channel_id */ 7:
                    ...
                    break;
                case /* uint64 upgrade_sequence */ 8:
                    message.upgradeSequence = reader.uint64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: IdentifiedChannel, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.upgradeSequence !== 0n)
            writer.tag(8, WireType.Varint).uint64(message.upgradeSequence);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class Packet$Type extends MessageType<Packet> {
    constructor() {
        super("ibc.core.channel.v1.Packet", [
            ...
            { no: 7, name: "timeout_height", kind: "message", T: () => Height, options: { "gogoproto.nullable": false } },
            { no: 8, name: "timeout_timestamp", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ], { "gogoproto.goproto_getters": false });
    }
...
// @generated message type with reflection information, may provide speed optimized methods
class PacketId$Type extends MessageType<PacketId> {
    constructor() {
    ...
    create(value?: PartialMessage<PacketId>): PacketId {
        ...
        message.sequence = 0n;
        if (value !== undefined)
            reflectionMergePartial<PacketId>(this, message, value);
        return message;
    }
...
// @generated message type with reflection information, may provide speed optimized methods
class Timeout$Type extends MessageType<Timeout> {
    constructor() {
        super("ibc.core.channel.v1.Timeout", [
    ...
    create(value?: PartialMessage<Timeout>): Timeout {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.timestamp = 0n;
        if (value !== undefined)
            reflectionMergePartial<Timeout>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Timeout): Timeout {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Timeout, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message ibc.core.channel.v1.Timeout
 */
export const Timeout = new Timeout$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Params$Type extends MessageType<Params> {
    constructor() {
        super("ibc.core.channel.v1.Params", [
            { no: 1, name: "upgrade_timeout", kind: "message", T: () => Timeout, options: { "gogoproto.nullable": false } }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Params): Params {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* ibc.core.channel.v1.Timeout upgrade_timeout */ 1:
                    message.upgradeTimeout = Timeout.internalBinaryRead(reader, reader.uint32(), options, message.upgradeTimeout);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: Params, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.upgradeTimeout)
            Timeout.internalBinaryWrite(message.upgradeTimeout, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message ibc.core.channel.v1.Params
 */
