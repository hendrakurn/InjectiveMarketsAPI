    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          ...
          break;
        case /* google.protobuf.Any client_state */
        2:
...
const IdentifiedClientState = new IdentifiedClientState$Type();
...
const ConsensusStateWithHeight = new ConsensusStateWithHeight$Type();
class ClientConsensusStates$Type extends MessageType {
  constructor() {
    super("ibc.core.client.v1.ClientConsensusStates", [
      ...
      { no: 2, name: "consensus_states", kind: "message", repeat: 2, T: () => ConsensusStateWithHeight, options: { "gogoproto.nullable": false } }
    ]);
  }
  create(value) {
    const message = globalThis.Object.create(this.messagePrototype);
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          message.clientId = reader.string();
          break;
        case /* repeated ibc.core.client.v1.ConsensusStateWithHeight consensus_states */
        2:
...
const ClientConsensusStates = new ClientConsensusStates$Type();
class Height$Type extends MessageType {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* uint64 revision_number */
        1:
          message.revisionNumber = reader.uint64().toBigInt();
          break;
        case /* uint64 revision_height */
        2:
...
class Params$Type extends MessageType {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* repeated string allowed_clients */
        1:
...
class ClientUpdateProposal$Type extends MessageType {
  constructor() {
    super("ibc.core.client.v1.ClientUpdateProposal", [
      ...
      { no: 3, name: "subject_client_id", kind: "scalar", T: 9, options: { "gogoproto.moretags": 'yaml:"subject_client_id"' } },
      { no: 4, name: "substitute_client_id", kind: "scalar", T: 9, options: { "gogoproto.moretags": 'yaml:"substitute_client_id"' } }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        2:
          ...
          break;
        case /* string subject_client_id */
        3:
          message.subjectClientId = reader.string();
          break;
        case /* string substitute_client_id */
        4:
...
const ClientUpdateProposal = new ClientUpdateProposal$Type();
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        2:
          message.description = reader.string();
          break;
        case /* cosmos.upgrade.v1beta1.Plan plan */
        3:
          message.plan = Plan.internalBinaryRead(reader, reader.uint32(), options, message.plan);
          break;
        case /* google.protobuf.Any upgraded_client_state */
        4:
...
const UpgradeProposal = new UpgradeProposal$Type();
export {
