...
import { ClientConsensusStates } from "./client_pb";
import { IdentifiedClientState } from "./client_pb";
/**
...
export interface GenesisState {
     ...
     *
     * @deprecated
     * @generated from protobuf field: bool create_localhost = 5 [deprecated = true]
     */
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("ibc.core.client.v1.GenesisState", [
            { no: 1, name: "clients", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => IdentifiedClientState, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "IdentifiedClientStates" } },
            { no: 2, name: "clients_consensus", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ClientConsensusStates, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "ClientsConsensusStates" } },
            { no: 3, name: "clients_metadata", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => IdentifiedGenesisMetadata, options: { "gogoproto.nullable": false } },
            ...
            { no: 6, name: "next_client_sequence", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* ibc.core.client.v1.Params params */ 4:
                    ...
                    break;
                case /* bool create_localhost = 5 [deprecated = true] */ 5:
                    message.createLocalhost = reader.bool();
                    break;
                case /* uint64 next_client_sequence */ 6:
                    message.nextClientSequence = reader.uint64().toBigInt();
                    break;
                default:
...
class IdentifiedGenesisMetadata$Type extends MessageType<IdentifiedGenesisMetadata> {
    constructor() {
        super("ibc.core.client.v1.IdentifiedGenesisMetadata", [
            ...
            { no: 2, name: "client_metadata", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => GenesisMetadata, options: { "gogoproto.nullable": false } }
        ]);
    }
