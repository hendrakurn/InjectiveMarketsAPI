...
class ClientConsensusStates$Type extends MessageType<ClientConsensusStates> {
    constructor() {
        super("ibc.core.client.v1.ClientConsensusStates", [
            { no: 1, name: "client_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "consensus_states", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ConsensusStateWithHeight, options: { "gogoproto.nullable": false } }
        ]);
    }
...
class Height$Type extends MessageType<Height> {
    constructor() {
        super("ibc.core.client.v1.Height", [
            { no: 1, name: "revision_number", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "revision_height", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
...
class Params$Type extends MessageType<Params> {
    constructor() {
        super("ibc.core.client.v1.Params", [
            { no: 1, name: "allowed_clients", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
