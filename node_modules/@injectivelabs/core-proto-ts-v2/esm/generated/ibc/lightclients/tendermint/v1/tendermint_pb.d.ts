...
import { ValidatorSet } from "../../../../cometbft/types/v1/validator_pb";
import { SignedHeader } from "../../../../cometbft/types/v1/types_pb";
...
export interface ClientState {
     ...
     *
     * @generated from protobuf field: repeated cosmos.ics23.v1.ProofSpec proof_specs = 8
     */
...
export interface Misbehaviour {
     ...
     *
     * @deprecated
     * @generated from protobuf field: string client_id = 1 [deprecated = true]
     */
    clientId: string;
    /**
...
export interface Header {
    ...
    /**
     * @generated from protobuf field: cometbft.types.v1.ValidatorSet trusted_validators = 4
     */
...
class ClientState$Type extends MessageType<ClientState> {
    constructor() {
        super("ibc.lightclients.tendermint.v1.ClientState", [
            ...
            { no: 2, name: "trust_level", kind: "message", T: () => Fraction, options: { "gogoproto.nullable": false } },
            { no: 3, name: "trusting_period", kind: "message", T: () => Duration, options: { "gogoproto.nullable": false, "gogoproto.stdduration": true } },
            { no: 4, name: "unbonding_period", kind: "message", T: () => Duration, options: { "gogoproto.nullable": false, "gogoproto.stdduration": true } },
            { no: 5, name: "max_clock_drift", kind: "message", T: () => Duration, options: { "gogoproto.nullable": false, "gogoproto.stdduration": true } },
            { no: 6, name: "frozen_height", kind: "message", T: () => Height, options: { "gogoproto.nullable": false } },
            { no: 7, name: "latest_height", kind: "message", T: () => Height, options: { "gogoproto.nullable": false } },
            { no: 8, name: "proof_specs", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ProofSpec },
            { no: 9, name: "upgrade_path", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* ibc.core.client.v1.Height latest_height */ 7:
                    ...
                    break;
                case /* repeated cosmos.ics23.v1.ProofSpec proof_specs */ 8:
...
class ConsensusState$Type extends MessageType<ConsensusState> {
    constructor() {
        super("ibc.lightclients.tendermint.v1.ConsensusState", [
            ...
            { no: 3, name: "next_validators_hash", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cometbft/cometbft/libs/bytes.HexBytes" } }
        ], { "gogoproto.goproto_getters": false });
    }
...
class Misbehaviour$Type extends MessageType<Misbehaviour> {
    constructor() {
        super("ibc.lightclients.tendermint.v1.Misbehaviour", [
            ...
            { no: 2, name: "header_1", kind: "message", T: () => Header, options: { "gogoproto.customname": "Header1" } },
            { no: 3, name: "header_2", kind: "message", T: () => Header, options: { "gogoproto.customname": "Header2" } }
        ], { "gogoproto.goproto_getters": false });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Misbehaviour): Misbehaviour {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string client_id = 1 [deprecated = true] */ 1:
...
class Header$Type extends MessageType<Header> {
    constructor() {
        super("ibc.lightclients.tendermint.v1.Header", [
            { no: 1, name: "signed_header", kind: "message", T: () => SignedHeader, options: { "gogoproto.embed": true } },
            { no: 2, name: "validator_set", kind: "message", T: () => ValidatorSet },
            { no: 3, name: "trusted_height", kind: "message", T: () => Height, options: { "gogoproto.nullable": false } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* ibc.core.client.v1.Height trusted_height */ 3:
                    ...
                    break;
                case /* cometbft.types.v1.ValidatorSet trusted_validators */ 4:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 numerator */ 1:
                    message.numerator = reader.uint64().toBigInt();
                    break;
                case /* uint64 denominator */ 2:
                    message.denominator = reader.uint64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
