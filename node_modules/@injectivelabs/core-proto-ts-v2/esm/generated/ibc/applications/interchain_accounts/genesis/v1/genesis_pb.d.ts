...
// @generated from protobuf file "ibc/applications/interchain_accounts/genesis/v1/genesis.proto" (package "ibc.applications.interchain_accounts.genesis.v1", syntax proto3)
// tslint:disable
...
import { Params as Params$ } from "../../host/v1/host_pb";
import { Params } from "../../controller/v1/controller_pb";
/**
 * GenesisState defines the interchain accounts genesis state
 *
 * @generated from protobuf message ibc.applications.interchain_accounts.genesis.v1.GenesisState
 */
export interface GenesisState {
    /**
     * @generated from protobuf field: ibc.applications.interchain_accounts.genesis.v1.ControllerGenesisState controller_genesis_state = 1
     */
    controllerGenesisState?: ControllerGenesisState;
    /**
     * @generated from protobuf field: ibc.applications.interchain_accounts.genesis.v1.HostGenesisState host_genesis_state = 2
     */
 ...
 *
 * @generated from protobuf message ibc.applications.interchain_accounts.genesis.v1.ControllerGenesisState
 */
export interface ControllerGenesisState {
    /**
     * @generated from protobuf field: repeated ibc.applications.interchain_accounts.genesis.v1.ActiveChannel active_channels = 1
     */
    activeChannels: ActiveChannel[];
    /**
     * @generated from protobuf field: repeated ibc.applications.interchain_accounts.genesis.v1.RegisteredInterchainAccount interchain_accounts = 2
     */
 ...
 *
 * @generated from protobuf message ibc.applications.interchain_accounts.genesis.v1.HostGenesisState
 */
 ...
 *
 * @generated from protobuf message ibc.applications.interchain_accounts.genesis.v1.ActiveChannel
 */
export interface ActiveChannel {
    ...
    channelId: string;
    /**
     * @generated from protobuf field: bool is_middleware_enabled = 4
     */
 ...
 *
 * @generated from protobuf message ibc.applications.interchain_accounts.genesis.v1.RegisteredInterchainAccount
 */
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("ibc.applications.interchain_accounts.genesis.v1.GenesisState", [
            { no: 1, name: "controller_genesis_state", kind: "message", T: () => ControllerGenesisState, options: { "gogoproto.nullable": false } },
            { no: 2, name: "host_genesis_state", kind: "message", T: () => HostGenesisState, options: { "gogoproto.nullable": false } }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GenesisState): GenesisState {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* ibc.applications.interchain_accounts.genesis.v1.ControllerGenesisState controller_genesis_state */ 1:
                    ...
                    break;
                case /* ibc.applications.interchain_accounts.genesis.v1.HostGenesisState host_genesis_state */ 2:
    ...
    internalBinaryWrite(message: GenesisState, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* ibc.applications.interchain_accounts.genesis.v1.ControllerGenesisState controller_genesis_state = 1; */
        ...
        /* ibc.applications.interchain_accounts.genesis.v1.HostGenesisState host_genesis_state = 2; */
...
/**
 * @generated MessageType for protobuf message ibc.applications.interchain_accounts.genesis.v1.GenesisState
 */
...
class ControllerGenesisState$Type extends MessageType<ControllerGenesisState> {
    constructor() {
        super("ibc.applications.interchain_accounts.genesis.v1.ControllerGenesisState", [
            { no: 1, name: "active_channels", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ActiveChannel, options: { "gogoproto.nullable": false } },
            { no: 2, name: "interchain_accounts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => RegisteredInterchainAccount, options: { "gogoproto.nullable": false } },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ControllerGenesisState): ControllerGenesisState {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated ibc.applications.interchain_accounts.genesis.v1.ActiveChannel active_channels */ 1:
                    message.activeChannels.push(ActiveChannel.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated ibc.applications.interchain_accounts.genesis.v1.RegisteredInterchainAccount interchain_accounts */ 2:
    ...
    internalBinaryWrite(message: ControllerGenesisState, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated ibc.applications.interchain_accounts.genesis.v1.ActiveChannel active_channels = 1; */
        ...
        /* repeated ibc.applications.interchain_accounts.genesis.v1.RegisteredInterchainAccount interchain_accounts = 2; */
...
/**
 * @generated MessageType for protobuf message ibc.applications.interchain_accounts.genesis.v1.ControllerGenesisState
 */
...
class HostGenesisState$Type extends MessageType<HostGenesisState> {
    constructor() {
        super("ibc.applications.interchain_accounts.genesis.v1.HostGenesisState", [
            { no: 1, name: "active_channels", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ActiveChannel, options: { "gogoproto.nullable": false } },
            { no: 2, name: "interchain_accounts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => RegisteredInterchainAccount, options: { "gogoproto.nullable": false } },
...
/**
 * @generated MessageType for protobuf message ibc.applications.interchain_accounts.genesis.v1.HostGenesisState
 */
export const HostGenesisState = new HostGenesisState$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ActiveChannel$Type extends MessageType<ActiveChannel> {
    constructor() {
        super("ibc.applications.interchain_accounts.genesis.v1.ActiveChannel", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string channel_id */ 3:
                    ...
                    break;
                case /* bool is_middleware_enabled */ 4:
    ...
    internalBinaryWrite(message: ActiveChannel, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isMiddlewareEnabled !== false)
            writer.tag(4, WireType.Varint).bool(message.isMiddlewareEnabled);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message ibc.applications.interchain_accounts.genesis.v1.ActiveChannel
 */
...
class RegisteredInterchainAccount$Type extends MessageType<RegisteredInterchainAccount> {
    constructor() {
        super("ibc.applications.interchain_accounts.genesis.v1.RegisteredInterchainAccount", [
            { no: 1, name: "connection_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "port_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message ibc.applications.interchain_accounts.genesis.v1.RegisteredInterchainAccount
 */
