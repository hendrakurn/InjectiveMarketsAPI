...
class InterchainAccount$Type extends MessageType<InterchainAccount> {
    constructor() {
        ...
        ], { "gogoproto.goproto_getters": false, "gogoproto.goproto_stringer": false, "cosmos_proto.implements_interface": ["ibc.applications.interchain_accounts.v1.InterchainAccountI"] });
    }
