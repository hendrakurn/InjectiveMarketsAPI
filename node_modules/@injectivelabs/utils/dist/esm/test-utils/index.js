import { c as DEFAULT_GAS_LIMIT, l as DEFAULT_GAS_PRICE, v as BigNumber_default } from "../constants-BxcSsKjm.js";
	...
	return {
		...
		eip712Args: {
			...
			fee: {
				amount: [{
					denom: "inj",
					amount: new BigNumber_default(gas.toString()).times(DEFAULT_GAS_PRICE).toFixed()
				}],
				gas: gas.toString(),
