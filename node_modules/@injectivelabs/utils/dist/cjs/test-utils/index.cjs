...
//#region src/test-utils/mocks/index.ts
...
const injUsdtDerivativeMarket = {
	...
	takerFeeRate: "0.002",
	serviceProviderFee: "0.4",
	minPriceTickSize: 1e3,
	minQuantityTickSize: .001,
	perpetualMarketInfo: {
...
const mockFactory = {
	...
	orderHash2,
	MAX_TIMEOUT_HEIGHT,
	eip712Tx: ({ chainId = __injectivelabs_ts_types.ChainId.Devnet, evmChainId = __injectivelabs_ts_types.EvmChainId.Sepolia, accountNumber = 1, sequence = 0, timeoutHeight = 999999999, memo = "" }) => ({
		tx: {
			memo,
			chainId,
			sequence,
...
const prepareEip712 = ({ messages, gas = require_constants.DEFAULT_GAS_LIMIT, network = __injectivelabs_networks.Network.Mainnet, injectiveAddress: injectiveAddress$1 = mockFactory.injectiveAddress, ethereumAddress: ethereumAddress$1 = mockFactory.ethereumAddress, endpoints = {}, accountNumber = 1, sequence = 1, timeoutHeight = 999999999, memo = "" }) => {
	...
	const actualEndpoints = {
		...(0, __injectivelabs_networks.getNetworkEndpoints)(network),
		...endpoints
	};
	...
	return {
		...
		prepareEip712Request: {
			...
			message: web3Msgs,
			gasLimit: gas,
			address: ethereumAddress$1
		}
	};
};

//#endregion
exports.injUsdtDerivativeMarket = injUsdtDerivativeMarket;
exports.injUsdtSpotMarket = injUsdtSpotMarket;
